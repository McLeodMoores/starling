...
public class ExampleGbConventions extends ConventionMasterInitializer {
  ...
  public void init(final ConventionMaster master) {
    ...
    final OISLegConvention oisLeg = new OISLegConvention("GBP OIS", ExternalId.of("CONVENTION", "GBP OIS").toBundle(), ExternalId.of("CONVENTION", "SONIA"),
        Tenor.ONE_YEAR, BusinessDayConventions.MODIFIED_FOLLOWING, 0, false, StubType.SHORT_START, false, 1);
    // IBOR Swaps
    final SwapFixedLegConvention iborFixedLeg = new SwapFixedLegConvention("GBP IBOR Fixed",
        ExternalIdBundle.of(ExternalId.of("CONVENTION", "GBP IBOR Fixed"), ExternalSchemes.currencyRegionId(Currency.GBP)), Tenor.SIX_MONTHS, DayCounts.ACT_365,
        BusinessDayConventions.MODIFIED_FOLLOWING, Currency.GBP, GB, 0, true, StubType.SHORT_START, false, 0);
    final VanillaIborLegConvention ibor3mLeg = new VanillaIborLegConvention("GBP 6M IBOR",
        ExternalIdBundle.of(ExternalId.of("CONVENTION", "GBP 6M IBOR"), ExternalSchemes.currencyRegionId(Currency.GBP)),
