...
/**
 * Populates the example database with ATM swaption volatility surface definitions and specifications for a given list of currencies.
 * <p>
 * The specifications have expiry as the x axis and maturity as the y axis, and use direct volatility quotes. The instrument provider is
 * {@link ExampleSwaptionVolatilitySurfaceInstrumentProvider}.
 * <p>
 * The definitions have x axis tenors of (3m, 6m, 1y, 2y, 3y, 5y, 10y) and y axis tenors of (1y, 2y, 3y, 5y, 7y, 10y, 12y, 15y, 20y, 30y).
 */
public class ExampleATMSwaptionVolatilitySurfaceConfigPopulator {
  ...
  private static void populateVolatilitySurfaceSpecifications(final ConfigMaster configMaster, final Currency target, final String name) {
    final SurfaceInstrumentProvider<Tenor, Tenor> surfaceInstrumentProvider = new ExampleSwaptionVolatilitySurfaceInstrumentProvider(target.toString(),
        "ATMSWAPTION", false, true,
        "");
