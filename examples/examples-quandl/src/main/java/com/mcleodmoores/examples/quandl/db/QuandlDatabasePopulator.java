 ...
 */
package com.mcleodmoores.examples.quandl.db;
 ...
 *
 */
public class QuandlDatabasePopulator extends AbstractTool<ToolContext> {
  ...
  /** Logger. */
  /* package */static final Logger LOGGER = LoggerFactory.getLogger(QuandlDatabasePopulator.class);
...
//
//  /**
//   * Loads conventions into the{@link ConventionMaster}.
//   */
//  private void loadConventions() {
//    final Log log = new Log("Creating convention data");
//    try {
//      final QuandlConventionsLoader conventionsLoader = new QuandlConventionsLoader();
//      conventionsLoader.run(getToolContext());
//      log.done();
//    } catch (final RuntimeException t) {
//      log.fail(t);
//    }
...
//    try {
//      final QuandlCurrencyConfigurationsLoader currencyLoader = new QuandlCurrencyConfigurationsLoader();
...
//    try {
//      final QuandlTimeSeriesRatingLoader timeSeriesRatingLoader = new QuandlTimeSeriesRatingLoader();
...
//
//  /**
//   * Loads example curve configurations.
//   */
//  private void loadCurveConfigurations() {
//    final Log log = new Log("Creating curve configurations");
//    try {
//      final QuandlCurveConfigurationsLoader loader = new QuandlCurveConfigurationsLoader();
//      loader.run(getToolContext());
//      log.done();
//    } catch (final RuntimeException t) {
//      log.fail(t);
