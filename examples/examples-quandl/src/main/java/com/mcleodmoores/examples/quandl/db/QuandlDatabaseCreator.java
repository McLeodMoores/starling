...
public class QuandlDatabaseCreator {
   ...
   * It relies on the <code>web</code> project directory being relative to examples-simulated in the file
  ...
  public static void main(String[] args) { // CSIGNORE
    if (args.length == 0) {
      ...
      args = new String[] {"classpath:/toolcontext/toolcontext-examples.properties"};
    }
    try {
