...
public class DefaultComputationTargetTypeProviderTest {
  ...
  public void testGetSimpleTypes() {
    ...
    final Set<ComputationTargetType> types = new HashSet<>(provider.getSimpleTypes());
    assertEquals(types, ImmutableSet.<ComputationTargetType>of(ComputationTargetType.PORTFOLIO, ComputationTargetType.PORTFOLIO_NODE,
        ...
        ComputationTargetType.CURRENCY, ComputationTargetType.UNORDERED_CURRENCY_PAIR,
        ComputationTargetType.CREDIT_CURVE_IDENTIFIER));
  }

  public void testGetAdditionalTypes() {
    final DefaultComputationTargetTypeProvider provider = new DefaultComputationTargetTypeProvider();
    final Set<ComputationTargetType> types = new HashSet<>(provider.getAdditionalTypes());
