...
public class TotallingGraphStatisticsGathererProviderTest {
  ...
  private final TotallingGraphStatisticsGathererProvider _provider = new TotallingGraphStatisticsGathererProvider();

  public void testBasicOperation() {
    final UniqueId vp1Id = UniqueId.of("Test", "ViewProcess1");
    final UniqueId vp2Id = UniqueId.of("Test", "ViewProcess2");
    ...
    int mask = 0;
    for (final Statistics stats : statsList) {
      if (stats.getViewProcessId().equals(vp1Id)) {
        ...
        for (final GraphExecutionStatistics graphStats : graphStatsList) {
