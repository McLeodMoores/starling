...
public class WithTest {
  ...
  public void testEmptyValues() {
    new With(PROPERTY_NAME, new String[0]);
  }
  ...
  public void testNullBuilder() {
    new With(PROPERTY_NAME, PROPERTY_VALUES).modify(null);
  }
  ...
  public void testModifyEmptyBuilder() {
    ...
    new With(PROPERTY_NAME, PROPERTY_VALUES).modify(builder);
  ...
  public void testModifyWithExistingProperty() {
    ...
    assertValuesEqual(builder.get().getValues(PROPERTY_NAME), expectedValues);
  }
