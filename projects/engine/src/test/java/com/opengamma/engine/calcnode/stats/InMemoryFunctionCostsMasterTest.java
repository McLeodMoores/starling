...
public class InMemoryFunctionCostsMasterTest {
  ...
  public void testMaster() {
    ...
    // check empty
    final InMemoryFunctionCostsMaster test = new InMemoryFunctionCostsMaster();
    assertNull(test.load("Conf1", "Func1", null));
    assertNull(test.load("Conf2", "Func2", null));

    // store1
    final FunctionCostsDocument stored1 = test.store(doc1);
    ...
    final FunctionCostsDocument loaded1 = test.load("Conf1", "Func1", null);
    ...
    // store2
    final FunctionCostsDocument stored2 = test.store(doc2);
    ...
    final FunctionCostsDocument loaded2 = test.load("Conf2", "Func2", null);
    ...
    final FunctionCostsDocument loaded1b = test.load("Conf1", "Func1", null);
