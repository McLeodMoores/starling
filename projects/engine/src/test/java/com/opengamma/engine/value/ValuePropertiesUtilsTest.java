...
public class ValuePropertiesUtilsTest {
  ...
  public void testRemoveAllNoOverlap() {
    final ValueProperties properties =
        ValuePropertiesUtils.removeAll(CURVE_PROPERTIES, ValuePropertyNames.RECEIVE_CURVE, ValuePropertyNames.RECEIVE_CURVE_CALCULATION_CONFIG).get();
    assertFalse(CURVE_PROPERTIES == properties);
    assertEquals(CURVE_PROPERTIES, properties);
  }
  ...
  public void testGetAllOptional() {
    ...
    final ValueProperties properties = ValueProperties.builder()
        ...
        .with(ValuePropertyNames.RECEIVE_CURVE_CALCULATION_CONFIG, "ReceiveCurveName1", "ReceiveCurveName2")
