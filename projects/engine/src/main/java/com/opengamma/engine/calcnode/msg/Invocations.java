...
public class Invocations extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitInvocationsMessage (this); }
  ...
  public static class PerConfiguration implements java.io.Serializable {
    ...
    public static class PerFunction implements java.io.Serializable {
      ...
      public PerFunction (final String identifier, final int count, final double invocation, final double dataInput, final double dataOutput) {
        if (identifier == null) {
      ...
      protected PerFunction (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
        ...
        if (fudgeField == null) {
          throw new IllegalArgumentException ("Fudge message is not a PerFunction - field 'identifier' is not present");
        }
        try {
        ...
        if (fudgeField == null) {
          throw new IllegalArgumentException ("Fudge message is not a PerFunction - field 'count' is not present");
        }
        try {
        ...
        if (fudgeField == null) {
          throw new IllegalArgumentException ("Fudge message is not a PerFunction - field 'invocation' is not present");
        }
        try {
        ...
        if (fudgeField == null) {
          throw new IllegalArgumentException ("Fudge message is not a PerFunction - field 'dataInput' is not present");
        }
        try {
        ...
        if (fudgeField == null) {
          throw new IllegalArgumentException ("Fudge message is not a PerFunction - field 'dataOutput' is not present");
        }
        try {
      ...
      public static PerFunction fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
        ...
        for (final org.fudgemsg.FudgeField field : types) {
          ...
          if ("com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction".equals (className)) {
            break;
          }
          try {
      ...
      public void setInvocation (final double invocation) {
        _invocation = invocation;
      }
      public double getDataInput () {
        return _dataInput;
      }
      public void setDataInput (final double dataInput) {
        _dataInput = dataInput;
      }
      public double getDataOutput () {
        return _dataOutput;
      }
      public void setDataOutput (final double dataOutput) {
        _dataOutput = dataOutput;
      }
      @Override
    ...
    public PerConfiguration (final String configuration, final java.util.Collection<? extends com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> function) {
      ...
      if (function == null) {
        ...
        final java.util.List<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge0 = new java.util.ArrayList<> (function);
        if (function.size () == 0) {
          throw new IllegalArgumentException ("'function' cannot be an empty list");
        }
        for (final java.util.ListIterator<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
          final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction fudge2 = fudge1.next ();
          if (fudge2 == null) {
            throw new NullPointerException ("List element of 'function' cannot be null");
          }
    ...
    protected PerConfiguration (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      if (fudgeField == null) {
        throw new IllegalArgumentException ("Fudge message is not a PerConfiguration - field 'configuration' is not present");
      }
      try {
      ...
      if (fudgeFields.size () == 0) {
        throw new IllegalArgumentException ("Fudge message is not a PerConfiguration - field 'function' is not present");
      }
      _function = new java.util.ArrayList<> (fudgeFields.size ());
    ...
    protected PerConfiguration (final PerConfiguration source) {
      ...
      if (source._function == null) {
        _function = null;
      } else {
        final java.util.List<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge0 = new java.util.ArrayList<> (source._function);
        for (final java.util.ListIterator<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
          final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction fudge2 = fudge1.next ();
          fudge1.set (fudge2.clone ());
        }
    ...
    public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
      ...
      if (_function != null)  {
        for (final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction fudge1 : _function) {
    ...
    public static PerConfiguration fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      for (final org.fudgemsg.FudgeField field : types) {
        final String className = (String)field.getValue ();
        if ("com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration".equals (className)) {
          break;
        }
        try {
    ...
    public void setFunction (final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction function) {
      if (function == null) {
        throw new NullPointerException ("'function' cannot be null");
      } else {
        _function = new java.util.ArrayList<> (1);
        addFunction (function);
      }
    }
    public void setFunction (final java.util.Collection<? extends com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> function) {
      if (function == null) {
        throw new NullPointerException ("'function' cannot be null");
      } else {
        final java.util.List<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge0 = new java.util.ArrayList<> (function);
    ...
    public void addFunction (final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration.PerFunction function) {
      if (function == null) {
        throw new NullPointerException ("'function' cannot be null");
      }
      if (_function == null) {
        _function = new java.util.ArrayList<> ();
      }
      _function.add (function.clone ());
    }
    @Override
    public String toString () {
      return org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(this, org.apache.commons.lang.builder.ToStringStyle.SHORT_PREFIX_STYLE);
  ...
  public static final String CONFIGURATION_KEY = "configuration";
  public Invocations (final java.util.Collection<? extends com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> configuration) {
    if (configuration == null) {
      throw new NullPointerException ("'configuration' cannot be null");
    } else {
      final java.util.List<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> fudge0 = new java.util.ArrayList<> (configuration);
      if (configuration.size () == 0) {
        throw new IllegalArgumentException ("'configuration' cannot be an empty list");
      }
      for (final java.util.ListIterator<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration fudge2 = fudge1.next ();
        if (fudge2 == null) {
          throw new NullPointerException ("List element of 'configuration' cannot be null");
        }
        fudge1.set (fudge2.clone ());
      }
  ...
  protected Invocations (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a Invocations - field 'configuration' is not present");
    }
    _configuration = new java.util.ArrayList<> (fudgeFields.size ());
    for (final org.fudgemsg.FudgeField fudge1 : fudgeFields) {
      try {
  ...
  protected Invocations (final Invocations source) {
    ...
    if (source._configuration == null) {
      _configuration = null;
    } else {
      final java.util.List<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> fudge0 = new java.util.ArrayList<> (source._configuration);
      for (final java.util.ListIterator<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration fudge2 = fudge1.next ();
        fudge1.set (fudge2.clone ());
      }
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    ...
    if (_configuration != null)  {
      for (final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration fudge1 : _configuration) {
  ...
  public static Invocations fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.engine.calcnode.msg.Invocations".equals (className)) {
        break;
      }
      try {
  ...
  public void setConfiguration (final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration configuration) {
    if (configuration == null) {
      throw new NullPointerException ("'configuration' cannot be null");
    } else {
      _configuration = new java.util.ArrayList<> (1);
      addConfiguration (configuration);
    }
  }
  public void setConfiguration (final java.util.Collection<? extends com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> configuration) {
    if (configuration == null) {
      throw new NullPointerException ("'configuration' cannot be null");
    } else {
      final java.util.List<com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration> fudge0 = new java.util.ArrayList<> (configuration);
  ...
  public void addConfiguration (final com.opengamma.engine.calcnode.msg.Invocations.PerConfiguration configuration) {
    if (configuration == null) {
      throw new NullPointerException ("'configuration' cannot be null");
    }
    if (_configuration == null) {
      _configuration = new java.util.ArrayList<> ();
    }
    _configuration.add (configuration.clone ());
  }
  @Override
  public String toString () {
    return org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(this, org.apache.commons.lang.builder.ToStringStyle.SHORT_PREFIX_STYLE);
