...
public class Init extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitInitMessage (this); }
  ...
  public Init (final long functionInitId) {
  ...
  protected Init (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Init - field 'functionInitId' is not present");
    }
    try {
  ...
  public static Init fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.calcnode.msg.Init".equals (className)) {
        break;
      }
      try {
  ...
  public void setFunctionInitId (final long functionInitId) {
    _functionInitId = functionInitId;
  }
  @Override
