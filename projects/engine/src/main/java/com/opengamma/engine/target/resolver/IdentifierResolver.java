...
/**
 * Common interface for a resolver component to produce a unique identifier from a weaker reference (either an unversioned object identifier
 * or an external identifier bundle).
 */
public interface IdentifierResolver {
  ...
  /**
   * Resolves the objects loosely specified by identifier bundles to exact unique identifiers. This is a bulk version of {@link #resolveExternalId}
   * that should be more efficient than calling it repeatedly.
   *
  ...
  /**
   * Resolves the objects loosely specified by object identifiers to exact unique identifiers. This is a bulk version of {@link #resolveObjectId}
   * that should be more efficient than calling it repeatedly.
   *
   * @param identifiers the identifiers to resolve, not null and not containing nulls
   * @param versionCorrection the version/correction time to perform the resolution at, not null
