...
/**
 * Exposure of a manager for function blacklisting information. Function blacklists are named to allow multiple ones to exist
 * from a single provider - for example:
 * <ul>
 ...
 * </ul>
 * The underlying implementation may be document based, but blacklists are potentially interactive resources that the view processor,
 * graph executor and remote calculation nodes are reading and writing from simultaneously.
 */
