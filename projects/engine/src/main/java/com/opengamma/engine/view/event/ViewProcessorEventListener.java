...
/**
 * Allows implementers to provide callback methods that will be executed in response to events on a {@link ViewProcessor}.
 */
public interface ViewProcessorEventListener {
   ...
   *
   * @param viewProcessId
   *          the unique identifier of the view process that has been removed
   */
   ...
   *
   * @param viewClientId
   *          the unique identifier of the view client that has been created
   */
   ...
   *
   * @param viewClientId
   *          the unique identifier of the view client that has been removed
   */
