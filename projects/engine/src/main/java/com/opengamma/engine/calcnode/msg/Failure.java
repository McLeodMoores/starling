...
public class Failure extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitFailureMessage (this); }
  ...
  public Failure (final com.opengamma.engine.calcnode.CalculationJobSpecification job, final String errorMessage, final String computeNodeId) {
    if (job == null) {
    ...
    if (computeNodeId == null) {
      throw new NullPointerException ("computeNodeId' cannot be null");
    }
  ...
  protected Failure (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Failure - field 'job' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Failure - field 'errorMessage' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Failure - field 'computeNodeId' is not present");
    }
    try {
  ...
  public Failure (final com.opengamma.engine.calcnode.CalculationJobSpecification job, final String errorMessage, final String computeNodeId, final com.opengamma.engine.calcnode.msg.Ready ready) {
    if (job == null) {
      throw new NullPointerException ("'job' cannot be null");
    } else {
      _job = job;
  ...
  protected Failure (final Failure source) {
    ...
    if (source._ready == null) {
      _ready = null;
    } else {
      _ready = source._ready.clone ();
    }
  }
  @Override
  ...
  public static Failure fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.calcnode.msg.Failure".equals (className)) {
        break;
      }
      try {
  ...
  public void setComputeNodeId (final String computeNodeId) {
    if (computeNodeId == null) {
      throw new NullPointerException ("computeNodeId' cannot be null");
    }
    _computeNodeId = computeNodeId;
  ...
  public void setReady (final com.opengamma.engine.calcnode.msg.Ready ready) {
    if (ready == null) {
      _ready = null;
    } else {
      _ready = ready.clone ();
