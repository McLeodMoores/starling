...
public interface ComputationTargetTypeVisitor<D, T> {
   ...
   *
   * @param types the sequence of types, not null and containing at least two elements. The outermost type is listed first, for example
   * {@code [PORTFOLIO_NODE, POSITION]}.
   * @param data the data parameter passed to the visitor operation
   * @return the result of the visitor operation
   */
