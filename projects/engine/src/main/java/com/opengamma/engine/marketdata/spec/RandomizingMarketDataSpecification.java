...
/**
 * Specifies a source of market data that decorates an underlying source and ticks at random intervals with random perturbations.
 */
@BeanDefinition
public final class RandomizingMarketDataSpecification implements ImmutableBean, MarketDataSpecification {
   ...
   *
   * @param underlying
   *          Specification of the underlying source of market data
   * @param updateProbability
   *          Probability of a value updating during a cycle
   * @param maxPercentageChange
   *          The maximum percentage change of any value in a single cycle
   * @param averageCycleInterval
   *          The average interval between calculation cycles in milliseconds. The actual interval is a random value +/- 50% of this value.
  ...
  /**
   * Creates a specification with an update probability of 0.2, maximum change of 5% and average cycle interval of 1000ms.
   *
   * @param underlying
   *          Specification of the underlying source of market data
   * @return the Randomizing market data specification
  ...
  static {
    MetaBean.register(RandomizingMarketDataSpecification.Meta.INSTANCE);
  }
