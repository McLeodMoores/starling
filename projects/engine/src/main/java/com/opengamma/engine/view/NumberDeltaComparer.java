...
public class NumberDeltaComparer implements DeltaComparer<Number> {
   ...
   */
  public NumberDeltaComparer(final int decimalPlaces) {
    _decimalPlaces = decimalPlaces;
    _multiplier = Math.pow(10, decimalPlaces);
  }

  @Override
  public boolean isDelta(final Number previousValue, final Number newValue) {
    ...
    final long previousCompare = (long) (previousValue.doubleValue() * _multiplier);
    final long newCompare = (long) (newValue.doubleValue() * _multiplier);
  ...
  public static NumberDeltaComparer fromFudgeMsg(final FudgeDeserializer fudgeContext, final FudgeMsg msg) {
  ...
  public boolean equals(final Object obj) {
    ...
    final NumberDeltaComparer other = (NumberDeltaComparer) obj;
