...
public class IsAlive extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitIsAliveMessage (this); }
  ...
  public IsAlive (final java.util.Collection<? extends com.opengamma.engine.calcnode.CalculationJobSpecification> job) {
    if (job == null) {
  ...
  protected IsAlive (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a IsAlive - field 'job' is not present");
    }
  ...
  public static IsAlive fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.calcnode.msg.IsAlive".equals (className)) {
        break;
      }
      try {
