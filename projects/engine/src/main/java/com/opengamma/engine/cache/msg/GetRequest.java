...
public class GetRequest extends com.opengamma.engine.cache.msg.CacheMessage implements java.io.Serializable {
  @Override
  public CacheMessage accept (final CacheMessageVisitor visitor) { return visitor.visitGetRequest (this); }
  ...
  public GetRequest (final com.opengamma.id.UniqueId viewCycleId, final String calculationConfigurationName, final java.util.Collection<? extends Long> identifier) {
    if (viewCycleId == null) {
  ...
  protected GetRequest (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a GetRequest - field 'viewCycleId' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a GetRequest - field 'calculationConfigurationName' is not present");
    }
    try {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a GetRequest - field 'identifier' is not present");
    }
  ...
  public GetRequest (final Long correlationId, final com.opengamma.id.UniqueId viewCycleId, final String calculationConfigurationName, final java.util.Collection<? extends Long> identifier) {
    super (correlationId);
    if (viewCycleId == null) {
      throw new NullPointerException ("'viewCycleId' cannot be null");
    } else {
  ...
  public static GetRequest fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.cache.msg.GetRequest".equals (className)) {
        break;
      }
      try {
