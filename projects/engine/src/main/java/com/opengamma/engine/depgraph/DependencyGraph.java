...
public interface DependencyGraph {
  ...
  /**
   * Returns the set of output values from the graph that are marked as terminal outputs. These are the result of the requested values that
   * drove the graph construction and will not be pruned. Any other output values in the graph are intermediate values required by the
   * functions used to deliver the requested terminal outputs.
   *
