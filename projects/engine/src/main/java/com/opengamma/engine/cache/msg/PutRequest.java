...
public class PutRequest extends com.opengamma.engine.cache.msg.CacheMessage implements java.io.Serializable {
  @Override
  public CacheMessage accept (final CacheMessageVisitor visitor) { return visitor.visitPutRequest (this); }
  ...
  public PutRequest (final com.opengamma.id.UniqueId viewCycleId, final String calculationConfigurationName, final java.util.Collection<? extends Long> identifier, final java.util.Collection<? extends org.fudgemsg.FudgeMsg> data) {
    if (viewCycleId == null) {
  ...
  protected PutRequest (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a PutRequest - field 'viewCycleId' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a PutRequest - field 'calculationConfigurationName' is not present");
    }
    try {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a PutRequest - field 'identifier' is not present");
    }
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a PutRequest - field 'data' is not present");
    }
  ...
  public PutRequest (final Long correlationId, final com.opengamma.id.UniqueId viewCycleId, final String calculationConfigurationName, final java.util.Collection<? extends Long> identifier, final java.util.Collection<? extends org.fudgemsg.FudgeMsg> data) {
    super (correlationId);
    if (viewCycleId == null) {
      throw new NullPointerException ("'viewCycleId' cannot be null");
    } else {
  ...
  public static PutRequest fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.cache.msg.PutRequest".equals (className)) {
        break;
      }
      try {
