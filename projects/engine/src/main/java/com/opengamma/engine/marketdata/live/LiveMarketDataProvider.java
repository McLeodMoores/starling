...
/**
 * Represents a source of live market data from which the engine can obtain a consistent snapshot and receive notifications of changes.
 */
@PublicSPI
public interface LiveMarketDataProvider extends MarketDataProvider {
   ...
   */
  boolean isActive(ValueSpecification specification);
