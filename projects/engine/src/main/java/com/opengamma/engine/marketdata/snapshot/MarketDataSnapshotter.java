...
public interface MarketDataSnapshotter {
   ...
   *          The client to use
   * @param cycle
   *          The cycle on which to base the snapshot
  ...
  /**
   * Provides the specifications for interesting values for yield curves included in the given cycle. Grouped by yield curve key and value name.
   *
   * Currently includes - The curve specification - The nodal curve - The interpolated curve
   * 
   * @param client
   *          The client to use
   * @param cycle
