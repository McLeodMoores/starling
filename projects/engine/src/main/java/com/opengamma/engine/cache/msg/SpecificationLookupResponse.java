...
public class SpecificationLookupResponse extends com.opengamma.engine.cache.msg.CacheMessage implements java.io.Serializable {
  @Override
  public CacheMessage accept (final CacheMessageVisitor visitor) { return visitor.visitSpecificationLookupResponse (this); }
  ...
  public SpecificationLookupResponse (final java.util.Collection<? extends com.opengamma.engine.value.ValueSpecification> specification) {
  ...
  protected SpecificationLookupResponse (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a SpecificationLookupResponse - field 'specification' is not present");
    }
  ...
  public SpecificationLookupResponse (final Long correlationId, final java.util.Collection<? extends com.opengamma.engine.value.ValueSpecification> specification) {
    super (correlationId);
    if (specification == null) {
      throw new NullPointerException ("'specification' cannot be null");
    } else {
  ...
  public static SpecificationLookupResponse fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.cache.msg.SpecificationLookupResponse".equals (className)) {
        break;
      }
      try {
