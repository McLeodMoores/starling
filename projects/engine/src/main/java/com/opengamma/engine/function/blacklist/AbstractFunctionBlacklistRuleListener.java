...
/**
 * Partial implementation of {@link FunctionBlacklistRuleListener}. A full set of rules is queried initially and whenever the modification
 * count changes unexpectedly. The listener can only be associated with a single blacklist which must be specified at construction.
 */
