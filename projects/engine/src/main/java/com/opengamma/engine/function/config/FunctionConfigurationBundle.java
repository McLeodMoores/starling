...
public class FunctionConfigurationBundle extends DirectBean implements Serializable {
  ...
  private final List<FunctionConfiguration> _functions = Lists.newArrayList();
  ...
  public void addFunctions(final FunctionConfiguration functionConfiguration) {
  ...
  static {
    MetaBean.register(FunctionConfigurationBundle.Meta.INSTANCE);
  }
  ...
  /**
   * Sets the functions.
   * @param functions  the new value of the property, not null
   */
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends FunctionConfigurationBundle> builder() {
      return new DirectBeanBuilder<>(new FunctionConfigurationBundle());
    }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((FunctionConfigurationBundle) bean)._functions, "functions");
    }
