...
public class Result extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitResultMessage (this); }
  ...
  public Result (final com.opengamma.engine.calcnode.CalculationJobResult result) {
    if (result == null) {
  ...
  protected Result (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Result - field 'result' is not present");
    }
    try {
  ...
  public Result (final com.opengamma.engine.calcnode.CalculationJobResult result, final com.opengamma.engine.calcnode.msg.Ready ready) {
    if (result == null) {
      throw new NullPointerException ("'result' cannot be null");
    } else {
      _result = result;
  ...
  public static Result fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.calcnode.msg.Result".equals (className)) {
        break;
      }
      try {
  ...
  public void setResult (final com.opengamma.engine.calcnode.CalculationJobResult result) {
    if (result == null) {
      throw new NullPointerException ("'result' cannot be null");
    } else {
      _result = result;
