...
/* package */interface ResolvedValueProducer {
   ...
   * @return a handle for removing the callback, or null if there is nothing to cancel (e.g. a failure call was made inline)
   * or a cancellation can't be supported.
   */
