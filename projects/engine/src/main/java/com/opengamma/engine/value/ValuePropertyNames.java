 ...
 * <p>
 * These name are used as keys to define specific value properties for the engine. They should be used by a
 * {@link com.opengamma.engine.function.FunctionDefinition} to annotate their requirements or provide additional context about their
 * outputs.
 */
@PublicAPI
public final class ValuePropertyNames {
   ...
   * <p>
   * This should be used where there are multiple possible behaviors from functions to produce an aggregate value. For example, input values
   * that cannot be combined directly might either be discarded or converted; this property will indicate which. Note that in such
   * circumstances the priority of each function in the repository is important to force "default" behaviors if no explicit aggregation
   * constraint is made when requesting the produced value
   */
   ...
   * <p>
   * This should only be used where it is meaningful to describe a value with a single country instead of a currency (e.g. a bond issued by
   * a euro-zone country).
   */
  public static final String COUNTRY = "Country";

  /**
   * The symbolic name of a volatility cube used to produce a value, valid within the naming context of the function repository containing
   * the function definition used.
   * <p>
   * This should only be used where it is meaningful to describe a value based on a single cube. If produced by functions requiring multiple
   * cube inputs, a suitable prefix should be used to differentiate the input cubes.
   */
   ...
   * <p>
   * This should only be used where it is meaningful to describe a value with a single currency. For example, an exchange rate should not
   * make use of this property.
   */
  public static final String CURRENCY = "Currency";

  /**
   * The symbolic name of a curve used to produce a value, valid within the naming context of the function repository containing the
   * function definition used.
   * <p>
   * This should only be used where it is meaningful to describe a value based on a single curve. If produced by functions requiring
   * multiple curve inputs, a suitable prefix should be used to differentiate the input curves.
   */
  public static final String CURVE = "Curve";

  /**
   * The currency of the curve used to produce a value. This does not necessarily imply anything about the currency of the output value.
   */
  public static final String CURVE_CURRENCY = "CurveCurrency";

  /**
   * The data provider used to source external values into the view cycle. This may be used by
   * {@link com.opengamma.engine.marketdata.availability.MarketDataAvailabilityProvider} instances that work with multiple underlying
   * providers to indicate which data provider should be queried for the value. In the case of a "route" of nested data providers existing,
   * the {@code /} character can be used as a separator between elements.
   */
   ...
   * <p>
   * If there are multiple functions in a repository that can compute a given value, this can be used as a constraint to force a particular
   * one to be used.
   * <p>
   * The result {@link ValueSpecification} objects created by functions must always include an appropriate function identifier.
   */
  public static final String FUNCTION = "Function";

  /**
   * The symbolic name of a curve used to produce an analytic value from an instrument that requires more than one curve (e.g. FX forwards,
   * where the pay curve is the curve used to discount the pay amount, or FX options, where the pay curve is the curve used to discount the
   * put amount).
   */
  ...
  /**
   * The symbolic name of a curve used to produce an analytic value from an instrument that requires more than one curve (e.g. FX forwards,
   * where the receive curve is the curve used to discount the receive amount, or FX options, where the receive curve is the curve used to
   * discount the call amount).
   */
  public static final String RECEIVE_CURVE = "ReceiveCurve";

  /**
   * The name of the curve calculation configuration used for the pay leg of an instrument (e.g. an FX forward or a cross-currency swap).
   */
  public static final String PAY_CURVE_CALCULATION_CONFIG = "PayCurveCalculationConfig";

  /**
   * The name of the curve calculation configuration used for the receive leg of an instrument (e.g. an FX forward or a cross-currency
   * swap).
   */
  public static final String RECEIVE_CURVE_CALCULATION_CONFIG = "ReceiveCurveCalculationConfig";

  /**
   * The symbolic name of a surface used to produce a value, valid within the naming context of the function repository containing the
   * function definition used.
   * <p>
   * This should only be used where it is meaningful to describe a value based on a single surface. If produced by functions requiring
   * multiple surface inputs, a suitable prefix should be used to differentiate the input surfaces.
   */
  ...
  /**
   * A reserved output prefix. No function should ever produce output values with properties that start with this. It is therefore safe for
   * functions to use it to prefix an optional constraint on inputs that can never influence resolution, but serve to distinguish one from
   * the other.
   */
   ...
   * 
   * @deprecated this was used to refer to configurations that have been deleted
   */
  @Deprecated
  ...
  /**
   * The name for a property describing the shift of the strike when approximating a binary option as a call or put spread.
   */
  public static final String BINARY_OVERHEDGE = "BinaryOverhedge";

  /**
   * The name for a property describing the full width of the spread between the two calls or puts used when approximating a binary option
   * as a call or put spread.
   */
  ...
  // REVIEW 2013-01-02 emcleod -- In the case of DV01, "Shift" refers to the scale factor applied (1 or -1). It was added to allow
  ...
  /**
   * The underlying ticker is used in Equity Options to tie results to the vol surface used, such that each column may represent, for
   * example, the vega of all positions sensitive to changes in that specific surface.
   */
  ...
  /**
   * The name of a property that provides the name of a discounting curve.
   * <p>
  ...
  /**
   * Property used to choose whether market data is to be snapped Live or at last Close.
   * <p>
