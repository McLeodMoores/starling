...
/**
 * Callback interface for receiving notifications about rules that have been added or removed from a blacklist. Actions should be minimal as they may be
 * blocking the caller which triggered the update. If a complex action is required, or one that will make calls while holding monitors that could
 * otherwise cause deadlocks, the supplied executor should be used to defer it.
 */
