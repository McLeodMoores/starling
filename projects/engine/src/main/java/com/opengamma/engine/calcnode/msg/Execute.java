...
public class Execute extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitExecuteMessage (this); }
  ...
  public Execute (final com.opengamma.engine.calcnode.CalculationJob job) {
    if (job == null) {
  ...
  protected Execute (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Execute - field 'job' is not present");
    }
    try {
  ...
  public static Execute fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.calcnode.msg.Execute".equals (className)) {
        break;
      }
      try {
  ...
  public void setJob (final com.opengamma.engine.calcnode.CalculationJob job) {
    if (job == null) {
      throw new NullPointerException ("'job' cannot be null");
    } else {
      _job = job;
