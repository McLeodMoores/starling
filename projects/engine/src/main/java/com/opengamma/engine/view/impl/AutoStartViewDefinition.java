...
/**
 * Defines a view and execution options that should be started automatically when the engine starts.
 */
@BeanDefinition
public final class AutoStartViewDefinition implements ImmutableBean {
   ...
   *
   * @param underlyingViewDefinitionId
   *          the id of the view to be started
  ...
  static {
    MetaBean.register(AutoStartViewDefinition.Meta.INSTANCE);
  }
