...
public final class LiveMarketDataSpecification implements ImmutableBean, MarketDataSpecification {
  ...
  public static LiveMarketDataSpecification of(final String dataSource) {
    final String trimmedDataSource = StringUtils.trimToNull(dataSource);
    ArgumentChecker.notNull(trimmedDataSource, "dataSource");
    return new LiveMarketDataSpecification(trimmedDataSource);
  }
  ...
  static {
    MetaBean.register(LiveMarketDataSpecification.Meta.INSTANCE);
  }
