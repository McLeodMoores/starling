...
public class Ready extends com.opengamma.engine.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  @Override
  public void accept (final RemoteCalcNodeMessageVisitor visitor) { visitor.visitReadyMessage (this); }
  private static final long serialVersionUID = -2059821179804l;
  private int _capacity;
  public static final String CAPACITY_KEY = "capacity";
  private String _hostId;
  public static final String HOST_ID_KEY = "hostId";
  public Ready (final int capacity, final String hostId) {
    _capacity = capacity;
    if (hostId == null) {
      throw new NullPointerException ("hostId' cannot be null");
    }
    _hostId = hostId;
  }
  protected Ready (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Ready - field 'capacity' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a Ready - field 'hostId' is not present");
    }
    try {
  ...
  public static Ready fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.engine.calcnode.msg.Ready".equals (className)) {
        break;
      }
      try {
