...
public interface FunctionExclusionGroups {
  ...
  /**
   * Tests if the current exclusion group is covered by a group already in the collection. This may typically be a {@link Collection#contains}
   * call on the existing collection, or a more elaborate check.
   *
