...
public class PortfolioPermissionChecker {
   ...
   */
  public PortfolioPermissionChecker(final Portfolio portfolio, final NodeChecker nodeChecker) {
   ...
   */
  public PortfolioPermission permissionCheck(final PortfolioNode node) {
