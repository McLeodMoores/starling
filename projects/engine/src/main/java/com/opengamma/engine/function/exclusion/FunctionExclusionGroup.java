...
/**
 * A group of functions whose outputs cannot be applied as inputs directly to any other functions in the group when operating on the
 * same value requirement name. This is to work around inefficiencies in the graph building algorithm when used with, for example, the
 * default property function pattern used in OG-Financial. Not strictly part of a function definition, the exclusion groups have been
