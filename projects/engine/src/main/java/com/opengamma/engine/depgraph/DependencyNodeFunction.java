...
public interface DependencyNodeFunction {
   ...
   * <p>
   * Note that this is mainly provided for compatibility between the non-serializable {@link ParameterizedFunction} instances used in
   * resolution rules and graph construction, and {@link DependencyNodeFunctionImpl} instances which may have been returned from a
   * cache or passed another serialization boundary.
   */
