...
public class PortfolioHtsResolverTool extends AbstractTool<IntegrationToolContext> {
  ...
  protected void doRun() {
    ...
    final PositionWriter positionWriter = new PrettyPrintingPositionWriter(getCommandLine().hasOption(VERBOSE_OPT));

    // Construct portfolio reader
    final PositionReader positionReader = new MasterPositionReader(
