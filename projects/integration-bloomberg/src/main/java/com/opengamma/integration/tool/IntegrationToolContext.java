...
public class IntegrationToolContext extends ToolContext implements BloombergToolContext {
  ...
  public List<LiveDataMetaDataProvider> getLiveDataMetaDataProviders() {
    ...
    final List<ComponentInfo> componentInfos = _componentServer.getComponentInfos(LiveDataMetaDataProvider.class);
    final List<LiveDataMetaDataProvider> results = new ArrayList<>();
    for (final ComponentInfo info : componentInfos) {
      try {
        final String clazzName = info.getAttribute(ComponentInfoAttributes.REMOTE_CLIENT_JAVA);
        if (clazzName == null) {
          continue;
        }
  ...
  static {
    MetaBean.register(IntegrationToolContext.Meta.INSTANCE);
  }
  ...
  public static class Meta extends ToolContext.Meta {
    ...
    public BeanBuilder<? extends IntegrationToolContext> builder() {
      return new DirectBeanBuilder<>(new IntegrationToolContext());
    }
