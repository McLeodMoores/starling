...
public final class RegressionReferenceData implements ImmutableBean {
   ...
   */
  public static RegressionReferenceData create(final ImmutableMap<String, ReferenceData> referenceData) {
  ...
  static {
    MetaBean.register(RegressionReferenceData.Meta.INSTANCE);
  }
