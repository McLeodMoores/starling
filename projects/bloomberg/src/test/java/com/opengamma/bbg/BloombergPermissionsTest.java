...
public class BloombergPermissionsTest {
  ...
  public void testCreateEidPermission() {
    final Permission expected = AuthUtils.getPermissionResolver().resolvePermission(BloombergPermissions.EID_PREFIX + "1234");
    assertEquals(expected, BloombergPermissions.createEidPermission(1234));
  }

  public void testCreateEidPermissionString() {
    final String expected = BloombergPermissions.EID_PREFIX + "1234";
  ...
  public void testExtractEidNull() {
   ...
   */
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testExtractEidEmpty() {
   ...
   */
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testExtractEidInvalid() {
