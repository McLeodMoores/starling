...
public class LoggedReferenceData {
   ...
   */
  public LoggedReferenceData(final String security, final String field, final Object value) {
    super();
    _security = security;
    _field = field;
    _value = value;
  ...
  public static LoggedReferenceData fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg message) {
    final FudgeField fieldValueField = message.getByName(FIELD_VALUE_FIELD);
    final Object fieldValue = fieldValueField != null ? deserializer.fieldValueToObject(fieldValueField) : null;
