...
public class CombiningBloombergLiveDataServer extends CombiningLiveDataServer {
  ...
  public CombiningBloombergLiveDataServer(
      final FakeSubscriptionBloombergLiveDataServer fakeServer,
      final BloombergLiveDataServer realServer,
      final FakeSubscriptionSelector selector,
  ...
  //-------------------------------------------------------------------------
  @Override
  protected Map<StandardLiveDataServer, Collection<LiveDataSpecification>> groupByServer(final Collection<LiveDataSpecification> specs) {
    final ObjectsPair<Collection<LiveDataSpecification>, Collection<LiveDataSpecification>> split = _selector.splitShouldFake(_fakeServer, specs);
    final Map<StandardLiveDataServer, Collection<LiveDataSpecification>> mapped = new HashMap<>();
