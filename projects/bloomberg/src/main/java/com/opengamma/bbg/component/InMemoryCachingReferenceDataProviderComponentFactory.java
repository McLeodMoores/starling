...
public class InMemoryCachingReferenceDataProviderComponentFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) throws Exception {
    final InMemoryCachingReferenceDataProvider provider = new InMemoryCachingReferenceDataProvider(getUnderlying());

    final ComponentInfo info = new ComponentInfo(ReferenceDataProvider.class, _classifier);
  ...
  static {
    MetaBean.register(InMemoryCachingReferenceDataProviderComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends InMemoryCachingReferenceDataProviderComponentFactory> builder() {
      return new DirectBeanBuilder<>(new InMemoryCachingReferenceDataProviderComponentFactory());
    }
