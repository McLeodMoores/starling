...
public class BloombergSecurityProviderComponentFactory extends SecurityProviderComponentFactory {
  ...
  //-------------------------------------------------------------------------
  @Override
  protected BloombergSecurityProvider createSecurityProvider(final ComponentRepository repo) {
    final ExchangeDataProvider exchangeDataProvider = initExchangeDataProvider(repo);
    return new BloombergSecurityProvider(getReferenceDataProvider(), exchangeDataProvider);
  }

  protected ExchangeDataProvider initExchangeDataProvider(final ComponentRepository repo) {
  ...
  static {
    MetaBean.register(BloombergSecurityProviderComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends SecurityProviderComponentFactory.Meta {
    ...
    public BeanBuilder<? extends BloombergSecurityProviderComponentFactory> builder() {
      return new DirectBeanBuilder<>(new BloombergSecurityProviderComponentFactory());
    }
