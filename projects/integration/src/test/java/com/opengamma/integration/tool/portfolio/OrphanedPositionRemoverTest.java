...
public class OrphanedPositionRemoverTest {
  ...
  private ManageablePortfolioNode generatePortfolio() {
    final ManageablePortfolioNode rootNode = new ManageablePortfolioNode("Port1");
    rootNode.addPosition(_pos1.getUniqueId());

    final ManageablePortfolioNode pn2 = new ManageablePortfolioNode("pn2");
    pn2.addPosition(_pos2.getUniqueId());

    final ManageablePortfolioNode pn3 = new ManageablePortfolioNode("pn3");
  ...
  public void removeOrphanedPosition() {
    ...
    final OrphanedPositionRemover positionRemover = new OrphanedPositionRemover(_portfolioMaster, _positionMaster);
    positionRemover.run();
