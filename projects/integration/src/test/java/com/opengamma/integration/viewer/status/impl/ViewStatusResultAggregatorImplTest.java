...
public class ViewStatusResultAggregatorImplTest {
  ...
  public void aggregateByTargetTypeSecurityValueNameCurrency() {
    final ViewStatusModel statusModel = _aggregator.aggregate(AggregateType.of("TSVC"));
  ...
  public void aggregateBySecurityCurrencyValueNameTargetType() {
    final ViewStatusModel statusModel = _aggregator.aggregate(AggregateType.of("SCVT"));
    assertNotNull(statusModel);
  ...
  public void targetSecurityValueCurrencyHeaders() {
    final ViewStatusModel model = _aggregator.aggregate(AggregateType.of("TSVC"));
    assertNotNull(model);
  ...
  public void targetSecurityCurrencyValueHeaders() {
    final ViewStatusModel model = _aggregator.aggregate(AggregateType.of("TSCV"));
    assertNotNull(model);
  ...
  public void defaultHeaders() {
    final ViewStatusModel model = _aggregator.aggregate(AggregateType.NO_AGGREGATION);
