...
public class ViewStatusOptionTest {
  ...
  static {
    final MarketDataSnapshotMaster snapshotMaster = mock(MarketDataSnapshotMaster.class);
  ...
  public void defaultOptions() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME };
    final ViewStatusOption statusOption = ViewStatusOption.getViewStatusReporterOption(PARSER.parse(OPTIONS, args), TOOL_CONTEXT);
  ...
  public void invalidSeparatorForUserOption() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME, "-u", "test~127.0.0.1" };
  ...
  public void blankUsernamePasswordForUserOption() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME, "-u", "/" };
    ViewStatusOption.getViewStatusReporterOption(PARSER.parse(OPTIONS, args), TOOL_CONTEXT);
  }

  public void liveMarketDataOption() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME, "--live", "liveMarketData" };
    final ViewStatusOption statusOption = ViewStatusOption.getViewStatusReporterOption(PARSER.parse(OPTIONS, args), TOOL_CONTEXT);
    assertNotNull(statusOption);
    ...
    final LiveMarketDataSpecification marketDataSpecification = (LiveMarketDataSpecification) statusOption.getMarketDataSpecification();
    assertEquals("liveMarketData", marketDataSpecification.getDataSource());
  }

  public void historicalMarketDataOption() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME, "--historical", "2013-06-20/timeSeriesResolverKey" };
    final ViewStatusOption statusOption = ViewStatusOption.getViewStatusReporterOption(PARSER.parse(OPTIONS, args), TOOL_CONTEXT);
    assertNotNull(statusOption);
    assertTrue(statusOption.getMarketDataSpecification() instanceof FixedHistoricalMarketDataSpecification);
    final FixedHistoricalMarketDataSpecification marketDataSpecification = (FixedHistoricalMarketDataSpecification) statusOption.getMarketDataSpecification();
  ...
  public void invalidDateHistoricalMarketDataOption() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME, "--historical", "xxxx/timeSeriesResolverKey" };
    ViewStatusOption.getViewStatusReporterOption(PARSER.parse(OPTIONS, args), TOOL_CONTEXT);
  }

  public void userMarketDataOption() throws Exception {
    final String[] args = { "-n", PORTFOLIO_NAME, "--snapshot", "snaphshotName" };
    final ViewStatusOption statusOption = ViewStatusOption.getViewStatusReporterOption(PARSER.parse(OPTIONS, args), TOOL_CONTEXT);
    assertNotNull(statusOption);

    assertTrue(statusOption.getMarketDataSpecification() instanceof UserMarketDataSpecification);
    final UserMarketDataSpecification marketDataSpecification = (UserMarketDataSpecification) statusOption.getMarketDataSpecification();
