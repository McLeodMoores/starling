...
public class CurrencyPairsConfigDocumentLoader {
   ...
   */
  public CurrencyPairsConfigDocumentLoader(final ConfigMaster configMaster, final String dataFilePath, final String configName) {
   ...
   */
  private void savePairs(final Set<CurrencyPair> pairs) {
    final CurrencyPairs currencyPairs = CurrencyPairs.of(pairs);
    final ConfigItem<CurrencyPairs> configDocument = ConfigItem.of(currencyPairs, _configName, CurrencyPairs.class);
   ...
   */
  /* package */ Set<CurrencyPair> readPairs(final BufferedReader reader) throws IOException {
    String pairStr;
