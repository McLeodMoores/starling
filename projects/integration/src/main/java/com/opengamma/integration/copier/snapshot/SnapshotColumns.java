...
public enum SnapshotColumns {
  ...
  /**
   * ValueSnapshot object, needed to preserve null valueSnapshots and deal with objects other than doubles and dates.
   */
  ...
  /**
   * @return Snapshot columns {TYPE, NAME, INSTANT, YIELD_CURVE_CURRENCY, SURFACE_TARGET, SURFACE_INSTRUMENT_TYPE, SURFACE_QUOTE_TYPE, SURFACE_QUOTE_UNITS,
   *         ID_BUNDLE, VALUE_NAME, MARKET_VALUE, VALUE_OBJECT, OVERRIDE_VALUE, SURFACE_X, SURFACE_Y }
   */
