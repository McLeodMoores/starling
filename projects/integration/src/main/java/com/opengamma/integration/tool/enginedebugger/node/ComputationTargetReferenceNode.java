...
public class ComputationTargetReferenceNode implements TreeTableNode {
  ...
  public ComputationTargetReferenceNode(final Object parent, final ComputationTargetReference targetReference) {
    _parent = parent;
  ...
  public Object getChildAt(final int index) {
    if (_targetReference instanceof ComputationTargetRequirement) {
      final ComputationTargetRequirement requirement = _targetReference.getRequirement();
      switch (index) {
        case 0:
  ...
  public int getIndexOfChild(final Object child) {
    if (child instanceof ComputationTargetTypeNode) {
      ...
      final ComputationTargetRequirement targetRequirement = (ComputationTargetRequirement) _targetReference;
      ...
      final ComputationTargetSpecification targetSpec = (ComputationTargetSpecification) _targetReference;
  ...
  public boolean equals(final Object obj) {
    ...
    final ComputationTargetReferenceNode other = (ComputationTargetReferenceNode) obj;
    if (_targetReference == null) {
