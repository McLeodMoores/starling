...
/**
 * Shifts a spot rate. If the shift type is {@link ScenarioShiftType#ABSOLUTE absolute} the shift amount is added to the rate. If the shift type is
 * {@link ScenarioShiftType#RELATIVE relative} the rate is multiplied by (1 + shift amount). This means a shift of +10% scales a value by 1.1 and a shift of
 * -20% scales a value by 0.8.
 */
@BeanDefinition
public final class SpotRateShift implements StructureManipulator<Double>, ImmutableBean {
  ...
  static {
    MetaBean.register(SpotRateShift.Meta.INSTANCE);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_shiftType, other._shiftType) &&
          JodaBeanUtils.equal(_shiftAmount, other._shiftAmount) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_shiftAmount);
  ...
  public String toString() {
    ...
    buf.append("shiftAmount").append('=').append(_shiftAmount).append(',').append(' ');
