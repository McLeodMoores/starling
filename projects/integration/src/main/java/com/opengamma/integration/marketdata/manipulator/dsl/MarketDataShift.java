...
/**
 * Shifts a market data value. If the shift type is {@link ScenarioShiftType#ABSOLUTE absolute} the shift amount is added to the value. If the shift type is
 * {@link ScenarioShiftType#RELATIVE relative} the value is multiplied by (1 + shift amount). This means a shift of +10% scales a value by 1.1 and a shift of
...
public final class MarketDataShift implements StructureManipulator<Double>, ImmutableBean {
  ...
  static {
    MetaBean.register(MarketDataShift.Meta.INSTANCE);
  }
