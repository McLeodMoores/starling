 ...
 */
@Scriptable
public class CurrencyPairsConfigDocumentTool extends AbstractTool<ToolContext> {
  ...
  protected void doRun() {
    ...
    final CurrencyPairsConfigDocumentLoader loader = new CurrencyPairsConfigDocumentLoader(master, args[0], args[1]);
    loader.run();
  }
