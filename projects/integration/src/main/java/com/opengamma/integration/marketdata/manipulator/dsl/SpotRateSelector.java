...
/**
 * Selects values with a requirement name of {@link ValueRequirementNames#SPOT_RATE} and a target type of {@link CurrencyPair} or {@link UnorderedCurrencyPair}.
 * TODO ImmutableBean
 */
@BeanDefinition
public final class SpotRateSelector implements DistinctMarketDataSelector, ImmutableBean {
  ...
  /* package */ SpotRateSelector(final Set<String> calcConfigNames, final Set<CurrencyPair> currencyPairs) {
    ...
    /*
     * for (CurrencyPair currencyPair : currencyPairs) { _unorderedCurrencyPairs.add(UnorderedCurrencyPair.of(currencyPair.getBase(),
  ...
  public DistinctMarketDataSelector findMatchingSelector(final ValueSpecification valueSpecification,
    ...
    /*
     * if (targetType.equals(ComputationTargetType.UNORDERED_CURRENCY_PAIR)) { UnorderedCurrencyPair unorderedCurrencyPair =
     * UnorderedCurrencyPair.parse(idValue); if (!_unorderedCurrencyPairs.contains(unorderedCurrencyPair)) { return null; } } else
     */
  ...
  static {
    MetaBean.register(SpotRateSelector.Meta.INSTANCE);
  }
