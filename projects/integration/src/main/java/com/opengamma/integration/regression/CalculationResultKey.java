...
/**
 * Key for identifying values in results. This is consistent across results generated by different server and database instances. The targets can be positions
 * (in which case {@link #getTargetId positionId} will be non-null) or portfolio nodes.
 */
@BeanDefinition
public final class CalculationResultKey implements ImmutableBean, Comparable<CalculationResultKey> {
  ...
  static {
    MetaBean.register(CalculationResultKey.Meta.INSTANCE);
  }
