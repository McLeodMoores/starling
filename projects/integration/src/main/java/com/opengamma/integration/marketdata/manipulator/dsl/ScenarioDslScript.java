...
/**
 * Configuration object containing a script to define a scenario. The script is written in the Groovy-based scenario DSL.
 */
...
public final class ScenarioDslScript implements ImmutableBean, ScenarioDefinitionFactory {
  ...
  static {
    MetaBean.register(ScenarioDslScript.Meta.INSTANCE);
  }
