...
public interface ViewStatusResultAggregator {
   ...
   *
   * @param aggregateType
   *          the view aggregation type, not null
   ...
   *
   * @param key
   *          the key which is a triple of SecurityType, ValueRequirementName and Currency, not null
   * @param status
   *          the status of the view calculation, i.e VALUE, NO_VALUE or GRAPH_FAIL.
   */
   ...
   *
   * @param key
   *          the key in the key/status pair.
