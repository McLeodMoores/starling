...
/**
 * Checks that a given xmlId to externalSystemId combination is valid. This is important since the {@link PortfolioLoader} expects externalIds to uniquely
 * identify a trade so that it can configure it properly in the database.
 *
 ...
 * <li>Referencing a trade/position from multiple different portfolios. This will cause dupes if external ids are empty.
 * </ul>
 */
