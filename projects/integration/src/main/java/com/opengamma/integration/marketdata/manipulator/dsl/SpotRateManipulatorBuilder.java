...
public class SpotRateManipulatorBuilder {
   ...
   * 
   * @param shiftType
   *          Whether the shift should be absolute or relative. A relative shift is expressed as an amount to add or subtract, e.g. 10% shift = rate * 1.1, -20%
   *          shift = rate * 0.8
   * @param shiftAmount
   *          The amount of the shift
   * @return This builder
   ...
   *          The amount of the shift
   * @param minRate
   *          The minimum value allowed for the rate
   * @param maxRate
   *          The maximum value allowed for the rate
   * @return This builder
   */
   ...
   * 
   * @param scalingFactor
   *          The scaling factor to apply to the rate
   * @param minRate
   *          The minimum value allowed for the rate
   * @param maxRate
   *          The maximum value allowed for the rate
