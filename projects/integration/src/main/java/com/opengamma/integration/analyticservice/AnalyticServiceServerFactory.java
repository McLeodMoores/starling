...
public class AnalyticServiceServerFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) throws Exception {
    ...
    final AnalyticServiceTradeProducer tradeProducer = new AnalyticServiceTradeProducer();
  ...
  static {
    MetaBean.register(AnalyticServiceServerFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends AnalyticServiceServerFactory> builder() {
      return new DirectBeanBuilder<>(new AnalyticServiceServerFactory());
    }
