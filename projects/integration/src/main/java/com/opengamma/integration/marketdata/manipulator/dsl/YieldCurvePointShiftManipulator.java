...
public final class YieldCurvePointShiftManipulator implements ImmutableBean, StructureManipulator<YieldCurve> {
  ...
  /* package */ YieldCurvePointShiftManipulator(final ScenarioShiftType shiftType, final List<YieldCurvePointShift> pointShifts) {
  ...
  public YieldCurve execute(final YieldCurve curve, final ValueSpecification valueSpec, final FunctionExecutionContext executionContext) {
    ...
    final Double[] xData = curve.getCurve().getXData();

    for (final YieldCurvePointShift shift : _pointShifts) {
      final int index = shift.getPointIndex();
  ...
  static {
    MetaBean.register(YieldCurvePointShiftManipulator.Meta.INSTANCE);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_shiftType, other._shiftType) &&
          JodaBeanUtils.equal(_pointShifts, other._pointShifts);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_pointShifts);
    return hash;
  }
