...
/**
 * Provides the ability to copy snapshots within a master, across masters, between streams/files and masters, and between streams/files.
 */
public interface SnapshotCopier {
