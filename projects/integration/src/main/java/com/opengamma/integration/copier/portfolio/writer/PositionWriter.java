...
/**
 * Interface for a portfolio writer, which is able to write positions and securities, and manipulate the portfolio's tree structure.
 */
public interface PositionWriter {
   ...
   * 
   * @param newPath
   *          the new path represented as an array of node names starting from the top of the hierarchy
   */
