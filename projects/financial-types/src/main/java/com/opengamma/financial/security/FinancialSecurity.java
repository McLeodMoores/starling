 ...
 * <p>
 * These securities work with the functions also defined in this project. Applications can choose to use these {@code FinancialSecurity} classes, extend
 * {@link ManageableSecurity} directly or use {@link RawSecurity}.
 */
@PublicSPI
@BeanDefinition
public abstract class FinancialSecurity extends ManageableSecurity {
  ...
  static {
    MetaBean.register(FinancialSecurity.Meta.INSTANCE);
  }
