...
public class FederalFundsFutureSecurityFudgeBuilder extends AbstractFudgeBuilder implements FudgeBuilder<FederalFundsFutureSecurity> {
  ...
  @Override
  public MutableFudgeMsg buildMessage(final FudgeSerializer serializer, final FederalFundsFutureSecurity object) {
    final MutableFudgeMsg msg = serializer.newMessage();
    FederalFundsFutureSecurityFudgeBuilder.toFudgeMsg(serializer, object, msg);
    return msg;
  }

  public static void toFudgeMsg(final FudgeSerializer serializer, final FederalFundsFutureSecurity object, final MutableFudgeMsg msg) {
  ...
  @Override
  public FederalFundsFutureSecurity buildObject(final FudgeDeserializer deserializer, final FudgeMsg msg) {
    final FederalFundsFutureSecurity object = new FederalFundsFutureSecurity();
    FederalFundsFutureSecurityFudgeBuilder.fromFudgeMsg(deserializer, msg, object);
    return object;
  }

  public static void fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg, final FederalFundsFutureSecurity object) {
