...
public class FloatingInterestRateSwapLeg extends InterestRateSwapLeg {
  ...
  /**
   * The schedule for the dates on this leg. Allows the conventions to be overridden with specific dates.
   */
  @PropertyDefinition
  ...
  static {
    MetaBean.register(FloatingInterestRateSwapLeg.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the schedule for the dates on this leg. Allows the conventions to be overridden with specific dates.
   * @return the value of the property
   */
  ...
  /**
   * Sets the schedule for the dates on this leg. Allows the conventions to be overridden with specific dates.
  ...
  public static class Meta extends InterestRateSwapLeg.Meta {
    ...
    public BeanBuilder<? extends FloatingInterestRateSwapLeg> builder() {
      return new DirectBeanBuilder<>(new FloatingInterestRateSwapLeg());
    }
