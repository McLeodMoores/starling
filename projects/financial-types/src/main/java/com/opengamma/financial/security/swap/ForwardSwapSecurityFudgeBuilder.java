...
public class ForwardSwapSecurityFudgeBuilder extends AbstractFudgeBuilder implements FudgeBuilder<ForwardSwapSecurity> {
  ...
  @Override
  public MutableFudgeMsg buildMessage(final FudgeSerializer serializer, final ForwardSwapSecurity object) {
    final MutableFudgeMsg msg = serializer.newMessage();
    ForwardSwapSecurityFudgeBuilder.toFudgeMsg(serializer, object, msg);
    return msg;
  }

  public static void toFudgeMsg(final FudgeSerializer serializer, final ForwardSwapSecurity object, final MutableFudgeMsg msg) {
  ...
  @Override
  public ForwardSwapSecurity buildObject(final FudgeDeserializer deserializer, final FudgeMsg msg) {
    final ForwardSwapSecurity object = new ForwardSwapSecurity();
    ForwardSwapSecurityFudgeBuilder.fromFudgeMsg(deserializer, msg, object);
    return object;
  }

  public static void fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg, final ForwardSwapSecurity object) {
