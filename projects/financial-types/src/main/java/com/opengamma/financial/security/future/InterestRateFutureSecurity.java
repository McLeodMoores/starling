...
public class InterestRateFutureSecurity extends FutureSecurity {
  ...
  public InterestRateFutureSecurity(final Expiry expiry, final String tradingExchange, final String settlementExchange, final Currency currency, final double unitAmount, final ExternalId underlyingIdentifier, final String category) {
