...
public class FloatingSpreadIRLeg extends FloatingInterestRateLeg {
   ...
   *          the spread
   */
  public FloatingSpreadIRLeg(final DayCount dayCount, final Frequency frequency, final ExternalId regionIdentifier,
      ...
      final FloatingRateType floatingRateType, final double spread) {
  ...
  static {
    MetaBean.register(FloatingSpreadIRLeg.Meta.INSTANCE);
  }
  ...
  public static class Meta extends FloatingInterestRateLeg.Meta {
    ...
    public BeanBuilder<? extends FloatingSpreadIRLeg> builder() {
      return new DirectBeanBuilder<>(new FloatingSpreadIRLeg());
    }
