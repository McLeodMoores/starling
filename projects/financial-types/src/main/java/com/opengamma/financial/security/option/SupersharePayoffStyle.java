...
public class SupersharePayoffStyle extends PayoffStyle {
   ...
   */
  public SupersharePayoffStyle(final double upperBound, final double lowerBound) {
  ...
  static {
    MetaBean.register(SupersharePayoffStyle.Meta.INSTANCE);
  }
  ...
  public static class Meta extends PayoffStyle.Meta {
    ...
    public BeanBuilder<? extends SupersharePayoffStyle> builder() {
      return new DirectBeanBuilder<>(new SupersharePayoffStyle());
    }
