...
/**
 * A rate, either constant or a complex schedule. The schedule can contain both absolute values and step changes.
 */
@BeanDefinition
public final class Rate implements ImmutableBean {
  ...
  public enum ShiftType {
    /**
     * Apply an adjustment to the previous amount. e.g. decrease by 10% each step.
     */
    DELTA {
      @Override
    ...
    /**
     * Apply an adjustment to the previous amount. e.g. decrease by 1 each step.
     */
    ADDITIVE {
      @Override
      double getRate(final double previous, final double step) {
     ...
     * @return the rate
     */
    abstract double getRate(double previous, double step);
  }
  ...
  static {
    MetaBean.register(Rate.Meta.INSTANCE);
  }
