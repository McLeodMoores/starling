...
public class CommodityFutureSecurityFudgeBuilder extends AbstractFudgeBuilder {
  ...
  public static void toFudgeMsg(final FudgeSerializer serializer, final CommodityFutureSecurity object, final MutableFudgeMsg msg) {
  ...
  public static void fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg, final CommodityFutureSecurity object) {
