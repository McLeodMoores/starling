...
public class EnergyFutureSecurity extends CommodityFutureSecurity {
   ...
   */
  @Deprecated
  public EnergyFutureSecurity(final Expiry expiry, final String tradingExchange, final String settlementExchange, final Currency currency,
  ...
  static {
    MetaBean.register(EnergyFutureSecurity.Meta.INSTANCE);
  }
  ...
  public static class Meta extends CommodityFutureSecurity.Meta {
    ...
    public BeanBuilder<? extends EnergyFutureSecurity> builder() {
      return new DirectBeanBuilder<>(new EnergyFutureSecurity());
    }
