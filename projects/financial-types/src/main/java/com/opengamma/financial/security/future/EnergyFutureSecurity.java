...
public class EnergyFutureSecurity extends CommodityFutureSecurity {
  ...
  public EnergyFutureSecurity(final Expiry expiry, final String tradingExchange, final String settlementExchange, final Currency currency, final double unitAmount, final String category) {
