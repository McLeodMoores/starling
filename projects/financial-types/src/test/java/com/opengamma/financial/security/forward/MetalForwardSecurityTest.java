...
/**
 * Tests for {@link MetalForwardSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class MetalForwardSecurityTest extends AbstractBeanTestCase {
  ...
  private static final MetalForwardSecurity FORWARD = new MetalForwardSecurity(UNIT_NAME, UNIT_NUMBER, EXPIRY, CCY, UNIT_AMOUNT, CONTRACT_CATEGORY);
  ...
  public void testConstructor() {
    final MetalForwardSecurity forward = new MetalForwardSecurity(UNIT_NAME, UNIT_NUMBER, EXPIRY, CCY, UNIT_AMOUNT, CONTRACT_CATEGORY);
