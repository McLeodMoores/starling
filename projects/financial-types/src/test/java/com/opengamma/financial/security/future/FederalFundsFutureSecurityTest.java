...
/**
 * Tests for {@link FederalFundsFutureSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class FederalFundsFutureSecurityTest extends AbstractBeanTestCase {
  ...
  private static final FederalFundsFutureSecurity FUTURE = new FederalFundsFutureSecurity(EXPIRY, TRADING_EXCHANGE, SETTLEMENT_EXCHANGE, CCY, UNIT_AMOUNT,
      UNDERLYING_ID, CONTRACT_CATEGORY);

  @Override
  public JodaBeanProperties<? extends Bean> getJodaBeanProperties() {
    return new JodaBeanProperties<>(FederalFundsFutureSecurity.class,
  ...
  public void testConstructor() {
    final FederalFundsFutureSecurity future = new FederalFundsFutureSecurity(EXPIRY, TRADING_EXCHANGE, SETTLEMENT_EXCHANGE, CCY, UNIT_AMOUNT, UNDERLYING_ID,
        CONTRACT_CATEGORY);
