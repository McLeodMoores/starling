...
/**
 * Tests for {@link EquityIndexDividendFutureOptionSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class EquityIndexDividendFutureOptionSecurityTest extends AbstractBeanTestCase {
  ...
  public JodaBeanProperties<? extends Bean> getJodaBeanProperties() {
    return new JodaBeanProperties<>(EquityIndexDividendFutureOptionSecurity.class,
  ...
  public void testConstructor() {
    EquityIndexDividendFutureOptionSecurity option = new EquityIndexDividendFutureOptionSecurity();
    ...
    assertEquals(option.getSecurityType(), EquityIndexDividendFutureOptionSecurity.SECURITY_TYPE);
    assertEquals(option.getStrike(), 0.);
    assertNull(option.getUnderlyingId());
    assertFalse(option.isMargined());
    option = new EquityIndexDividendFutureOptionSecurity(EXCHANGE, EXPIRY, EXERCISE_TYPE, UNDERLYING, POINT_VALUE, MARGINED, CCY, STRIKE, OPTION_TYPE);
  ...
  public void testAccept() {
    final EquityIndexDividendFutureOptionSecurity option = new EquityIndexDividendFutureOptionSecurity(EXCHANGE, EXPIRY, EXERCISE_TYPE, UNDERLYING, POINT_VALUE,
        MARGINED, CCY, STRIKE, OPTION_TYPE);
