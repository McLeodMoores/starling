...
public class OvernightIndexTest extends AbstractBeanTestCase {
  /** The index name */
  ...
  public JodaBeanProperties<? extends Bean> getJodaBeanProperties() {
    return new JodaBeanProperties<>(OvernightIndex.class, Arrays.asList("securityType", "name", "description", "conventionId"),
        Arrays.asList(OvernightIndex.INDEX_TYPE, NAME, DESCRIPTION, CONVENTION_ID),
