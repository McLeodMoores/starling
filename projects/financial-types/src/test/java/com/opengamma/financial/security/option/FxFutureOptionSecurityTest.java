...
/**
 * Tests for {@link FxFutureOptionSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class FxFutureOptionSecurityTest extends AbstractBeanTestCase {
  ...
  public JodaBeanProperties<? extends Bean> getJodaBeanProperties() {
    return new JodaBeanProperties<>(FxFutureOptionSecurity.class,
  ...
  public void testConstructor() {
    FxFutureOptionSecurity option = new FxFutureOptionSecurity();
    ...
    assertEquals(option.getSecurityType(), FxFutureOptionSecurity.SECURITY_TYPE);
    ...
    option = new FxFutureOptionSecurity(TRADING_EXCHANGE, SETTLEMENT_EXCHANGE, EXPIRY, EXERCISE_TYPE, UNDERLYING, POINT_VALUE, CCY, STRIKE, OPTION_TYPE);
  ...
  public void testAccept() {
    final FxFutureOptionSecurity option = new FxFutureOptionSecurity(TRADING_EXCHANGE, SETTLEMENT_EXCHANGE, EXPIRY, EXERCISE_TYPE, UNDERLYING, POINT_VALUE, CCY,
        STRIKE, OPTION_TYPE);
