...
public class IborIndexTest extends AbstractBeanTestCase {
  /** The index name */
  ...
  public JodaBeanProperties<? extends Bean> getJodaBeanProperties() {
    return new JodaBeanProperties<>(IborIndex.class, Arrays.asList("securityType", "name", "description", "indexFamilyId", "tenor", "conventionId"),
        Arrays.asList(IborIndex.INDEX_TYPE, NAME, DESCRIPTION, ExternalId.of("eid", "1"), TENOR, CONVENTION_ID),
        Arrays.asList(BondIndex.INDEX_TYPE, "other", "INDEX DESCRIPTION", ExternalId.of("eid", "2"), Tenor.ONE_MONTH, ExternalId.of("eid", "3")));
  }
