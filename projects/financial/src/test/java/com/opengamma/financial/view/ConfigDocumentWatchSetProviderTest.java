...
public class ConfigDocumentWatchSetProviderTest {
  ...
  public void testMissingClass() {
    final ConfigDocumentWatchSetProvider provider = new ConfigDocumentWatchSetProvider(Mockito.mock(ConfigSource.class));
    assertEquals(
        provider.getAdditionalWatchSet(Collections.<ObjectId> singleton(ObjectId.of(ConfigDocumentWatchSetProvider.CONFIG_TYPE_SCHEME, "ClassDoesn'tExist"))),
  ...
  public void testWatches() {
    ...
    assertEquals(
        provider.getAdditionalWatchSet(Collections
            .<ObjectId> singleton(ObjectId.of(ConfigDocumentWatchSetProvider.CONFIG_TYPE_SCHEME, ConfigDocumentWatchSetProviderTest.class.getName()))),
