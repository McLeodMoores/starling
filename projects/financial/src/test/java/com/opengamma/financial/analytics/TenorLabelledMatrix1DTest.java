...
public class TenorLabelledMatrix1DTest {
  ...
  public void testAddMatrix() {
    ...
    assertObjectArrayEquals(
        new Tenor[] { Tenor.ONE_DAY, Tenor.TWO_DAYS, Tenor.ONE_WEEK, Tenor.TWO_WEEKS, Tenor.ONE_MONTH, Tenor.TWO_MONTHS, Tenor.ONE_YEAR, Tenor.TWO_YEARS },
        newMatrix.getKeys());
