...
public class BloombergCommodityFuturePriceCurveInstrumentProviderTest extends FinancialTestBase {
  ...
  private static final BloombergCommodityFuturePriceCurveInstrumentProvider PROVIDER = new BloombergCommodityFuturePriceCurveInstrumentProvider(PREFIX, POSTFIX,
      DATA_FIELD_NAME);
   ...
   */
  @Test
  public void testSoybeanFutureExpiryCalculatorGetExpiryMonth() {
   ...
   */
  @Test
  public void testSoybeanFutureExpiryCalculatorGetExpiryDate() {
