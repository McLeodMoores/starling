...
public class LabelledMatrix1DTest {
  ...
  private static class MyLabelledMatrix1D extends LabelledMatrix1D<Integer, Integer> {
    ...
    MyLabelledMatrix1D(final Integer[] keys, final double[] values) {
      super(keys, values, TOLERANCE);
    }

    MyLabelledMatrix1D(final Integer[] keys, final Object[] labels, final double[] values) {
      super(keys, labels, values, TOLERANCE);
    }

    MyLabelledMatrix1D(final Integer[] keys, final Object[] labels, final String labelsTitle, final double[] values, final String valuesTitle) {
    ...
    @Override
    public LabelledMatrix1D<Integer, Integer> getMatrix(final Integer[] keys, final Object[] labels, final String labelsTitle, final double[] values,
