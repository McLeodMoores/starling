...
public class ModelVolatilitySmileTest extends AnalyticsTestBase {
  ...
  public void testSmileInterpolatorSABR() {
    final SmileInterpolatorSABR interpolator = new SmileInterpolatorSABR(VolatilityFunctionFactory.PAULOT_FORMULA, 0.5,
        WeightingFunctionFactory.LINEAR_WEIGHTING_FUNCTION);
