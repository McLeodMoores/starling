...
public class AUDTest {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(AUDTest.class);
  ...
  public void test() throws Exception {
    ...
    final Resource resourceDeal = ResourceUtils.createResource("classpath:com/opengamma/financial/analytics/test/Trades14Oct.csv");
    final List<IRSwapSecurity> trades = tradeParser.parseCSVFile(resourceDeal.getURL());
