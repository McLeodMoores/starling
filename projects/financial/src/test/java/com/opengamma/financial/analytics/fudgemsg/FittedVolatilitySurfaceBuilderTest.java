...
public class FittedVolatilitySurfaceBuilderTest extends AnalyticsTestBase {
  ...
  private static final double[][] BUTT = new double[][] { { 0.00665, 0.00725, 0.00835, 0.009075, 0.013175, 0.01505, 0.01565, 0.0163, 0.009275, 0.007075, },
    ...
    private static final Interpolator1D EXTRAPOLATOR_1D =
        NamedInterpolator1dFactory.of(DoubleQuadraticInterpolator1dAdapter.NAME, LinearExtrapolator1dAdapter.NAME);
    private static final ForexSmileDeltaSurfaceDataBundle FOREX_DATA = new ForexSmileDeltaSurfaceDataBundle(EXTRAPOLATOR_1D, FORWARDS, EXPIRIES, DELTAS, ATM, RR,
        BUTT, true);
    private static final StandardSmileSurfaceDataBundle STANDARD_DATA = new StandardSmileSurfaceDataBundle(FOREX_DATA.getForwardCurve(), FOREX_DATA.getExpiries(),
        FOREX_DATA.getStrikes(), FOREX_DATA.getVolatilities());
