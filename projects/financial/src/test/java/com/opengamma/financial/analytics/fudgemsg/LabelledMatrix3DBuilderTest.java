...
public class LabelledMatrix3DBuilderTest extends AnalyticsTestBase {
  ...
  public void testDouble() {
    ...
    final Double[] yKeys = new Double[] {1., 2., 3., 4. };
    final Double[] zKeys = new Double[] {1., 2., 3. };
    final DoubleLabelledMatrix3D matrix = new DoubleLabelledMatrix3D(xKeys, X_LABELS, yKeys, Y_LABELS, zKeys, Z_LABELS, VALUES);
