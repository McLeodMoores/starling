...
public class DoubleLabelledMatrix2DTest {
  ...
  private static final double[][] SORTED_VALUES = new double[][] { new double[] { 1, 2, 3, 4, 5 }, new double[] { 2, 4, 6, 8, 10 },
  ...
  public void testAdd() {
    ...
    double[][] values = new double[][] { new double[] { 24, 28 }, new double[] { 30, 35 }, new double[] { 36, 42 }, new double[] { 42, 49 },
        new double[] { 48, 56 } };
    ...
    values = new double[][] { new double[] { 10, 100 }, new double[] { 20, 200 }, new double[] { 30, 300 }, new double[] { 40, 400 },
        new double[] { 50, 500 } };
  ...
  public void testAddWithTolerance() {
    ...
    final double[][] values = new double[][] { new double[] { -10, 10, 100 }, new double[] { -20, 20, 200 }, new double[] { -30, 31, 301 },
        new double[] { -40, 40, 400 }, new double[] { -50, 50, 500 } };
    final DoubleLabelledMatrix2D originalMatrix = new DoubleLabelledMatrix2D(SORTED_X_KEYS, SORTED_X_LABELS2, SORTED_Y_KEYS, SORTED_Y_LABELS2, SORTED_VALUES);
