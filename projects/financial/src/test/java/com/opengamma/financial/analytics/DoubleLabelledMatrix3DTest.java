...
public class DoubleLabelledMatrix3DTest {
  ...
  private static final double[][][] SORTED_VALUES1 = new double[][][] {
    ...
    private static final double[][][] VALUES1 = new double[][][] {
      ...
      private static void testCreationResult(final DoubleLabelledMatrix3D result, final Object[] xLabels, final Object[] yLabels, final Object[] zLabels) {
      ...
      private static void testAddResult(final DoubleLabelledMatrix3D result) {
