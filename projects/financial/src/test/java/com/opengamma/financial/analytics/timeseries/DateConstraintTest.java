...
public class DateConstraintTest {
  ...
  private final LocalDate _referenceDate = LocalDate.of(2010, 4, 23);
  private final LocalDate _nowDate = LocalDate.of(2013, 3, 5);
  ...
  private FunctionExecutionContext mockExecutionContext() {
    ...
    context.setValuationClock(Clock.fixed(_nowDate.atStartOfDay(zone).toInstant(), zone));
    return context;
  }
  ...
  public void testConstructionParseAndEval() {
    testConstructionParseAndEval(DateConstraint.of(_referenceDate), "2010-04-23", _referenceDate);
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME, "Now", _nowDate);
    testConstructionParseAndEval(DateConstraint.NULL, "Null", null);
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.previousWeekDay(), "PreviousWeekDay", _nowDate.minusDays(1));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.previousWeekDay().previousWeekDay(), "PreviousWeekDay(PreviousWeekDay)", _nowDate.minusDays(4));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.nextWeekDay(), "NextWeekDay", _nowDate.plusDays(1));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.nextWeekDay().nextWeekDay(), "NextWeekDay(NextWeekDay)", _nowDate.plusDays(2));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.minus(Period.ofMonths(1)), "-P1M", _nowDate.minusMonths(1));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.plus(Period.ofMonths(1)), "+P1M", _nowDate.plusMonths(1));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.minus(Period.ofMonths(1)).previousWeekDay(), "PreviousWeekDay(-P1M)",
        _nowDate.minusMonths(1).minusDays(1));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.minus(Period.ofMonths(1)).previousWeekDay().plus(Period.ofDays(7)), "PreviousWeekDay(-P1M)+P7D",
        _nowDate.minusMonths(1).plusDays(6));
    testConstructionParseAndEval(DateConstraint.VALUATION_TIME.minus(Period.ofMonths(1)).nextWeekDay().plus(Period.ofDays(7)).nextWeekDay(),
        "NextWeekDay(NextWeekDay(-P1M)+P7D)", _nowDate.minusMonths(1).plusDays(9));
  }
  ...
  public void testParseAndEval() {
    testParseAndEval(DateConstraint.VALUATION_TIME.minus(Period.ofDays(1)), "Now-P1D", _nowDate.minusDays(1));
    testParseAndEval(DateConstraint.VALUATION_TIME.plus(Period.ofDays(1)), "Now+P1D", _nowDate.plusDays(1));
    testParseAndEval(DateConstraint.VALUATION_TIME.previousWeekDay(), "PreviousWeekDay(Now)", _nowDate.minusDays(1));
    testParseAndEval(DateConstraint.VALUATION_TIME.nextWeekDay(), "NextWeekDay(Now)", _nowDate.plusDays(1));
  }
  ...
  public void testNullPreviousWeekDay() {
   ...
   */
  @Test(expectedExceptions = UnsupportedOperationException.class)
  public void testNullNextWeekDay() {
  ...
  public void testLiteral() {
    final DateConstraint x = DateConstraint.of(_referenceDate);
    assertEquals(x.previousWeekDay(), DateConstraint.of(_referenceDate.minusDays(1)));
    assertEquals(x.nextWeekDay(), DateConstraint.of(_referenceDate.plusDays(3)));
    assertEquals(x.plus(Period.ofDays(1)), DateConstraint.of(_referenceDate.plusDays(1)));
    assertEquals(x.minus(Period.ofDays(1)), DateConstraint.of(_referenceDate.minusDays(1)));
    assertEquals(x.periodUntil(DateConstraint.of(_nowDate)), Period.of(2, 10, 10));
  }
