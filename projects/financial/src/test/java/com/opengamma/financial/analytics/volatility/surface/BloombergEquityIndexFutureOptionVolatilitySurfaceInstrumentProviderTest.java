...
public class BloombergEquityIndexFutureOptionVolatilitySurfaceInstrumentProviderTest {
  ...
  private static final LocalDate[] EXPIRY_DATES = new LocalDate[3];
  ...
  private static final BloombergEquityFutureOptionVolatilitySurfaceInstrumentProvider PROVIDER = new BloombergEquityFutureOptionVolatilitySurfaceInstrumentProvider(
