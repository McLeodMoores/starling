...
public class ReflectionInstrumentProviderPopulatorTest {
  ...
  /*
   * @Test(expectedExceptions = RuntimeException.class) public void testWrongDestinationMethodNameForConverter() { final Map<StripInstrumentType,
   * InstrumentProviderPopulator> converters = new EnumMap<>(StripInstrumentType.class); converters.put(StripInstrumentType.CASH, new
   * ReflectionInstrumentProviderPopulator(StripInstrumentType.CASH, "getCashInstrumentProviders", "swapNodeIds", new DefaultCsbcRenamingFunction())); final
   * String name = "DEFAULT"; final Map<Tenor, CurveInstrumentProvider> map = new HashMap<>(); final CurveSpecificationBuilderConfiguration originalConfig = new
   * CurveSpecificationBuilderConfiguration(null, null, null, null, null, null, map, null, null, null, null, null, null, null, null, null, null, null, null);
   * CurveSpecificationBuilderConfigurationConverter.convert("USD", Collections.singletonMap(name, originalConfig), converters); }
   */
}
