...
public class ExternalIdBundleMapperTest {
  ...
  public void testMapper() {
    final ExternalId idA1 = ExternalId.of("TEST_SCHEME_A", "1");
    final ExternalId idB1 = ExternalId.of("TEST_SCHEME_B", "1");
    final ExternalId idC1 = ExternalId.of("TEST_SCHEME_C", "1");
    final ExternalId idD1 = ExternalId.of("TEST_SCHEME_D", "1");
    final ExternalId idA2 = ExternalId.of("TEST_SCHEME_A", "2");
    final ExternalId idB2 = ExternalId.of("TEST_SCHEME_B", "2");

    // first some bundles with overlapping ids.
    final ExternalIdBundle bundleA1B1 = ExternalIdBundle.of(idA1, idB1);
    final ExternalIdBundle bundleB1C1 = ExternalIdBundle.of(idB1, idC1);
    final ExternalIdBundle bundleA1B1C1 = ExternalIdBundle.of(idA1, idB1, idC1);
    final ExternalIdBundle bundleA1B1C1D1 = ExternalIdBundle.of(idA1, idB1, idC1, idD1);
    final ExternalIdBundle bundleA2B2 = ExternalIdBundle.of(idA2, idB2);
    final String testSchemeName = "TEST_SCHEME_1";
    final ExternalIdBundleMapper<String> mapper = new ExternalIdBundleMapper<>(testSchemeName);
    final String obj = "TEST1";
    final UniqueId uniqueId1 = mapper.add(bundleA1B1, obj);
    ...
    final UniqueId uniqueId2 = mapper.add(bundleB1C1, obj);
    ...
    final String obj2 = "TEST2";
    final UniqueId uniqueId3 = mapper.add(bundleA2B2, obj2);
    // check the uniqueId is what we expect.
