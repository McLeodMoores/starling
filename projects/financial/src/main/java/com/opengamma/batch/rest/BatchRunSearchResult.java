...
public class BatchRunSearchResult extends DirectBean {
   ...
   */
  @PropertyDefinition
  private final List<RiskRun> _values = new ArrayList<>();
  ...
  static {
    MetaBean.register(BatchRunSearchResult.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends BatchRunSearchResult> builder() {
      return new DirectBeanBuilder<>(new BatchRunSearchResult());
    }
