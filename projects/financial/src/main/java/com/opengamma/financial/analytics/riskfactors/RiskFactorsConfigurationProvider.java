...
public interface RiskFactorsConfigurationProvider {
   ...
   * <p>
   * If this is not set then risk factors should be generated in their default currency which could be different for each position.
   *
   ...
   *
   * @param currency
   *          the currency for which the forward curve is required, not null
   ...
   *
   * @param futureCode
   *          typically two character future code prefix, e.g. ED.
   * @return the name of the surface
   */
   ...
   *
   * @param tickerPlusMarketSector
   *          bloomberg code for underlying index e.g. DJX Index
   * @return the name of the surface
   */
