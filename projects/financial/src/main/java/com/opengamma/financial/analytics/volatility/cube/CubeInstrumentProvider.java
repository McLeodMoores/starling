...
/**
 * Class that gets an {@link ExternalId} for an (x, y, z) point on a volatility cube. There are no restrictions on how these ids are produced; they could be
 * autogenerated, or pulled out of a map, for example.
 *
 * @param <X>
