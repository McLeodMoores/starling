...
public final class VolatilityWeightingFunctionUtils {
  ...
  public static ValueProperties addVolatilityWeightingProperties(final ValueProperties properties) {
    final ValueProperties.Builder builder = properties.copy();
    addVolatilityWeightingProperties(builder);
    return builder.get();
  }

  public static void addVolatilityWeightingProperties(final ValueProperties.Builder builder) {
    addVolatilityWeightingProperties(builder, null);
  }

  public static void addVolatilityWeightingProperties(final ValueProperties.Builder builder, final ValueRequirement desiredValue) {
    ...
    final Set<String> startDates = desiredValue != null ? desiredValue.getConstraints().getValues(VOLATILITY_WEIGHTING_START_DATE_PROPERTY) : null;
    ...
    final Set<String> lambdas = desiredValue != null ? desiredValue.getConstraints().getValues(VOLATILITY_WEIGHTING_LAMBDA_PROPERTY) : null;
