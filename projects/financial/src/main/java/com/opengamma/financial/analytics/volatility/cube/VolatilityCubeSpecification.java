...
public class VolatilityCubeSpecification implements Bean, Serializable, UniqueIdentifiable {
  ...
  /**
   * @param name
   *          The name of the specification, not null
   * @param cubeQuoteType
   *          The cube quote type, not null
   * @param volatilityQuoteUnits
   *          The volatility quote units, not null
   * @param cubeInstrumentProvider
   *          The instrument provider, not null
   */
  ...
  static {
    MetaBean.register(VolatilityCubeSpecification.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends VolatilityCubeSpecification> builder() {
      return new DirectBeanBuilder<>(new VolatilityCubeSpecification());
    }
