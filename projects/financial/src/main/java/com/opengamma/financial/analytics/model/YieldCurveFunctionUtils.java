...
public class YieldCurveFunctionUtils {
  ...
  public static Set<ValueRequirement> getCurveRequirements(final MultiCurveCalculationConfig curveConfig,
  ...
  public static ValueRequirement getCurveRequirement(final ComputationTargetSpecification target, final String yieldCurveName,
      final String curveCalculationConfigName,
  ...
  public static ValueRequirement getCurveRequirementForFXOption(final ComputationTargetSpecification target, final String yieldCurveName,
      final String curveCalculationConfigName,
  ...
  public static ValueRequirement getCurveRequirementForFXForward(final ComputationTargetSpecification target, final String yieldCurveName,
      final String curveCalculationConfigName,
    ...
    if (isPay) {
      ...
      properties = ValueProperties.builder()
          ...
          .with(ValuePropertyNames.RECEIVE_CURVE_CALCULATION_CONFIG, curveCalculationConfigName)
          .withOptional(ValuePropertyNames.RECEIVE_CURVE_CALCULATION_CONFIG)
          .get();
    }
    return new ValueRequirement(ValueRequirementNames.YIELD_CURVE, target, properties);
  }
  ...
  public static YieldCurveBundle getAllYieldCurves(final FunctionInputs inputs, final MultiCurveCalculationConfig curveConfig,
      final ConfigDBCurveCalculationConfigSource configSource) {
    ...
    if (curveConfig.getExogenousConfigData() != null) {
      ...
      for (final Map.Entry<String, String[]> entry : exogenousCurves.entrySet()) {
        ...
        for (final String curveName : entry.getValue()) {
          final ValueRequirement curveRequirement = YieldCurveFunctionUtils.getCurveRequirement(target, curveName, exogenousConfigName,
              exogenousCalculationMethod);
    ...
    for (final String curveName : curveNames) {
      final ValueRequirement curveRequirement = YieldCurveFunctionUtils.getCurveRequirement(target, curveName, curveConfig.getCalculationConfigName(),
