...
/**
 * Data used to build an ISDA yield curve. The cash and swap data maps define the market data values and imply the term structure of the curve. Other fields
 * define the conventions which are applied when calibrating the curve.
 */
@BeanDefinition
public final class YieldCurveData implements ImmutableBean {
  ...
  /**
   * Yield curve spot date. This is the start date for instruments defined on the curve and used in calibration.
   */
  @PropertyDefinition(validate = "notNull")
  ...
  /**
   * Tenor-rate mappings for cash data. Rates should be in fractions (e.g. 0.01 = 1%). The set of tenors must be distinct from the swap tenors.
   */
  @PropertyDefinition(validate = "notNull")
  private final ImmutableSortedMap<Tenor, Double> _cashData;

  /**
   * Tenor-rate mappings for swap data. Rates should be in fractions (e.g. 0.01 = 1%). The set of tenors must be distinct from the cash tenors.
   */
  @PropertyDefinition(validate = "notNull")
  ...
  static {
    MetaBean.register(YieldCurveData.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets yield curve spot date. This is the start date for instruments defined on the curve and used in calibration.
   * @return the value of the property, not null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets tenor-rate mappings for cash data. Rates should be in fractions (e.g. 0.01 = 1%). The set of tenors must be distinct from the swap tenors.
   * @return the value of the property, not null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets tenor-rate mappings for swap data. Rates should be in fractions (e.g. 0.01 = 1%). The set of tenors must be distinct from the cash tenors.
   * @return the value of the property, not null
   */
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<YieldCurveData> {
    ...
    /**
     * Sets yield curve spot date. This is the start date for instruments defined on the curve and used in calibration.
    ...
    /**
     * Sets tenor-rate mappings for cash data. Rates should be in fractions (e.g. 0.01 = 1%). The set of tenors must be distinct from the swap tenors.
    ...
    /**
     * Sets tenor-rate mappings for swap data. Rates should be in fractions (e.g. 0.01 = 1%). The set of tenors must be distinct from the cash tenors.
