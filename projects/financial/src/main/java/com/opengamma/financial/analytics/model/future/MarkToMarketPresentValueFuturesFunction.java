...
public class MarkToMarketPresentValueFuturesFunction extends MarkToMarketFuturesFunction<Double> {
   ...
   */
  public MarkToMarketPresentValueFuturesFunction(final String closingPriceField, final String costOfCarryField, final String resolutionKey) {
    super(ValueRequirementNames.PRESENT_VALUE,
        MarkToMarketFuturesCalculator.PresentValueCalculator.getInstance(), closingPriceField, costOfCarryField, resolutionKey);
  }
