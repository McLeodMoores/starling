...
public class BloombergIRFutureOptionVolatilitySurfaceInstrumentProviderFudgeBuilder
    implements FudgeBuilder<BloombergIRFutureOptionVolatilitySurfaceInstrumentProvider> {
