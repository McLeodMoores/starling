...
/**
 * Configuration object that contains information about how a curve is to be used (e.g. as a discounting curve, as the curve for an overnight index).
 */
@BeanDefinition
public abstract class CurveTypeConfiguration extends DirectBean implements Serializable {
  ...
  static {
    MetaBean.register(CurveTypeConfiguration.Meta.INSTANCE);
  }
