...
public final class CurrencyUtils {
  ...
  public static Double getRate(final Currency currency1,
    ...
    final CurrencyPair pair = currencyPairsSource.getCurrencyPair(currencyPairsName, currency1, currency2);
    if (pair == null) {
      return null;
    }
  ...
  public static Double getRate(final Currency currency1,
    ...
    final CurrencyPair pair = currencyPairs.getCurrencyPair(currency1, currency2);
    if (pair == null) {
      return null;
    }
    if (pair.getBase().equals(currency1)) {
