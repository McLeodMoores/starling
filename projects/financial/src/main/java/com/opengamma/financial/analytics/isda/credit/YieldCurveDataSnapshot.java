...
/**
 * A snapshot containing yield curve market data. This defines a set of yield curves which can be bootstrapped and used in a pricing environment. Curves are
 * indexed on a per-currency basis since they are typically accessed as such.
 */
@BeanDefinition
public class YieldCurveDataSnapshot implements NamedSnapshot, ImmutableBean {
  ...
  static {
    MetaBean.register(YieldCurveDataSnapshot.Meta.INSTANCE);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_uniqueId, other._uniqueId) &&
          ...
          JodaBeanUtils.equal(_yieldCurves, other._yieldCurves);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_yieldCurves);
    return hash;
  }
