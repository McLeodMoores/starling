...
/**
 * An instance containing the market data required to bootstrap an ISDA credit curve. Also referenced is the applicable recovery rate and convention to use.
 *
 * The CDS quotes to use are held in a sorted map indexed by tenor. Quotes are specified using subclasses of the interface {@link CdsQuote}. The term structure
...
public class CreditCurveData implements ImmutableBean {
  ...
  static {
    MetaBean.register(CreditCurveData.Meta.INSTANCE);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_curveConventionLink, other._curveConventionLink) &&
          JodaBeanUtils.equal(_cdsQuotes, other._cdsQuotes) &&
          JodaBeanUtils.equal(_recoveryRate, other._recoveryRate);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_curveConventionLink);
    hash = hash * 31 + JodaBeanUtils.hashCode(_cdsQuotes);
    hash = hash * 31 + JodaBeanUtils.hashCode(_recoveryRate);
    return hash;
  }
