...
public abstract class ConstantBlackDiscountingSwaptionFunction extends DiscountingFunction {
  ...
  protected abstract class BlackDiscountingCompiledFunction extends DiscountingCompiledFunction {
    ...
    protected Collection<ValueProperties.Builder> getResultProperties(final FunctionCompilationContext compilationContext, final ComputationTarget target) {
      final ValueProperties.Builder properties = createValueProperties().with(PROPERTY_CURVE_TYPE, DISCOUNTING).with(PROPERTY_VOLATILITY_MODEL, CONSTANT_BLACK)
          .withAny(SURFACE)
     ...
     */
    protected BlackSwaptionFlatProvider getSwaptionBlackSurface(final FunctionExecutionContext executionContext, final FunctionInputs inputs,
      ...
      final BlackFlatSwaptionParameters parameters = new BlackFlatSwaptionParameters(ConstantDoublesSurface.from(volatility),
          SwaptionUtils.getSwapGenerator(security, definition,
              securitySource));
