 ...
 *
 */
public class EquitySecurityPnLDefaultPropertiesFunction extends DefaultPropertyFunction {
  private final String _returnCalculator;
  private final String _samplingPeriod;
  private final String _scheduleCalculator;
  private final String _samplingCalculator;

  public EquitySecurityPnLDefaultPropertiesFunction(final String samplingPeriod, final String scheduleCalculator, final String samplingCalculator,
