...
public class FinancialFunctions extends AbstractFunctionConfigurationBean {
  ...
  protected FunctionConfigurationSource createObject() {
    return CombiningFunctionConfigurationSource.of(super.createObject(), aggregationFunctionConfiguration(), analyticsFunctionConfiguration(),
        currencyFunctionConfiguration(),
