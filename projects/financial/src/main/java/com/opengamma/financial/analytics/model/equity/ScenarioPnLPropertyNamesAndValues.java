...
public class ScenarioPnLPropertyNamesAndValues {
  ...
  /**
   * Property name for the type of the shift to the volatility surface. Valid values are: ADDITIVE and MULTIPLICATIVE
   */
  ...
  /**
   * Property name for the type of the shift to the spot or forward price. Valid values are: ADDITIVE and MULTIPLICATIVE
   */
