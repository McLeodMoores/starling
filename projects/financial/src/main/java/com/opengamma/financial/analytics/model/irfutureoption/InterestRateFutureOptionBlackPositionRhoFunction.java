...
/**
 * Function computes the {@link ValueRequirementNames#POSITION_RHO}, first order derivative of {@link Position} price with respect to the continuously
 * compounded discount rates of the provided {@link ValuePropertyNames#CURVE}, for interest rate future options in the Black world.
 * <p>
 ...
 * 
 * @deprecated This function simply returns the PV01, which is calculated in {@link InterestRateFutureOptionBlackPV01Function}. Use
 *             {@link ValueRenamingFunction} to rename outputs rather than repeating the calculations.
 */
@Deprecated
