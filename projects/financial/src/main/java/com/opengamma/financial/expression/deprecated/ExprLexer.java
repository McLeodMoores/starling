...
public class ExprLexer extends Lexer {
  ...
  public final void mSTRING_IDENTIFIER() throws RecognitionException {
    try {
      final int _type = STRING_IDENTIFIER;
      final int _channel = DEFAULT_TOKEN_CHANNEL;
            ...
            // com/opengamma/financial/expression/deprecated/Expr.g:39:58: ( '\\\\' . | . )
            {
              ...
              if (LA4_0 == '\\') {
                ...
                if (LA4_1 == '\"') {
                  ...
                  final NoViableAltException nvae = new NoViableAltException("", 4, 1, input);
  ...
  public final void mFLOAT() throws RecognitionException {
    try {
      ...
      final int _channel = DEFAULT_TOKEN_CHANNEL;
      // com/opengamma/financial/expression/deprecated/Expr.g:42:7: ( ( '+' | '-' )? ( '0' .. '9' )* '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' ..
      // '9' )+ )? ( 'f' )? )
      // com/opengamma/financial/expression/deprecated/Expr.g:42:9: ( '+' | '-' )? ( '0' .. '9' )* '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' ..
      // '9' )+ )? ( 'f' )?
      {
        ...
        loop11: do {
          ...
          switch (alt11) {
            ...
            default:
              ...
              final EarlyExitException eee = new EarlyExitException(11, input);
              throw eee;
          }
          cnt11++;
        } while (true);
            ...
            loop13: do {
              ...
              switch (alt13) {
                ...
                default:
                  ...
                  final EarlyExitException eee = new EarlyExitException(13, input);
                  throw eee;
              }
              cnt13++;
            } while (true);
  ...
  public void mTokens() throws RecognitionException {
    // com/opengamma/financial/expression/deprecated/Expr.g:1:8: ( LT | LTE | GT | GTE | EQ | NEQ | T__21 | T__22 | AND | NOT | OR | TRUE | FALSE | IDENTIFIER |
    // STRING | STRING_IDENTIFIER | WHITESPACE | INTEGER | FLOAT )
    int alt16 = 19;
  ...
  static final String DFA16_eotS = "\1\uffff\1\24\1\26\3\uffff\5\13\5\uffff\1\34\6\uffff\2\13\1\37\2" +
      "\13\1\uffff\1\42\1\43\1\uffff\2\13\2\uffff\1\46\1\13\1\uffff\1\50" +
      "\1\uffff";
  static final String DFA16_eofS = "\51\uffff";
  static final String DFA16_minS = "\1\11\2\75\3\uffff\1\116\1\117\2\122\1\101\4\uffff\2\56\6\uffff" +
      "\1\104\1\124\1\56\1\125\1\114\1\uffff\2\56\1\uffff\1\105\1\123\2" +
      "\uffff\1\56\1\105\1\uffff\1\56\1\uffff";
  static final String DFA16_maxS = "\1\172\1\76\1\75\3\uffff\1\156\1\157\2\162\1\141\4\uffff\2\71\6" +
      "\uffff\1\144\1\164\1\172\1\165\1\154\1\uffff\2\172\1\uffff\1\145" +
      "\1\163\2\uffff\1\172\1\145\1\uffff\1\172\1\uffff";
  static final String DFA16_acceptS = "\3\uffff\1\5\1\7\1\10\5\uffff\1\16\1\17\1\20\1\21\2\uffff\1\23\1" +
      "\2\1\6\1\1\1\4\1\3\5\uffff\1\22\2\uffff\1\13\2\uffff\1\11\1\12\2" +
      "\uffff\1\14\1\uffff\1\15";
  static final String DFA16_specialS = "\51\uffff}>";
  ...
  static {
    final int numStates = DFA16_transitionS.length;
  ...
  class DFA16 extends DFA {
    ...
    DFA16(final BaseRecognizer recognizer) {
