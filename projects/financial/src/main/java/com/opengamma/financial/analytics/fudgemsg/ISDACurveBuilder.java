...
public class ISDACurveBuilder extends AbstractFudgeBuilder<ISDACurve> {
  ...
  @Override
  public ISDACurve buildObject(final FudgeDeserializer deserializer, final FudgeMsg message) {
  ...
  @Override
  protected void buildMessage(final FudgeSerializer serializer, final MutableFudgeMsg message, final ISDACurve object) {
