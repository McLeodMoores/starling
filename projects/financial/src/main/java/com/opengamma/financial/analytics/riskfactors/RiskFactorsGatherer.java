...
/**
 * Gathers the risk factors available from a function library for elements of a portfolio, producing a {@link ValueRequirement} for each risk factor that the
 * function library can produce.
 */
@Deprecated
public interface RiskFactorsGatherer {
   ...
   *          the portfolio, not null
   * @param calcConfig
   *          the view calculation configuration, not null
   */
