...
/**
 * A snapshot containing credit curve market data. This defines a set of credit curves which can be bootstrapped and used in a pricing environment. Curves are
 * indexed using {@link CreditCurveDataKey}s.
 */
@BeanDefinition
public final class CreditCurveDataSnapshot implements NamedSnapshot, ImmutableBean {
  ...
  static {
    MetaBean.register(CreditCurveDataSnapshot.Meta.INSTANCE);
  }
