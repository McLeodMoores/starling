...
/**
 * A key used to reference a credit curve. Curves are typically referenced by the same four attributes that would identify a CDS, i.e. reference entity,
 * seniority, currency and restructuring clause. Fields are intentionally optional since they may not apply to all curves. Whether or not they are assigned with
 * values is left as a decision for the user and what is most suitable for their curve management system.
 */
@BeanDefinition
public final class CreditCurveDataKey implements ImmutableBean {
   ...
   *
   * Commonly the name will refer to the legal entity being priced, but this is not mandatory. Ability to use free-form labels allows the user to specify more
   * abstract curves which can be used to price a set of legal entities, e.g. all triple-A entities in a certain currency. This may be desirable when no
   * observable liquid quotes exist for the entity.
   */
  ...
  static {
    MetaBean.register(CreditCurveDataKey.Meta.INSTANCE);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_curveName, other._curveName) &&
          JodaBeanUtils.equal(_currency, other._currency) &&
          JodaBeanUtils.equal(_seniority, other._seniority) &&
          JodaBeanUtils.equal(_restructuring, other._restructuring);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_curveName);
    hash = hash * 31 + JodaBeanUtils.hashCode(_currency);
    hash = hash * 31 + JodaBeanUtils.hashCode(_seniority);
    hash = hash * 31 + JodaBeanUtils.hashCode(_restructuring);
    return hash;
  }
  ...
  public String toString() {
    ...
    buf.append("curveName").append('=').append(_curveName).append(',').append(' ');
    buf.append("currency").append('=').append(_currency).append(',').append(' ');
    buf.append("seniority").append('=').append(_seniority).append(',').append(' ');
