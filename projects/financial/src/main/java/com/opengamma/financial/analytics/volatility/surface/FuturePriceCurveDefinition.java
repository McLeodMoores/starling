...
public final class FuturePriceCurveDefinition<X> implements ImmutableBean {
  ...
  static {
    MetaBean.register(FuturePriceCurveDefinition.Meta.INSTANCE);
  }
  ...
  public static <X> FuturePriceCurveDefinition.Builder<X> builder() {
    return new FuturePriceCurveDefinition.Builder<>();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_name, other._name) &&
          ...
          JodaBeanUtils.equal(_xs, other._xs);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_xs);
    return hash;
  }
  ...
  public static final class Builder<X> extends DirectFieldsBeanBuilder<FuturePriceCurveDefinition<X>> {
    ...
    public FuturePriceCurveDefinition<X> build() {
      return new FuturePriceCurveDefinition<>(
          _name,
          _target,
          _xs);
    }
     ...
     */
    @SafeVarargs
    public final Builder<X> xs(X... xs) {
