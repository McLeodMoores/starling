...
/**
 * Base class for the
 * {@link CalculationPropertyNamesAndValues#ROLL_GESKE_WHALEY_LISTED_METHOD}.
 * <p>
 * This form requires that a market price is available for the option. When this
 * isn't available, pricing can be done via
 * {@link com.opengamma.engine.value.ValueRequirementNames#BLACK_VOLATILITY_SURFACE}.
 * 
 * Roll-Geske-Whaley model offers an analytic approximation for American call
 * options. If an option is put, Bjerksund-Stensland model is used.
 */
