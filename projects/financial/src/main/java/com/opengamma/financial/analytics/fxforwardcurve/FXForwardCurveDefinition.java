...
public final class FXForwardCurveDefinition implements ImmutableBean {
   ...
   *          the name, not null
   * @param target
   *          the target currencies, not null
   * @param tenors
   *          the tenors, not null
  ...
  static {
    MetaBean.register(FXForwardCurveDefinition.Meta.INSTANCE);
  }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<FXForwardCurveDefinition> {
    ...
    private List<Tenor> _tenors = ImmutableList.of();
    ...
    private Builder(FXForwardCurveDefinition beanToCopy) {
      ...
      this._tenors = beanToCopy.getTenors();
    }
    ...
    public Builder tenors(Tenor... tenors) {
      return tenors(ImmutableList.copyOf(tenors));
    }
