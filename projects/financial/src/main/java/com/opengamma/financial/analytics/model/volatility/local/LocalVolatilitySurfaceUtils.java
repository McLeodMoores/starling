...
public class LocalVolatilitySurfaceUtils {
  ...
  public static ValueProperties.Builder addAllDupireLocalVolatilitySurfaceProperties(final ValueProperties properties, final String instrumentType,
      final String blackSmileInterpolator,
      final String parameterizationType) {
    final ValueProperties blackSurfaceProperties = BlackVolatilitySurfacePropertyUtils
        .addAllBlackSurfaceProperties(properties, instrumentType, blackSmileInterpolator).get();
  ...
  public static ValueProperties.Builder addAllDupireLocalVolatilitySurfaceProperties(final ValueProperties properties, final String instrumentType,
    ...
    final ValueProperties.Builder blackSurfaceProperties = BlackVolatilitySurfacePropertyUtils.addAllBlackSurfaceProperties(properties, instrumentType,
        desiredValue);
