...
public class InflationIssuerCurveTypeConfiguration extends CurveTypeConfiguration {
  ...
  /**
   * @param reference
   *          The code for this curve (e.g. a currency), not null
   * @param priceIndex
   *          The price index for this curve, not null
   */
  ...
  static {
    MetaBean.register(InflationIssuerCurveTypeConfiguration.Meta.INSTANCE);
  }
