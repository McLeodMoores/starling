...
public class SurfaceSpecification implements Bean, Serializable, UniqueIdentifiable {
   ...
   * @param quoteUnits
   *          The quote units, not null
   * @param quoteType
   *          The quote type, not null
   * @param surfaceInstrumentProvider
   *          The surface instrument provider, not null
   */
  ...
  static {
    MetaBean.register(SurfaceSpecification.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends SurfaceSpecification> builder() {
      return new DirectBeanBuilder<>(new SurfaceSpecification());
    }
