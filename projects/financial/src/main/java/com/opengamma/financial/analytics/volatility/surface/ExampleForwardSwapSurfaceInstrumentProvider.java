...
/**
 * Generates {@link ExternalId}s for the forward swap rate tickers in the simulated market data fields.
 */
@BeanDefinition
public class ExampleForwardSwapSurfaceInstrumentProvider implements Bean, SurfaceInstrumentProvider<Tenor, Tenor>, Serializable {
  ...
  static {
    MetaBean.register(ExampleForwardSwapSurfaceInstrumentProvider.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends ExampleForwardSwapSurfaceInstrumentProvider> builder() {
      return new DirectBeanBuilder<>(new ExampleForwardSwapSurfaceInstrumentProvider());
    }
