 ...
 * <p>
 * This interface provides a simple view of yield curve definitions. This may be backed by a full-featured master, or by a much simpler data structure.
 *
...
public interface InterpolatedYieldCurveDefinitionSource extends ChangeProvider {
   ...
   *          the version-correction, null for latest
   * @return the definition, null if not found
   */
