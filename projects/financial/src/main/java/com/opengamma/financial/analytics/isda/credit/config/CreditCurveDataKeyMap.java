...
/**
 * Config object used to drive mapping from source credit keys to target credit keys. Source keys are inferred from some credit security whereas target keys
 * refer to curves in a credit curve snapshot.
 */
@BeanDefinition
...
public final class CreditCurveDataKeyMap implements ImmutableBean {
  ...
  /**
   * A map containing mappings from source (security) credit keys to target (credit curve) credit keys.
   */
  ...
  static {
    MetaBean.register(CreditCurveDataKeyMap.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets a map containing mappings from source (security) credit keys to target (credit curve) credit keys.
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_keyMap, other._keyMap);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_keyMap);
    return hash;
  }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<CreditCurveDataKeyMap> {
    ...
    //-----------------------------------------------------------------------
    /**
     * Sets a map containing mappings from source (security) credit keys to target (credit curve) credit keys.
