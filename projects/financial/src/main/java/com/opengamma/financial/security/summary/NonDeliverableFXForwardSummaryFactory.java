...
public class NonDeliverableFXForwardSummaryFactory implements SummaryFactory<NonDeliverableFXForwardSecurity> {
  ...
  public NonDeliverableFXForwardSummaryFactory(final SecuritySource securitySource) {
  ...
  @Override
  public Summary getSummary(final NonDeliverableFXForwardSecurity security) {
