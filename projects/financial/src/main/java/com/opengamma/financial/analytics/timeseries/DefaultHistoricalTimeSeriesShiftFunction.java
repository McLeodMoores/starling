...
/**
 * Function to inject default historical time series shifts into the dependency graph. Shifts are taken from the default property "MARKET_DATA_SHIFT" in the
 * same manner that market data is adjusted at the start of a view cycle.
 */
public class DefaultHistoricalTimeSeriesShiftFunction extends StaticDefaultPropertyFunction {
  ...
  public DefaultHistoricalTimeSeriesShiftFunction() {
    super(ComputationTargetType.PRIMITIVE, AbstractHistoricalTimeSeriesShiftFunction.SHIFT_PROPERTY, false, ValueRequirementNames.HISTORICAL_TIME_SERIES,
        ValueRequirementNames.HISTORICAL_TIME_SERIES_LATEST, ValueRequirementNames.YIELD_CURVE_HISTORICAL_TIME_SERIES,
        ValueRequirementNames.YIELD_CURVE_INSTRUMENT_CONVERSION_HISTORICAL_TIME_SERIES);
  }
