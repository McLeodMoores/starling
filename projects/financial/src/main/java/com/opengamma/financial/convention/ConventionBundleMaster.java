 ...
 *
 * @deprecated ConventionBundles should no longer be used. Use {@link com.opengamma.core.convention.Convention} and
...
public interface ConventionBundleMaster {
   ...
   * 
   * @param searchRequest
   *          a request object containing the query parameters
   ...
   * 
   * @param searchRequest
   *          a request object containing the historic query parameters
   * @return a search result object containing the resulting matches plus metadata
   */
