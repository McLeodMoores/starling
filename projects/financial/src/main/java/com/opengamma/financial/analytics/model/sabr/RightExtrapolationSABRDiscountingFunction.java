...
public abstract class RightExtrapolationSABRDiscountingFunction extends SABRDiscountingFunction {
  ...
  protected abstract class RightExtrapolationSABRDiscountingCompiledFunction extends SABRDiscountingCompiledFunction {
     ...
     */
    protected RightExtrapolationSABRDiscountingCompiledFunction(final DefaultTradeConverter tradeToDefinitionConverter,
    ...
    public Set<ValueRequirement> getRequirements(final FunctionCompilationContext context, final ComputationTarget target,
      ...
      final ValueProperties properties = ValueProperties.builder()
          .with(CUBE, cube).with(CURRENCY, currency.getCode())
          .with(PROPERTY_VOLATILITY_MODEL, SABR).get();
      final ValueRequirement surfacesRequirement =
          new ValueRequirement(ValueRequirementNames.SABR_SURFACES, ComputationTargetSpecification.of(currency), properties);
