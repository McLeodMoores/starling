...
public class FactorExposureData extends DirectBean {
  ...
  public FactorExposureData(final long factorSetId, final FactorType factorType, final String factorName, final String node) {
  ...
  static {
    MetaBean.register(FactorExposureData.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends FactorExposureData> builder() {
      return new DirectBeanBuilder<>(new FactorExposureData());
    }
