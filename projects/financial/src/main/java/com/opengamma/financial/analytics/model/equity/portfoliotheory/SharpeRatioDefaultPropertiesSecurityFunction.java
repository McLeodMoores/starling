 ...
 *
 */
public class SharpeRatioDefaultPropertiesSecurityFunction extends SharpeRatioDefaultPropertiesFunction {

  public SharpeRatioDefaultPropertiesSecurityFunction(final String samplingPeriodName, final String scheduleCalculatorName, final String samplingFunctionName,
