...
public class BloombergAlternativeFXOptionVolatilitySurfaceInstrumentProviderFudgeBuilder
    implements FudgeBuilder<BloombergAlternativeFXOptionVolatilitySurfaceInstrumentProvider> {
  ...
  public BloombergAlternativeFXOptionVolatilitySurfaceInstrumentProvider buildObject(final FudgeDeserializer deserializer, final FudgeMsg message) {
    return new BloombergAlternativeFXOptionVolatilitySurfaceInstrumentProvider(message.getString(PREFIX_FIELD_NAME), message.getString(POSTFIX_FIELD_NAME),
        message.getString(DATA_FIELD_NAME));
  }
