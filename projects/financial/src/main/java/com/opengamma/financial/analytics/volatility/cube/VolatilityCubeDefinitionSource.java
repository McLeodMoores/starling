 ...
 * <p>
 * This interface provides a simple view of vol cube definitions. This may be backed by a full-featured master, or by a much simpler data structure.
 */
public interface VolatilityCubeDefinitionSource {
   ...
   */
  VolatilityCubeDefinition<?, ?, ?> getDefinition(String name);
   ...
   * @return the definition, null if not found
   */
  VolatilityCubeDefinition<?, ?, ?> getDefinition(String name, VersionCorrection versionCorrection);
