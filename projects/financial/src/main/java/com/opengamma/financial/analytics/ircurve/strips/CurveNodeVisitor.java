...
public interface CurveNodeVisitor<T> {
   ...
   * 
   * @param node
   *          A continuously compounded rate node
   * @return The return value
   */
   ...
   * 
   * @param node
   *          A periodically compounded rate node
   * @return The return value
   */
   ...
   * 
   * @param node
   *          A deliverable swap future node
   * @return The return value
   */
