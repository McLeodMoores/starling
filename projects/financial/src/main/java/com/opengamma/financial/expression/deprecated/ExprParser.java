...
public class ExprParser extends Parser {
  public static final String[] tokenNames = new String[] {
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "LT", "LTE", "GT", "GTE", "EQ", "NEQ", "AND", "NOT", "OR", "TRUE", "FALSE", "IDENTIFIER", "STRING",
      "STRING_IDENTIFIER", "WHITESPACE", "INTEGER", "FLOAT", "'('", "')'"
  };
  ...
  public ExprParser(final TokenStream input) {
    this(input, new RecognizerSharedState());
  }

  public ExprParser(final TokenStream input, final RecognizerSharedState state) {
    super(input, state);
  ...
  public String getGrammarFileName() {
    return "com/opengamma/financial/expression/deprecated/Expr.g";
  }
  ...
  public final ExprParser.variable_return variable() throws RecognitionException {
    final ExprParser.variable_return retval = new ExprParser.variable_return();
  ...
  public final ExprParser.literal_return literal() throws RecognitionException {
    final ExprParser.literal_return retval = new ExprParser.literal_return();
    retval.start = input.LT(1);
  ...
  public final ExprParser.value_expr_return value_expr() throws RecognitionException {
    final ExprParser.value_expr_return retval = new ExprParser.value_expr_return();
    retval.start = input.LT(1);
    ...
    final Object char_literal5_tree = null;
    final Object char_literal7_tree = null;
  ...
  public final ExprParser.cmp_expr_return cmp_expr() throws RecognitionException {
    final ExprParser.cmp_expr_return retval = new ExprParser.cmp_expr_return();
    retval.start = input.LT(1);
    ...
    try {
      ...
      switch (alt4) {
            ...
            // com/opengamma/financial/expression/deprecated/Expr.g:64:17: ( EQ | GT | GTE | LT | LTE | NEQ ) cmp_expr
            {
              ...
              switch (alt2) {
                ...
                // com/opengamma/financial/expression/deprecated/Expr.g:64:18: EQ
                {
                  ...
                  EQ9_tree = adaptor.create(EQ9);
                  root_0 = adaptor.becomeRoot(EQ9_tree, root_0);
                ...
                // com/opengamma/financial/expression/deprecated/Expr.g:64:24: GT
                {
                  ...
                  GT10_tree = adaptor.create(GT10);
                  root_0 = adaptor.becomeRoot(GT10_tree, root_0);
                ...
                // com/opengamma/financial/expression/deprecated/Expr.g:64:30: GTE
                {
                  ...
                  GTE11_tree = adaptor.create(GTE11);
                  root_0 = adaptor.becomeRoot(GTE11_tree, root_0);
                ...
                // com/opengamma/financial/expression/deprecated/Expr.g:64:37: LT
                {
                  ...
                  LT12_tree = adaptor.create(LT12);
                  root_0 = adaptor.becomeRoot(LT12_tree, root_0);
                ...
                // com/opengamma/financial/expression/deprecated/Expr.g:64:43: LTE
                {
                  ...
                  LTE13_tree = adaptor.create(LTE13);
                  root_0 = adaptor.becomeRoot(LTE13_tree, root_0);
                ...
                // com/opengamma/financial/expression/deprecated/Expr.g:64:50: NEQ
                {
                  ...
                  NEQ14_tree = adaptor.create(NEQ14);
                  root_0 = adaptor.becomeRoot(NEQ14_tree, root_0);
        ...
        // com/opengamma/financial/expression/deprecated/Expr.g:65:5: NOT cmp_expr
        {
          ...
          NOT16_tree = adaptor.create(NOT16);
          root_0 = adaptor.becomeRoot(NOT16_tree, root_0);
  ...
  public final ExprParser.and_expr_return and_expr() throws RecognitionException {
    final ExprParser.and_expr_return retval = new ExprParser.and_expr_return();
    retval.start = input.LT(1);
      ...
      // com/opengamma/financial/expression/deprecated/Expr.g:68:12: cmp_expr ( AND and_expr )?
      {
        ...
        switch (alt5) {
          ...
          // com/opengamma/financial/expression/deprecated/Expr.g:68:22: AND and_expr
          {
            ...
            AND19_tree = adaptor.create(AND19);
            root_0 = adaptor.becomeRoot(AND19_tree, root_0);
  ...
  public final ExprParser.or_expr_return or_expr() throws RecognitionException {
    final ExprParser.or_expr_return retval = new ExprParser.or_expr_return();
    retval.start = input.LT(1);
      ...
      // com/opengamma/financial/expression/deprecated/Expr.g:70:11: and_expr ( OR or_expr )?
      {
        ...
        switch (alt6) {
          ...
          // com/opengamma/financial/expression/deprecated/Expr.g:70:21: OR or_expr
          {
            ...
            OR22_tree = adaptor.create(OR22);
            root_0 = adaptor.becomeRoot(OR22_tree, root_0);
  ...
  public final ExprParser.expr_return expr() throws RecognitionException {
    final ExprParser.expr_return retval = new ExprParser.expr_return();
    retval.start = input.LT(1);
  ...
  public final ExprParser.root_return root() throws RecognitionException {
    final ExprParser.root_return retval = new ExprParser.root_return();
    retval.start = input.LT(1);
    ...
    try {
      ...
      // com/opengamma/financial/expression/deprecated/Expr.g:74:8: expr EOF
      {
        ...
        EOF26_tree = adaptor.create(EOF26);
