...
public class RemoteClient {
  ...
  public static final class BaseUriTargetProvider extends TargetProvider {
    ...
    @Override
    public URI getSecurityMaster() {
      return DataFinancialClientUris.uriSecurityMaster(_baseUri, _userName, _clientName);
    }

    @Override
    public URI getPositionMaster() {
      return DataFinancialClientUris.uriPositionMaster(_baseUri, _userName, _clientName);
    }

    @Override
    public URI getPortfolioMaster() {
      return DataFinancialClientUris.uriPortfolioMaster(_baseUri, _userName, _clientName);
    }

    @Override
    public URI getConfigMaster() {
      return DataFinancialClientUris.uriConfigMaster(_baseUri, _userName, _clientName);
    }

    @Override
    public URI getInterpolatedYieldCurveDefinitionMaster() {
      return DataFinancialClientUris.uriInterpolatedYieldCurveDefinitionMaster(_baseUri, _userName, _clientName);
    }

    @Override
    public URI getMarketDataSnapshotMaster() {
      return DataFinancialClientUris.uriSnapshotMaster(_baseUri, _userName, _clientName);
    }

    @Override
    public URI getHeartbeat() {
      return DataFinancialClientUris.uriHeartbeat(_baseUri, _userName, _clientName);
    }
  }
