...
public class DataInterpolatedYieldCurveDefinitionMasterUris extends AbstractDataDocumentUris {
  ...
  public static URI uri(final URI baseUri) {
    final UriBuilder bld = UriBuilder.fromUri(baseUri).path("/definitions");
    return bld.build();
  }
   ...
   * @return the URI, not null
   */
  public static URI uriAddOrUpdate(final URI baseUri) {
    final UriBuilder bld = UriBuilder.fromUri(baseUri).path("/definitions/save");
    return bld.build();
  }
