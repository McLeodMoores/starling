...
public class DependencyGraphTraceBuilderPropertiesTest {
  ...
  public void valuationTime() {
    ...
    final Instant instant = ZonedDateTime.parse("2007-12-03T10:15:30+01:00[Europe/Paris]").toInstant();
  ...
  public void defaultProperties() {
    final ValueProperties valueProperties = ValueProperties.parse("A=[foo,bar],B=*");
    final DependencyGraphTraceBuilderProperties builder = createBuilder();
  ...
  public void marketData() {
    ...
    final List<MarketDataSpecification> defaultMD = builder1.getMarketData();
  ...
  public void requirements() {
    final Set<ValueRequirement> requirements = Collections
        .singleton(new ValueRequirement("testValue", new ComputationTargetRequirement(ComputationTargetType.POSITION, ExternalId.of("GOLDMAN", "FOO1"))));

    final DependencyGraphTraceBuilderProperties builder1 = createBuilder();
    final Collection<ValueRequirement> defaultRequirements = builder1.getRequirements();
  ...
  public void resolutionTime() {
    ...
    final DependencyGraphTraceBuilderProperties builder1 = createBuilder();
    final VersionCorrection defaultVC = builder1.getResolutionTime();
