 ...
 */
$.register_module({
	name: 'og.views.convention_forms.cmslegconvention',
	dependencies: [
		'og.api.rest',
		'og.common.util.ui'
	],
	obj: function () {
		var ui = og.common.util.ui, 
			...
			type_map = [
				...
				['name', 											Form.type.STR],
				['swapIndexConvention',		 						Form.type.STR],
        ...
        var constructor = function (config) {
        	var load_handler = config.handler || $.noop,
	        	...
	        	form = new Form({
	        		module: 'og.views.forms.cms-leg-convention_tash',
	        		data: master,
	        		type_map: type_map,
	        		selector: selector,
	        		extras: {
        		...
        		load_resource = function () {
            		var header = '\
            			...
            			<span class="og-js-name">' + master.name + '</span>\
            			  ...
            			  &nbsp(Constant Maturity Swap Leg Convention)\
            			</header>\
            			';
            ...
            form.children = [
            	new ui.Dropdown({
            		...
            		data_generator: function (handler) {
            			api.conventions.convention_ids.get({ conventionType: 'SwapIndex'}).pipe(function (result) {
