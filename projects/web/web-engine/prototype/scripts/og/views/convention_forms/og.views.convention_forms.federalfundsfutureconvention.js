 ...
 */
$.register_module({
	name: 'og.views.convention_forms.federalfundsfutureconvention',
	dependencies: [
		'og.api.rest',
		'og.common.util.ui'
	],
	obj: function () {
        ...
        var constructor = function (config) {
        	var load_handler = config.handler || $.noop,
	        	...
	        	sep = '~',
	        	form = new Form({
	        		module: 'og.views.forms.federal-funds-future-convention_tash',
	        		data: master,
	        		type_map: type_map,
	        		selector: selector,
	        		extras: {
        		...
        		load_resource = function () {
            		var header = '\
            			...
            			<span class="og-js-name">' + master.name + '</span>\
            			  ...
            			  &nbsp(Federal Funds Future Convention)\
            			</header>\
            			';
