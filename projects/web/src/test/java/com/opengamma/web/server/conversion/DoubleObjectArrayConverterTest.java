...
/**
 * Tests for {@link DoubleObjectArrayConverter}.
 */
@Test(groups = TestGroup.UNIT)
public class DoubleObjectArrayConverterTest {
  ...
  private static final DoubleObjectArrayConverter CONVERTER = new DoubleObjectArrayConverter();
