...
public final class StandardFudgeMessages {
  ...
  public static MutableFudgeMsg createMessageAllNames(final FudgeContext context) {
    ...
    final short shortValue = Byte.MAX_VALUE + 5;
    msg.add("short", shortValue);
    msg.add("Short", new Short(shortValue));
    final int intValue = Short.MAX_VALUE + 5;
    msg.add("int", intValue);
    msg.add("Integer", new Integer(intValue));
    final long longValue = (long) Integer.MAX_VALUE + 5;
  ...
  public static FudgeMsg createMessageWithSubMsgs(final FudgeContext context) {
    final MutableFudgeMsg msg = context.newMessage();
    final MutableFudgeMsg sub1 = context.newMessage();
    sub1.add("bibble", "fibble");
    sub1.add(827, "Blibble");
    final MutableFudgeMsg sub2 = context.newMessage();
