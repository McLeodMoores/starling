...
public class MarketDataSnapshotListResourceTest {
  ...
  private static MarketDataSnapshotDocument createSnapshot(final String basisViewName, final String name, final UniqueId uid) {
  ...
  private static MarketDataSnapshotListResource createResource(final MarketDataSnapshotDocument... docs) {
    final MarketDataSnapshotMaster snapshotMaster = mock(MarketDataSnapshotMaster.class);
    final List<MarketDataSnapshotDocument> documents = Arrays.asList(docs);
  ...
  public void getJson() throws JSONException {
    final MarketDataSnapshotListResource resource = createResource(
  ...
  public void snapshotWithBlankNameNotReturned() throws JSONException {
    ...
    final JSONArray json = new JSONArray(resource.getMarketDataSnapshotList());
  ...
  public void getJsonOverHttp() throws Exception {
    ...
    final JSONArray snapshots = basis1Map.getJSONArray(SNAPSHOTS);
    assertEquals(1, snapshots.length());
    final JSONObject snap1 = snapshots.getJSONObject(0);
