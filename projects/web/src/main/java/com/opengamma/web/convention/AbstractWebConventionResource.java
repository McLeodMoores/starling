...
import com.mcleodmoores.web.json.convention.DeliverablePriceQuotedSwapFutureConventionJsonBuilder;
import com.mcleodmoores.web.json.convention.DepositConventionJsonBuilder;
import com.mcleodmoores.web.json.convention.FederalFundsFutureConventionJsonBuilder;
...
import com.mcleodmoores.web.json.convention.InterestRateFutureConventionJsonBuilder;
...
import com.mcleodmoores.web.json.convention.SwapConventionJsonBuilder;
...
import com.mcleodmoores.web.json.convention.VanillaIborLegRollDateConventionJsonBuilder;
...
public abstract class AbstractWebConventionResource extends AbstractPerRequestWebResource<WebConventionData> {
  ...
  private void initializeJsonBuilders() {
    ...
    data().getJsonBuilderMap().put(DeliverablePriceQuotedSwapFutureConvention.class,
        new DeliverablePriceQuotedSwapFutureConventionJsonBuilder(data().getConventionMaster()));
    data().getJsonBuilderMap().put(DepositConvention.class, DepositConventionJsonBuilder.INSTANCE);
    data().getJsonBuilderMap().put(FederalFundsFutureConvention.class, new FederalFundsFutureConventionJsonBuilder(data().getConventionMaster()));
    ...
    data().getJsonBuilderMap().put(InterestRateFutureConvention.class, new InterestRateFutureConventionJsonBuilder(data().getConventionMaster()));
    ...
    data().getJsonBuilderMap().put(SwapConvention.class, new SwapConventionJsonBuilder(data().getConventionMaster()));
    ...
    data().getJsonBuilderMap().put(VanillaIborLegRollDateConvention.class, new VanillaIborLegRollDateConventionJsonBuilder(data().getConventionMaster()));
  }
