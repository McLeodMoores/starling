...
public final class ViewDefinitionJSONBuilder extends AbstractJSONBuilder<ViewDefinition> {
  ...
  private static String createTemplate() {
    final ViewDefinitionJSONBuilder builder = ViewDefinitionJSONBuilder.INSTANCE;
    return builder.toJSON(getBlankView());
  }

  private static ViewDefinition getBlankView() {
    final ViewDefinition blank = new ViewDefinition("Untitled", new UserPrincipal("", ""));
    blank.setDefaultCurrency(Currency.USD);
