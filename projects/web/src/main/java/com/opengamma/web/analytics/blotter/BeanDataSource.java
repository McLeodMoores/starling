...
/**
 * Source of data used to build a bean instance. The structure of the data source is likely to match the structure of the bean.
 */
/* package */ interface BeanDataSource {
   ...
   * @param propertyName
   *          The property name
   * @return The property value map. The keys and values are strings if they're simple or {@link BeanDataSource}s if they have structure
   */
