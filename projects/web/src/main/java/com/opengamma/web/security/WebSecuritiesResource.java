...
public class WebSecuritiesResource extends AbstractWebSecurityResource {
  ...
  public Response postJSON(
    ...
    switch (trimmedType) {
      ...
      case "id":
        ...
        final Collection<ExternalIdBundle> requestBundles = buildSecurityRequest(scheme, trimmedIdValue);
  ...
  public static URI uri(final WebSecuritiesData data, final ExternalIdBundle identifiers) {
    final UriBuilder builder = data.getUriInfo().getBaseUriBuilder().path(WebSecuritiesResource.class);
    if (identifiers != null) {
