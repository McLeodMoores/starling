...
public class MinimalWebSecurityVersionsResource extends AbstractMinimalWebSecurityResource {
  ...
  public static URI uri(final WebSecuritiesData data) {
    ...
    return data.getUriInfo().getBaseUriBuilder().path(MinimalWebSecurityVersionsResource.class).build(securityId);
  }
