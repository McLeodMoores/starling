 ...
 * parameter that can be parsed by {@link com.opengamma.id.UniqueId#parse UniqueId.parse()} and the parameter must also have a {@link javax.ws.rs.PathParam
 * PathParam} annotation. See {@link com.opengamma.web.portfolio.WebPortfoliosResource#findPortfolio WebPortfoliosResource.findPortfolio()} for an example.
 * </p>
 *
 * <h2>Queries</h2>
 * <p>
 ...
 * specified as annotation parameters. See {@link com.opengamma.web.portfolio.WebPortfoliosResource#getJSON WebPortfoliosResource.getJSON()} for an example.
 * </p>
 *
 ...
 * </pre>
 * <p>
 * The request must contain the follow parameters to define the view:
 * </p>
 * <ul>
 ...
 * <li>{@code marketDataProviders}: JSON array spcifying the market data providers. See {@link com.opengamma.web.analytics.MarketDataSpecificationJsonReader
 * MarketDataSpecificationJsonReader} for details.</li>
 * </ul>
 * <p>
 * The response header will contain the location of the new view. To close a view the client should make a {@code DELETE} request to the view's location.
 * </p>
 *
 * <h3>Grids</h3>
 * <p>
 * A view always has at least two grids, the portfolio and primitives grids. TODO depgraphs
 * </p>
 *
 ...
 * </pre>
 * <p>
 * TODO document the grid structure JSON
 * </p>
 *
 * <h3>Viewports</h3>
 * <p>
 ...
 * </pre>
 * <p>
 * The request must contain parameters specifying which cells the viewport should contain. These can be either:
 * <ul>
 * <li>{@code rows} and {@code columns} containing the row and column indices in the viewport. This creates a rectangular viewport.</li>
 * <li>{@code cells} containing the row and column index for each cell in the viewport as a comma-separated pair, e.g. '10,12'.</li>
 * </ul>
 * <p>
 * The response header will contain the location of the new viewport. To close the viewport the client should make a {@code DELETE} request to the viewport's
 * location.
 * </p>
 *
 * <h3>Viewport Data</h3>
 ...
 * </pre>
 * <p>
 * The data is returned as an array of objects for each cell by row and then by column. The order of cell or indices in the parameters used to create the
 * viewport is ignored.
 * </p>
 * <p>
 * TODO document data JSON
 * </p>
 *
 * <p>
 * TODO async updates
