...
/* package */ class Inliner {
  ...
  public static List<ColumnMeta> columnMeta(final Object value) {
    if (value instanceof LocalDateLabelledMatrix1D) {
      final LocalDateLabelledMatrix1D matrix = (LocalDateLabelledMatrix1D) value;
    ...
    if (value instanceof TenorLabelledLocalDateDoubleTimeSeriesMatrix1D) {
      final TenorLabelledLocalDateDoubleTimeSeriesMatrix1D matrix = (TenorLabelledLocalDateDoubleTimeSeriesMatrix1D) value;
      return getTenorLabelledLocalDateDoubleTimeSeriesMatrix1DColumnMeta(matrix);
    }
    return Collections.emptyList();
  }

  private static List<ColumnMeta> getLocalDateDoubleLabelledMatrix1DColumnMeta(final LocalDateLabelledMatrix1D matrix) {
...
/* package */ class ColumnMeta implements Comparable<ColumnMeta> {
  ...
  /* package */ <T> ColumnMeta(final Comparable<? super T> key, final String header, final Class<?> type, final Class<?> underlyingType) {
  ...
  public boolean equals(final Object o) {
    ...
    final ColumnMeta that = (ColumnMeta) o;
