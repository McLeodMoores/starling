...
public class DataHistoricalTimeSeriesMasterUris {
   ...
   */
  public static URI uriMetaData(final URI baseUri, final HistoricalTimeSeriesInfoMetaDataRequest request) {
  ...
  public static URI uriSearch(final URI baseUri) {
    final UriBuilder bld = UriBuilder.fromUri(baseUri).path("infoSearches");
    return bld.build();
  }
  ...
  public static URI uriAdd(final URI baseUri) {
    final UriBuilder bld = UriBuilder.fromUri(baseUri).path("infos");
    return bld.build();
  }
