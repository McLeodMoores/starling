...
/**
 * Test {@link ThrowableExceptionMapper}.
 */
...
public class ThrowableExceptionMapperTest extends AbstractExceptionMapperTestHelper {
  ...
  public void testMapping(final MediaType mediaType) throws Exception {
    final NullPointerException ex = new NullPointerException("Test message");
    final ThrowableExceptionMapper mapper = new ThrowableExceptionMapper();
  ...
  public void testNoOutputMessage(final MediaType mediaType) throws Exception {
    ...
    assertTrue(data.get("locator").startsWith(
        "<p>IllegalArgumentException<br />&nbsp;&nbsp;at com.opengamma.util.rest.ThrowableExceptionMapperTest.testNoOutputMessage()"));
  ...
  public void testOutputMessage(final MediaType mediaType) throws Exception {
    ...
    assertTrue(data.get("locator").startsWith(
        "<p>OpenGammaRuntimeException<br />&nbsp;&nbsp;at com.opengamma.util.rest.ThrowableExceptionMapperTest.testOutputMessage()"));
    assertTrue(data.get("locator").endsWith("</p>"));
  }
