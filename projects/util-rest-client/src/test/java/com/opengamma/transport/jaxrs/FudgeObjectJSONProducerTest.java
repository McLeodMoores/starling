...
/**
 * Tests for {@link FudgeObjectJSONProducer}.
 */
@Test(groups = TestGroup.UNIT)
public class FudgeObjectJSONProducerTest {
  private static final FudgeObjectXMLProducer PRODUCER = new FudgeObjectXMLProducer();
