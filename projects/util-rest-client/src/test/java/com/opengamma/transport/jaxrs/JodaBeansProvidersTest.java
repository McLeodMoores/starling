...
public class JodaBeansProvidersTest {
  ...
  private static void testBeans(final MessageBodyWriter producer, final MessageBodyReader consumer) {
    final FlexiBean sub = new FlexiBean();
    sub.put("child", "name");
  ...
  /**
   * Tests the Joda bean binary producer / consumer.
   */
  public void testBinary() {
    final JodaBeanBinaryProducerConsumer pc = new JodaBeanBinaryProducerConsumer();
    testBeans(pc, pc);
  }

  /**
   * Tests the Joda bean XML producer / consumer.
   */
  public void testXML() {
    final JodaBeanXmlProducerConsumer pc = new JodaBeanXmlProducerConsumer();
    testBeans(pc, pc);
  }
