...
public class FieldMappingHistoricalTimeSeriesResolverTest {
  ...
  public void testMappings() {
    ...
    final HistoricalTimeSeriesFieldAdjustmentMap map1 = new HistoricalTimeSeriesFieldAdjustmentMap("BLOOMBERG");
    map1.addFieldAdjustment(syntheticFieldName, "CMPL", "PX_LAST", null);

    // Synthetic -> (*, REUTERS.VOLUME, adjuster)
    final HistoricalTimeSeriesFieldAdjustmentMap map2 = new HistoricalTimeSeriesFieldAdjustmentMap("REUTERS");
    ...
    for (final ExternalIdBundleWithDates identifierBundleWithDates : _identifiers) {
      ...
      final Set<Triple<String, String, String>> candidateInfo = getCandidateInfo(_selector.getLastCandidates());
