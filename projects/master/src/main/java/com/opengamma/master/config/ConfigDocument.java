...
public class ConfigDocument extends AbstractDocument {
   ...
   */
  public <T> ConfigDocument(final T value, final Class<T> type, final String name, final UniqueId uid, final Instant versionFrom, final Instant versionTo, final Instant correctionFrom, final Instant correctionTo) {
