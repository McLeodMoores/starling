...
public class HolidaySearchResult extends AbstractSearchResult<HolidayDocument> {
   ...
   */
  public HolidaySearchResult(final Collection<HolidayDocument> coll) {
    super(coll);
  }
   ...
   */
  public HolidaySearchResult(final VersionCorrection versionCorrection) {
  ...
  static {
    MetaBean.register(HolidaySearchResult.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractSearchResult.Meta<HolidayDocument> {
    ...
    public BeanBuilder<? extends HolidaySearchResult> builder() {
      return new DirectBeanBuilder<>(new HolidaySearchResult());
    }
