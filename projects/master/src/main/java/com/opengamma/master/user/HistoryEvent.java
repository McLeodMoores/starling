...
public class HistoryEvent implements ImmutableBean, Comparable<HistoryEvent> {
  ...
  /**
   * The changes that occurred. This list is a description of the important changes that occurred. Not all changes are included, each master selects those it
   * wants to expose. It is not the intention to allow the recreation of an old version of the master.
   */
  @PropertyDefinition(validate = "notNull")
   ...
   * @param changes
   *          the changes that occurred, not null
  ...
  static {
    MetaBean.register(HistoryEvent.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the changes that occurred. This list is a description of the important changes that occurred. Not all changes are included, each master selects those it
   * wants to expose. It is not the intention to allow the recreation of an old version of the master.
   * @return the value of the property, not null
   */
  ...
  public static class Builder extends DirectFieldsBeanBuilder<HistoryEvent> {
    ...
    /**
     * Sets the changes that occurred. This list is a description of the important changes that occurred. Not all changes are included, each master selects those it
     * wants to expose. It is not the intention to allow the recreation of an old version of the master.
