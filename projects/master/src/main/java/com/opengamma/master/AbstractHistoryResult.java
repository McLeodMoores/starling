 ...
 * <p>
 * The returned documents may be a mixture of versions and corrections. The document instant fields are used to identify which are which. See
 * {@link AbstractHistoryRequest} for more details.
 *
 * @param <D>
...
public abstract class AbstractHistoryResult<D extends AbstractDocument> extends AbstractDocumentsResult<D> {
   ...
   * 
   * @param coll
   *          the collection of documents to add, not null
   */
  ...
  static {
    MetaBean.register(AbstractHistoryResult.Meta.INSTANCE);
  }
