...
/**
 * Request for the history of a Trade.
 * <p>
 * A full Trade master implements historical storage of data.
 ...
 * A simple Trade master might simply replace the original version with the corrected value.
 ...
 * <p>
 * For example, a Trade added on Monday and updated on Thursday has two versions.
...
@PublicSPI
@BeanDefinition
public class TradeHistoryRequest extends AbstractHistoryRequest {
   ...
   */
  public TradeHistoryRequest(final ObjectIdentifiable objectId) {
    super(objectId);
  }
   ...
   */
  public TradeHistoryRequest(final ObjectIdentifiable objectId, final Instant versionInstant, final Instant correctedToInstant) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code TradeHistoryRequest}.
  ...
  //-----------------------------------------------------------------------
  @Override
  public TradeHistoryRequest clone() {
  ...
  public String toString() {
    ...
    buf.append("TradeHistoryRequest{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends AbstractHistoryRequest.Meta {
    ...
    @Override
    public BeanBuilder<? extends TradeHistoryRequest> builder() {
      return new DirectBeanBuilder<TradeHistoryRequest>(new TradeHistoryRequest());
    }

    @Override
    public Class<? extends TradeHistoryRequest> beanType() {
