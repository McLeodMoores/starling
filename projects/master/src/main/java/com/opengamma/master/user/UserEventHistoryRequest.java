 ...
 * <p>
 * A user master implements lightweight historical storage of data. This object is used to request that history.
 * <p>
 * Either the object identifier or the user name must be specified. If both are specified, the user name is ignored.
 */
@BeanDefinition
public class UserEventHistoryRequest implements Bean {
  ...
  static {
    MetaBean.register(UserEventHistoryRequest.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends UserEventHistoryRequest> builder() {
      return new DirectBeanBuilder<>(new UserEventHistoryRequest());
    }
