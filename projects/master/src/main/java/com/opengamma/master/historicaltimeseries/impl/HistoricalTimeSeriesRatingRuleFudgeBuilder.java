...
public class HistoricalTimeSeriesRatingRuleFudgeBuilder implements FudgeBuilder<HistoricalTimeSeriesRatingRule> {
  ...
  @Override
  public MutableFudgeMsg buildMessage(final FudgeSerializer serializer, final HistoricalTimeSeriesRatingRule object) {
  ...
  @Override
  public HistoricalTimeSeriesRatingRule buildObject(final FudgeDeserializer deserializer, final FudgeMsg message) {
    final String fieldName = message.getString(FIELD_NAME_FIELD_NAME);
    if (fieldName == null) {
      throw new IllegalArgumentException("Fudge message is not a HistoricalTimeSeriesRatingRule - field 'fieldName' is not present");
    }
    final String fieldValue = message.getString(FIELD_VALUE_FIELD_NAME);
    if (fieldValue == null) {
      throw new IllegalArgumentException("Fudge message is not a HistoricalTimeSeriesRatingRule - field 'fieldValue' is not present");
    }
    final Integer rating = message.getInt(RATING_FIELD_NAME);
    if (rating == null) {
