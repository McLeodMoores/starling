 ...
 * <p>
 * The returned documents will match the search criteria. See {@link RoleSearchRequest} for more details.
 */
@BeanDefinition
public class RoleSearchResult implements Bean {
   ...
   *
   * @param paging
   *          the paging information, not null
   * @param roles
   *          the collection of roles to add, not null
   */
  ...
  static {
    MetaBean.register(RoleSearchResult.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends RoleSearchResult> builder() {
      return new DirectBeanBuilder<>(new RoleSearchResult());
    }
