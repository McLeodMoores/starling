 ...
 * <p>
 * A role master implements lightweight historical storage of data. This object is used to request that history.
 */
@BeanDefinition
public class RoleEventHistoryRequest implements Bean {
  ...
  static {
    MetaBean.register(RoleEventHistoryRequest.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends RoleEventHistoryRequest> builder() {
      return new DirectBeanBuilder<>(new RoleEventHistoryRequest());
    }
