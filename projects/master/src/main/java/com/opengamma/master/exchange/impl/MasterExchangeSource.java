 ...
 * <p>
 * The {@link ExchangeSource} interface provides exchanges to the application via a narrow API. This class provides
 * the source on top of a standard {@link ExchangeMaster}.
 */
@PublicSPI
