 ...
 * <p>
 * The returned documents will match the search criteria. See {@link UserSearchRequest} for more details.
 */
@BeanDefinition
public class UserSearchResult implements Bean {
   ...
   * @param users
   *          the collection of users to add, not null
   */
  ...
  static {
    MetaBean.register(UserSearchResult.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends UserSearchResult> builder() {
      return new DirectBeanBuilder<>(new UserSearchResult());
    }
