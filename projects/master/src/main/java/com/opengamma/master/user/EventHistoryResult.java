 ...
 * <p>
 * When a master is queried for event history, this class is used to return the result. It stores a list of events, in chronological order, representing changes
 * that were made. This approach to history is used by those masters that do not require bi-temporal versioning.
 */
@BeanDefinition
public abstract class EventHistoryResult implements Bean {
  ...
  static {
    MetaBean.register(EventHistoryResult.Meta.INSTANCE);
  }
