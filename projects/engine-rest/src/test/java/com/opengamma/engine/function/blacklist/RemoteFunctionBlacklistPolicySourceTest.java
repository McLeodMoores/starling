...
public class RemoteFunctionBlacklistPolicySourceTest {
  ...
  public void testGetPolicyByUniqueId() {
    ...
    underlying.addPolicy(
        new DefaultFunctionBlacklistPolicy(UniqueId.of("Test", "Foo"), 10, Collections.singleton(FunctionBlacklistPolicy.Entry.PARAMETERIZED_FUNCTION)));
