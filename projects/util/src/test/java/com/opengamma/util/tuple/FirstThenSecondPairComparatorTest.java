...
/**
 * Test {@link FirstThenSecondPairComparator}.
 */
@Test(groups = TestGroup.UNIT)
public class FirstThenSecondPairComparatorTest {

  /**
   * Tests the Comparable comparator.
   */
  @Test
  public void testSingleton() {
    final Pair<Integer, String> a = ObjectsPair.of(1, "A");
    final Pair<Integer, String> b = ObjectsPair.of(1, "B");
   ...
   */
  @Test
  public void testSingletonDoubles() {
    final Pair<Double, Double> a = DoublesPair.of(1.0, 1.0);
    final Pair<Double, Double> b = DoublesPair.of(1.0, 2.0);
  ...
  public void testCompare() {
    ...
    final FirstThenSecondPairComparator<Double, Double> test = new FirstThenSecondPairComparator<>();
