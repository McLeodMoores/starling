...
public class PerformanceCounterTest {
  ...
  public void oneSecCounter() {
    final PerformanceCounter counter = new PerformanceCounter(1, 5000);
  ...
  public void sixtySecondCounter() {
    final PerformanceCounter counter = new PerformanceCounter(60, 3000);
  ...
  public void clockGoingBackwards() {
    final PerformanceCounter counter = new PerformanceCounter(60, 0);
