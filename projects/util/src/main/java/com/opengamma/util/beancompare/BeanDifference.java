...
public class BeanDifference<P> {
   ...
   */
  public BeanDifference(final MetaProperty<? extends P> property, final P value1, final P value2) {
   ...
   */
  public BeanDifference(final MetaProperty<? extends P> property, final P value1, final P value2, final List<MetaProperty<?>> path) {
  ...
  public boolean equals(final Object obj) {
    ...
    final BeanDifference<?> that = (BeanDifference<?>) obj;
