 ...
 * <p>
 * This class allows information about an arbitrary {@link Throwable} instance to be stored and serialized.
 * 
...
public final class ThrowableDetails implements ImmutableBean {
   ...
   *
   * @param throwable
   *          the throwable to create an instance for
  ...
  static {
    MetaBean.register(ThrowableDetails.Meta.INSTANCE);
  }
