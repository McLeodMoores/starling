...
public final class CompareUtils {
   ...
   */
  public static <E> int compareWithNullLow(final Comparable<E> a, final E b) {
    if (a == null) {
      return b == null ? 0 : -1;
    } else if (b == null) {
      return 1; // a not null
   ...
   * @return negative when a less than b, zero when equal, positive when greater
   */
  public static <E> int compareWithNullHigh(final Comparable<E> a, final E b) {
    if (a == null) {
      return b == null ? 0 : 1;
    } else if (b == null) {
      return -1; // a not null
   ...
   */
  public static boolean closeEquals(final double a, final double b, final double maxDifference) {
    if (Double.isInfinite(a)) {
      return a == b;
    }
   ...
   */
  public static int compareWithTolerance(final double a, final double b, final double maxDifference) {
   ...
   */
  public static <T> int compareByList(final List<T> list, final T a, final T b) {
    if (a == null) {
      if (b == null) {
        return 0;
      }
