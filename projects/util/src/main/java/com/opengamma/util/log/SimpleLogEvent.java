...
public class SimpleLogEvent implements LogEvent {
   ...
   */
  public SimpleLogEvent(final LogLevel level, final String message) {
   ...
   */
  public static LogEvent of(final LogLevel level, final String message) {
  ...
  public boolean equals(final Object obj) {
    ...
    final SimpleLogEvent other = (SimpleLogEvent) obj;
