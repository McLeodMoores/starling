...
public interface ExtendedPermission extends Permission {
   ...
   * <p>
   * This object will be the permission of the subject user. The specified
   * permission is the one that is required. This only differs from
   * {@link #implies(Permission)} in that this method is allowed to throw an
   * exception if there was a problem determining the permission status.
   *
