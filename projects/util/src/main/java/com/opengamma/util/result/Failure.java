...
public final class Failure implements ImmutableBean {
  ...
  /**
   * Stack trace where the failure occurred. If the failure was caused by an {@code Exception} its stack trace is used, otherwise it's the location where the
   * failure was created.
   */
  @PropertyDefinition(validate = "notNull")
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets stack trace where the failure occurred. If the failure was caused by an {@code Exception} its stack trace is used, otherwise it's the location where the
   * failure was created.
   * @return the value of the property, not null
   */
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<Failure> {
    ...
    /**
     * Sets stack trace where the failure occurred. If the failure was caused by an {@code Exception} its stack trace is used, otherwise it's the location where the
     * failure was created.
