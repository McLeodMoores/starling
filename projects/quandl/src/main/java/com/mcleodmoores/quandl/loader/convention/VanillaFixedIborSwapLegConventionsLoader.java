...
/**
 * Creates {@link SwapFixedLegConvention}s from a csv file called "vanilla-fixed-ibor-swap-leg-conventions.csv". These conventions are used to construct the
 * fixed leg of a vanilla fixed/ibor swap.
 */
