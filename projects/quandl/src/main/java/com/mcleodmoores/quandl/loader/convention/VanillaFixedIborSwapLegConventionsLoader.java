...
/**
 * Creates {@link SwapFixedLegConvention}s from a csv file called "vanilla-fixed-ibor-swap-leg-conventions.csv".
 * These conventions are used to construct the fixed leg of a vanilla fixed/ibor swap.
 */
public final class VanillaFixedIborSwapLegConventionsLoader implements ConventionsLoader<SwapFixedLegConvention> {
  /** An instance of this loader. */
  public static final VanillaFixedIborSwapLegConventionsLoader INSTANCE = new VanillaFixedIborSwapLegConventionsLoader();
  /** The logger */
  private static final Logger LOGGER = LoggerFactory.getLogger(VanillaFixedIborSwapLegConventionsLoader.class);
  /** The file name */
  private static final String FILE_NAME = "vanilla-fixed-ibor-swap-leg-conventions.csv";

  /**
   * Restricted constructor.
   */
  private VanillaFixedIborSwapLegConventionsLoader() {
  }
