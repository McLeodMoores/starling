...
/**
 * Unit tests for {@link ForwardDriftlessThetaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class ForwardDriftlessThetaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final ForwardDriftlessThetaForexBlackSmileCalculator CALCULATOR = ForwardDriftlessThetaForexBlackSmileCalculator.getInstance();
   ...
   * value returned is the theoretical theta of the option and is not scaled by the notionals.
   */
  @Test
