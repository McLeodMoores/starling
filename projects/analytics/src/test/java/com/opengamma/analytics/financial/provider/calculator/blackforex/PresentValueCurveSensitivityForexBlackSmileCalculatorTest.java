...
/**
 * Unit tests for {@link PresentValueCurveSensitivityForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class PresentValueCurveSensitivityForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final PresentValueCurveSensitivityForexBlackSmileCalculator CALCULATOR = PresentValueCurveSensitivityForexBlackSmileCalculator.getInstance();
  ...
  public void testLongShortVanillaOption() {
    final MultipleCurrencyMulticurveSensitivity longCall = LONG_VANILLA_CALL_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    final MultipleCurrencyMulticurveSensitivity shortCall = SHORT_VANILLA_CALL_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longCall, shortCall, -1);
    final MultipleCurrencyMulticurveSensitivity longPut = LONG_VANILLA_PUT_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    final MultipleCurrencyMulticurveSensitivity shortPut = SHORT_VANILLA_PUT_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
  ...
  public void testLongShortNonDeliverableOption() {
    final MultipleCurrencyMulticurveSensitivity longCall = LONG_ND_CALL_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    final MultipleCurrencyMulticurveSensitivity shortCall = SHORT_ND_CALL_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longCall, shortCall, -1);
    final MultipleCurrencyMulticurveSensitivity longPut = LONG_ND_PUT_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    final MultipleCurrencyMulticurveSensitivity shortPut = SHORT_ND_PUT_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longPut, shortPut, -1);
  }
  ...
  public void testLongShortDigitalOption() {
    final MultipleCurrencyMulticurveSensitivity longCall = LONG_DIGITAL_CALL_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    final MultipleCurrencyMulticurveSensitivity shortCall = SHORT_DIGITAL_CALL_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longCall, shortCall, -1);
    final MultipleCurrencyMulticurveSensitivity longPut = LONG_DIGITAL_PUT_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    final MultipleCurrencyMulticurveSensitivity shortPut = SHORT_DIGITAL_PUT_OPTION.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longPut, shortPut, -1);
  }
  ...
  public void testLongShortSingleBarrierOption() {
    MultipleCurrencyMulticurveSensitivity longCall = LONG_DOWN_KNOCK_IN_CALL.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    MultipleCurrencyMulticurveSensitivity shortCall = SHORT_DOWN_KNOCK_IN_CALL.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longCall, shortCall, -1);
    MultipleCurrencyMulticurveSensitivity longPut= LONG_DOWN_KNOCK_IN_PUT.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    MultipleCurrencyMulticurveSensitivity shortPut = SHORT_DOWN_KNOCK_IN_PUT.toDerivative(VALUATION_DATE).accept(CALCULATOR, MARKET_DATA_WITH_SMILE);
    assertEqualsAfterScaling(longPut, shortPut, -1);
