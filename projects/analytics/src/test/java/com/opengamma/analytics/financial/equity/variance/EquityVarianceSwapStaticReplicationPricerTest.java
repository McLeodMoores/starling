  ...
  private static final double[][] STRIKES = new double[][] { {50, 55, 60, 65, 70, 75, 80 }, {50, 55, 60, 65, 70, 75, 80 }, {50, 55, 60, 65, 70, 75, 80 },
    ...
    public void dividendSensitivityWithStickyImpVolTest() {
      if (PRINT) {
        ...
        // double[][] d1 =
        // pricer.dividendSensitivityWithStickyImpliedVol(EVS_COR_FRO_DIVS, SPOT,
        // DISCOUNT_CURVE, ZERO_DIVIDENDS, v1);
        ...
        // double[][] d4 = pricer.dividendSensitivityWithStickyImpliedVol(EVS,
        // SPOT, DISCOUNT_CURVE, ZERO_DIVIDENDS, v4);
