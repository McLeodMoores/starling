...
/**
 * Unit tests for {@link SpotGammaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class SpotGammaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final SpotGammaForexBlackSmileCalculator CALCULATOR = SpotGammaForexBlackSmileCalculator.getInstance();
