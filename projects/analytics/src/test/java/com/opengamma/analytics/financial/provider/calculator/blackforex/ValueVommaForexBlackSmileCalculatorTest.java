...
/**
 * Unit tests for {@link ValueVommaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class ValueVommaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final ValueVommaForexBlackSmileCalculator CALCULATOR = ValueVommaForexBlackSmileCalculator.getInstance();
