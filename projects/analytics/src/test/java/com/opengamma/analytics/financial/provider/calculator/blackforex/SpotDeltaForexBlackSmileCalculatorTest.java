...
/**
 * Unit tests for {@link SpotDeltaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class SpotDeltaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final SpotDeltaForexBlackSmileCalculator CALCULATOR = SpotDeltaForexBlackSmileCalculator.getInstance();
