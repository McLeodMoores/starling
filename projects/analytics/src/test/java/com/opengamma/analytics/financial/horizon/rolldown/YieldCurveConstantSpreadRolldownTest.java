...
public class YieldCurveConstantSpreadRolldownTest {
  ...
  public void testNullCurve() {
    YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(null, 1);
  }
  ...
  public void testHighT() {
    YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(INTERPOLATED_CURVE, 1).getInterestRate(9.9);
  }
  ...
  public void testLowT() {
    YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(INTERPOLATED_CURVE, -2).getInterestRate(0.1);
  }
  ...
  public void testRolldown() {
    YieldAndDiscountCurve newYieldCurve = YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(INTERPOLATED_CURVE, 1);
    ...
    newYieldCurve = YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(INTERPOLATED_CURVE, 3);
    assertTrue(((YieldCurve) newYieldCurve).getCurve() instanceof FunctionalDoublesCurve);
    ...
    newYieldCurve = YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(INTERPOLATED_CURVE, -1);
    assertTrue(((YieldCurve) newYieldCurve).getCurve() instanceof FunctionalDoublesCurve);
    ...
    newYieldCurve = YieldCurveConstantSpreadRolldown.INSTANCE.rollDown(FUNCTIONAL_CURVE, 1);
    assertTrue(((YieldCurve) newYieldCurve).getCurve() instanceof FunctionalDoublesCurve);
