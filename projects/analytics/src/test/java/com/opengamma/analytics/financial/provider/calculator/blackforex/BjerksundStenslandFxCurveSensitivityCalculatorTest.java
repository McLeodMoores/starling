...
/**
 * Unit tests for {@link BjerksundStenslandFxCurveSensitivityCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class BjerksundStenslandFxCurveSensitivityCalculatorTest {
  /** The calculator being tested. */
  private static final BjerksundStenslandFxCurveSensitivityCalculator CALCULATOR = BjerksundStenslandFxCurveSensitivityCalculator.getInstance();
