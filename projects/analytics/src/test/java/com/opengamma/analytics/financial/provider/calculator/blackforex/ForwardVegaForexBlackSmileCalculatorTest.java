...
/**
 * Unit tests for {@link ForwardVegaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class ForwardVegaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final ForwardVegaForexBlackSmileCalculator CALCULATOR = ForwardVegaForexBlackSmileCalculator.getInstance();
   ...
   * value returned is the theoretical vega of the option and is not scaled by the notionals.
   */
  @Test
