...
/**
 * Unit tests for {@link PercentageGammaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class PercentageGammaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final PercentageGammaForexBlackSmileCalculator CALCULATOR = PercentageGammaForexBlackSmileCalculator.getInstance();
  ...
  /**
   * Tests that long and short vanilla options give the same results with a different sign.
   */
  @Test
  public void testLongShortVanillaOption() {
    ...
    assertEqualsAfterScaling(longCall, longPut, 1);
    assertEqualsAfterScaling(shortCall, shortPut, 1);
  }
