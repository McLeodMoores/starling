...
/**
 * Unit tests for {@link ValueGammaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class ValueGammaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final ValueGammaForexBlackSmileCalculator CALCULATOR = ValueGammaForexBlackSmileCalculator.getInstance();
