...
public class StandardDataSetsBlack {
  ...
  private static final Interpolator1D TIME_SQUARE_FLAT = NamedInterpolator1dFactory.of(TimeSquareInterpolator1dAdapter.NAME, FlatExtrapolator1dAdapter.NAME,
      FlatExtrapolator1dAdapter.NAME);
