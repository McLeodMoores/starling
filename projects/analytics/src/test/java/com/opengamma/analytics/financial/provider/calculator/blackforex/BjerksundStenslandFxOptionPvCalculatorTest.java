...
/**
 * Unit tests for {@link BjerksundStenslandFxOptionPvCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class BjerksundStenslandFxOptionPvCalculatorTest {
  /** The calculator being tested. */
  private static final BjerksundStenslandFxOptionPvCalculator CALCULATOR = BjerksundStenslandFxOptionPvCalculator.getInstance();
