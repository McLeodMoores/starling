...
/**
 * Unit tests for {@link CurrencyExposureForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class CurrencyExposureForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final CurrencyExposureForexBlackSmileCalculator CALCULATOR = CurrencyExposureForexBlackSmileCalculator.getInstance();
