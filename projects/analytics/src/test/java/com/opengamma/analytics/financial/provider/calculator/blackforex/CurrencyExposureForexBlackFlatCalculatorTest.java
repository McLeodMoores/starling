...
/**
 * Unit tests for {@link CurrencyExposureForexBlackFlatCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class CurrencyExposureForexBlackFlatCalculatorTest {
  /** The calculator being tested. */
  private static final CurrencyExposureForexBlackFlatCalculator CALCULATOR = CurrencyExposureForexBlackFlatCalculator.getInstance();
