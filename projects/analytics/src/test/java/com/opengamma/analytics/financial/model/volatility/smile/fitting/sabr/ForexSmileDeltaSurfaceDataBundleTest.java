...
public class ForexSmileDeltaSurfaceDataBundleTest {
  ...
  private static final double[][] RR = new double[][] { {-0.0168, -0.02935, -0.039125, -0.047325, -0.058325, -0.06055, -0.0621, -0.063, -0.032775, -0.023925 },
    ...
    private static final double[][] STRANGLE = new double[][] { {0.00665, 0.00725, 0.00835, 0.009075, 0.013175, 0.01505, 0.01565, 0.0163, 0.009275, 0.007075, },
      ...
      private static final NamedInterpolator1d INTERPOLATOR = NamedInterpolator1dFactory.of(DoubleQuadraticInterpolator1dAdapter.NAME,
      ...
      public void testNullForwards() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, null, EXPIRIES, DELTAS, ATM, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testNullExpiries1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, null, DELTAS, ATM, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testNullDeltas1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, null, ATM, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testNullATM1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, null, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testNullRR1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, null, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testNullStrangle1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, RR, null, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testNullInterpolator() {
        new ForexSmileDeltaSurfaceDataBundle(null, FORWARDS, EXPIRIES, DELTAS, ATM, RR, STRANGLE, IS_CALL_DATA);
      }
      ...
      public void testForwardLength() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, new double[] { 2 }, EXPIRIES, DELTAS, ATM, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testATMLength1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, new double[] { 2 }, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testDeltaLength1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, new double[0], ATM, RR, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testRRLength1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, new double[][] { ATM }, STRANGLE, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testStrangleLength1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, RR, new double[][] { ATM }, IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testRR1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, new double[][] { ATM, ATM, new double[] { 1, 2 } }, STRANGLE,
            IS_CALL_DATA);
      }

      @Test(expectedExceptions = IllegalArgumentException.class)
      public void testStrangle1() {
        new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, RR, new double[][] { ATM, ATM, new double[] { 1, 2 } }, IS_CALL_DATA);
      }
      ...
      public void testObject() {
        ...
        assertEquals(DATA, other);
        assertEquals(DATA.hashCode(), other.hashCode());
    other = new ForexSmileDeltaSurfaceDataBundle(INTERPOLATOR, FORWARDS, EXPIRIES, DELTAS, ATM, RR, STRANGLE, IS_CALL_DATA);
