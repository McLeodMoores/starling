...
public class MultiCapFloorPricerTest extends CapletStrippingSetup {
  ...
  /**
   * Since finding implied vol is expensive compared to finding a price (10-20 times more), there is little (relative) difference here. This
   * is why it is quicker to to caplet stripping based on price (weighted by vega) rather than implied vol.
   */
  @SuppressWarnings("unused")
  @Test
