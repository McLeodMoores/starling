...
/**
 * Unit tests for {@link ValueDeltaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class ValueDeltaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final ValueDeltaForexBlackSmileCalculator CALCULATOR = ValueDeltaForexBlackSmileCalculator.getInstance();
