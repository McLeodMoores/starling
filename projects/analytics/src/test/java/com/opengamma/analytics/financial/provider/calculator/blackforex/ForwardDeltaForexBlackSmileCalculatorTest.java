...
/**
 * Unit tests for {@link ForwardDeltaForexBlackSmileCalculator}.
 */
@Test(groups = TestGroup.UNIT)
public class ForwardDeltaForexBlackSmileCalculatorTest {
  /** The calculator being tested. */
  private static final ForwardDeltaForexBlackSmileCalculator CALCULATOR = ForwardDeltaForexBlackSmileCalculator.getInstance();
   ...
   * value returned is the theoretical delta of the option and is not scaled by the notionals.
   */
  @Test
