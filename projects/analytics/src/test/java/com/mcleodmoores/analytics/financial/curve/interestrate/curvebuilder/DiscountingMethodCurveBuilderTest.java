...
import com.mcleodmoores.analytics.financial.curve.interestrate.curvebuilder.PreConstructedCurveTypeSetUp;
...
public class DiscountingMethodCurveBuilderTest {
  ...
  public void testNullCurveNames() {
    new DiscountingMethodCurveBuilder(null, DISCOUNTING, IBOR, OVERNIGHT, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, new RootFinderSetUp());
  }
