...
/**
 * Method to computes the present value and sensitivities of physical delivery European swaptions with the Hull-White one factor model. Reference: Henrard, M.
 * (2003). Explicit bond option and swaption formula in Heath-Jarrow-Morton one-factor model. International Journal of Theoretical and Applied Finance,
 * 6(1):57--72.
 */
public final class SwaptionPhysicalFixedIborHullWhiteMethod {
   ...
   *          The swaption.
   * @param cfe
   *          The swaption cash flow equivalent.
   * @param hullWhite
   *          The Hull-White parameters and the curves.
   * @return The present value.
   */
  public MultipleCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final AnnuityPaymentFixed cfe,
