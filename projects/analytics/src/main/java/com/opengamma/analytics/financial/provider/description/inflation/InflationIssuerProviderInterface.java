...
/**
 * Interface specific to inflation curves. Compose the MulticurveProviderInterface.
 */
public interface InflationIssuerProviderInterface extends ParameterIssuerProviderInterface, ParameterInflationProviderInterface {
  ...
  /**
   * Gets an unmodifiable sorted set of the names of all curves. An empty set of is returned if there are no curves in this provider.
   * 
   * @return The names.
   */
  @Override
   ...
   *          The currency
   * @param replacement
   *          The replacement identifier / issuer pair
