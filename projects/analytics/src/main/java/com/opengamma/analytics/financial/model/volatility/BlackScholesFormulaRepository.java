...
public abstract class BlackScholesFormulaRepository {
  ...
  public static double price(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
    ...
    final double discount = Math.abs(interestRate) < SMALL ? 1. : Math.exp(-interestRate * timeToExpiry);
  ...
  public static double delta(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
    ...
    final double rescaledSpot = spot * factor;
   ...
   * @param isCall
   *          true for call
   * @return The strike Note that the parameter range is more restricted for this method because the strike is undetermined for infinite/zero valued parameters
   */
  public static double strikeForDelta(final double spot, final double spotDelta, final double timeToExpiry, final double lognormalVol,
      final double interestRate, final double costOfCarry,
   ...
   */
  @ExternalFunction
  public static double dualDelta(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
  ...
  public static double gamma(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
    ...
    if (Math.abs(spot - strike) < SMALL || spot > LARGE && strike > LARGE) {
      final double coefD1 = Math.abs(costOfCarry) < SMALL && lognormalVol < SMALL ? Math.signum(costOfCarry) + 0.5 * lognormalVol
   ...
   */
  @ExternalFunction
  public static double dualGamma(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
    ...
    final double discount = Math.abs(interestRate) < SMALL && timeToExpiry > LARGE ? 1. : Math.exp(-interestRate * timeToExpiry);
   ...
   */
  @ExternalFunction
  public static double crossGamma(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
  ...
  public static double theta(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
    ...
    if (Math.abs(spot - strike) < SMALL || sigmaRootT > LARGE) {
      ...
      final double coefD2 = Math.abs(costOfCarry) < SMALL && lognormalVol < SMALL ? Math.signum(costOfCarry) - 0.5 * lognormalVol
          : costOfCarry / lognormalVol - 0.5 * lognormalVol;
   ...
   * @return The charm
   */
  public static double charm(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry, final boolean isCall) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
    ...
    if (Math.abs(spot - strike) < SMALL || spot > LARGE && strike > LARGE || sigmaRootT > LARGE) {
      final double coefD1 = Double.isNaN(Math.abs(costOfCarry) / lognormalVol) ? Math.signum(costOfCarry) + 0.5 * lognormalVol
          : costOfCarry / lognormalVol + 0.5 * lognormalVol;
      final double tmpD1 = Math.abs(coefD1) < SMALL ? 0. : coefD1 * rootT;
      d1 = Double.isNaN(tmpD1) ? Math.signum(coefD1) : tmpD1;
      final double coefD2 = Double.isNaN(Math.abs(costOfCarry) / lognormalVol) ? Math.signum(costOfCarry) - 0.5 * lognormalVol
          : costOfCarry / lognormalVol - 0.5 * lognormalVol;
      final double tmpD2 = Math.abs(coefD2) < SMALL ? 0. : coefD2 * rootT;
      d2 = Double.isNaN(tmpD2) ? Math.signum(coefD2) : tmpD2;
    } else {
    ...
    final double coefPdf = cocMod - 0.5 * tmp;
   ...
   */
  public static double dualCharm(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry,
      final boolean isCall) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
   ...
   */
  @ExternalFunction
  public static double vanna(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
   ...
   */
  @ExternalFunction
  public static double dualVanna(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
   ...
   */
  @ExternalFunction
  public static double vomma(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
   ...
   */
  @ExternalFunction
  public static double vegaBleed(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
    ArgumentChecker.isTrue(timeToExpiry >= 0.0, "negative/NaN timeToExpiry; have {}", timeToExpiry);
    ...
    if (Math.abs(spot - strike) < SMALL || spot > LARGE && strike > LARGE || rootT > LARGE) {
      ...
      if (lognormalVol > LARGE) {
        ...
        if (lognormalVol < SMALL) {
          ...
          d1 = tmp + 0.5 * sigmaRootT;
          final double pDivTmp = interestRate - 0.5 * costOfCarry * (1. - costOfCarry / lognormalVol / lognormalVol);
          final double pDiv = Double.isNaN(pDivTmp) ? rootT : pDivTmp * rootT;
   ...
   */
  @ExternalFunction
  public static double rho(final double spot, final double strike, final double timeToExpiry, final double lognormalVol, final double interestRate,
      final double costOfCarry,
      final boolean isCall) {
    ArgumentChecker.isTrue(spot >= 0.0, "negative/NaN spot; have {}", spot);
    ArgumentChecker.isTrue(strike >= 0.0, "negative/NaN strike; have {}", strike);
