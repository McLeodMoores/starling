...
public class EnergyFutureSecurity extends CommodityFutureSecurity {
  ...
  public EnergyFutureSecurity(final double lastTradingTime, final CommodityUnderlying underlying, final String unitName,
    ...
    super(lastTradingTime, underlying, unitName, unitAmount, noticeFirstTime, noticeLastTime, firstDeliveryTime,
        lastDeliveryTime, settlementType, settlementTime, name, calendar);
  }
