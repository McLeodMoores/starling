...
/**
 * Class representing a Global Industry Classification Standard Code (GICS). GICS codes are eight-digit numbers used to classify the industry of a company.
 * <p>
...
public final class GICSCode implements ImmutableBean, Serializable {
   ...
   * 
   * @param code
   *          The code as an integer, greater than 10 and less than 100000000
   * @return The GICS
   */
   ...
   *           If the code entered is not an eight-digit number of the appropriate pattern
   */
  ...
  /**
   * Gets the industry group. Returns an empty string if the code does not contain this information.
   * 
  ...
  /**
   * Gets the industry. Returns an empty string if the code does not contain this information.
   * 
   * @return The industry
   */
  ...
  /**
   * Gets the sub-industry. Returns an empty string if the code does not contain this information.
   * 
  ...
  static {
    MetaBean.register(GICSCode.Meta.INSTANCE);
  }
