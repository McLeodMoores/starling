 ...
 * the yield curve and in the time series on the first of the month. The pay-off is (final index / start index - 1) * notional if the notional is not paid and
 * final index / start index * notional if the notional is paid.
 */
public class CouponInflationZeroCouponMonthly extends CouponInflation {
   ...
   *          The index value at the start of the coupon for the standard product .
   ...
   */
  public CouponInflationZeroCouponMonthly(final Currency currency, final double paymentTime, final double paymentYearFraction, final double notional,
  ...
  public CouponInflationZeroCouponMonthly withNotional(final double notional) {
    return new CouponInflationZeroCouponMonthly(getCurrency(), getPaymentTime(), getPaymentYearFraction(), notional, getPriceIndex(), _indexStartValue,
