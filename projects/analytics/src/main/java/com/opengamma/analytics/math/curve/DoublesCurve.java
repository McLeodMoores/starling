...
public abstract class DoublesCurve extends Curve<Double, Double> {
   ...
   *
   * @param x
   *          the value at which the parameter sensitivity is computed, not null
   ...
   *
   * @param x
   *          the value at which the derivative is taken
   * @return the first derivative
   */
  public abstract double getDyDx(double x);
  ...
  static {
    MetaBean.register(DoublesCurve.Meta.INSTANCE);
  }
