...
public class ParameterSensitivityBlackSmileCapDiscountInterpolatedFDCalculator {
   ...
   *          The shift used for finite difference.
   */
  public ParameterSensitivityBlackSmileCapDiscountInterpolatedFDCalculator(
      final InstrumentDerivativeVisitor<BlackSmileCapProviderInterface, MultipleCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final BlackSmileCapProviderDiscount black) {
    ...
    for (final Currency ccy : ccyDiscounting) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final BlackSmileCapProviderDiscount marketDscBumpedPlus = new BlackSmileCapProviderDiscount(
        ...
        final BlackSmileCapProviderDiscount marketDscBumpedMinus = new BlackSmileCapProviderDiscount(
    ...
    for (final IndexON index : indexON) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final YieldAndDiscountCurve dscBumpedPlus = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumpedPlus, curveInt.getInterpolator(), true));
        final BlackSmileCapProviderDiscount marketFwdBumpedPlus = new BlackSmileCapProviderDiscount(
        ...
        final YieldAndDiscountCurve dscBumpedMinus = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumpedMinus, curveInt.getInterpolator(), true));
        final BlackSmileCapProviderDiscount marketFwdBumpedMinus = new BlackSmileCapProviderDiscount(
