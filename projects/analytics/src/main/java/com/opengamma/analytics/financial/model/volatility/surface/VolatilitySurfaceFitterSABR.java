...
public class VolatilitySurfaceFitterSABR extends VolatilitySurfaceFitter<SABRFormulaData> {
   ...
   */
  public VolatilitySurfaceFitterSABR(final double[] forwards, final double[][] strikes, final double[] expiries, final double[][] impliedVols,
      final double[][] errors,
      final VolatilityFunctionProvider<SABRFormulaData> model, final LinkedHashMap<String, double[]> knotPoints,
