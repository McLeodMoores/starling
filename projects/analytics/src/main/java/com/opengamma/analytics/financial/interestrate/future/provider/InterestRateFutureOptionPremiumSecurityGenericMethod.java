 ...
 */
public abstract class InterestRateFutureOptionPremiumSecurityGenericMethod<DATA_TYPE extends ParameterProviderInterface> {
   ...
   */
  public abstract double price(InterestRateFutureOptionPremiumSecurity security, DATA_TYPE data);
   ...
   */
  public abstract MulticurveSensitivity priceCurveSensitivity(InterestRateFutureOptionPremiumSecurity security, DATA_TYPE data);
