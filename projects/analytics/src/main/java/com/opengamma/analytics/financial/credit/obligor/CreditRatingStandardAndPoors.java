...
/**
 * Enumerate the possible credit rating states for a reference entity (Standard &amp; Poor's rating classifications). The ratings are long
 * term.
 * <p>
 * This is an incomplete list of the long-term S&amp;P ratings classifications, but this enum is deprecated and will not be completed. The
 * DEFAULT value has been mapped to D.
 *
...
public enum CreditRatingStandardAndPoors {
   ...
   *          The rating description
   */
  CreditRatingStandardAndPoors(final String rating, final String description) {
    _rating = rating;
