...
public class LiborMarketModelDisplacedDiffusionProviderDiscount extends LiborMarketModelDisplacedDiffusionProvider {
  ...
  /**
   * Constructor from exiting multicurveProvider and LMM parameters. The given provider and parameters are used for the new provider (the same maps are used,
   * not copied).
   *
   * @param multicurves
   *          The multi-curves provider.
   * @param parameters
   *          The LMM one factor parameters.
   * @param ccy
   *          The currency for which the LMM parameters are valid (LMM on the discounting curve).
   */
  public LiborMarketModelDisplacedDiffusionProviderDiscount(final MulticurveProviderDiscount multicurves,
   ...
   *
   * @param other
   *          The other provider. TODO: REVIEW: Should we check that the curve are already present? Should we update the HW parameters.
   */
