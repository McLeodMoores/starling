 ...
 */
public final class PresentValueCurveSensitivityBlackSmileCapCalculator
    extends InstrumentDerivativeVisitorAdapter<BlackSmileCapProviderInterface, MultipleCurrencyMulticurveSensitivity> {
