 ...
 * 
 * @param <F>
 *          The type of the function to minimize
 * @param <G>
 *          The type of the gradient function
 * @param <S>
 *          The type of the start position of the minimization
 */
public interface MinimizerWithGradient<F extends Function1D<S, ?>, G extends Function1D<S, ?>, S> extends Minimizer<F, S> {

  /**
   * @param function
   *          The function to minimize, not null
   * @param gradient
   *          The gradient function, not null
   * @param startPosition
   *          The start position, not null
   * @return The minimum
   */
