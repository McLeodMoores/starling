...
public class ParameterSensitivityIssuerDiscountInterpolatedFDCalculator {
   ...
   *          The shift used for finite difference.
   */
  public ParameterSensitivityIssuerDiscountInterpolatedFDCalculator(
      final InstrumentDerivativeVisitor<ParameterIssuerProviderInterface, MultipleCurrencyAmount> valueCalculator, final double shift) {
