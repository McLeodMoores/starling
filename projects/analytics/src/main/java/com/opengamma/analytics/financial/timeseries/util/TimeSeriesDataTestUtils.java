...
public class TimeSeriesDataTestUtils {
   ...
   *          The minimum size
   * @throws IllegalArgumentException
   *           If the time series is null, empty, or contains fewer elements than the minimum size, if the minimum size is less than zero
   */
   ...
   * @param ts2
   *          the second time-series, not null
   * @param maxDifference
   *          The difference above which numbers are not equal
   */
