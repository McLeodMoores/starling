 ...
 * lastTimeCalculator is stored. The node are computed from the instruments. The number of instruments is set exogenously.
 */
public class GeneratorCurveYieldInterpolatedNumber extends GeneratorYDCurve {
   ...
   *          The interpolator used for the curve.
   */
  public GeneratorCurveYieldInterpolatedNumber(final InstrumentDerivativeVisitorAdapter<Object, Double> nodeTimeCalculator,
      final int numberNode,
