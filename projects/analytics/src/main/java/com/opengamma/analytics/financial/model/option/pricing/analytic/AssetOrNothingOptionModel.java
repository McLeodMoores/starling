...
/**
 * Class for pricing asset-or-nothing options (see {@link com.opengamma.analytics.financial.model.option.definition.AssetOrNothingOptionDefinition}). The price
 * is calculated using the Reiner-Rubenstein formula.
 */
