...
public class BlackSmileCapInflationZeroCouponProviderDiscount extends BlackSmileCapInflationZeroCouponProvider {
   ...
   */
  public BlackSmileCapInflationZeroCouponProviderDiscount(final InflationProviderDiscount inflation, final BlackSmileCapInflationZeroCouponParameters parameters) {
