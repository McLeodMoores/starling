...
public class BondIborTransaction extends BondTransaction<BondIborSecurity> {
   ...
   */
  public BondIborTransaction(final BondIborSecurity bondTransaction, final double quantity, final double transactionPrice, final BondIborSecurity bondStandard,
