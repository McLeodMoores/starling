...
public class BondCapitalIndexedTransaction<C extends Coupon> extends BondTransaction<BondCapitalIndexedSecurity<C>> {
   ...
   *          The transaction clean real price.
   * @param bondStandard
   *          Description of the underlying bond with standard settlement date.
   * @param notionalStandard
   *          The notional at the standard spot time.
   */
  public BondCapitalIndexedTransaction(final BondCapitalIndexedSecurity<C> bondPurchased, final double quantity, final double transactionPrice,
      final BondCapitalIndexedSecurity<C> bondStandard,
