 ...
 * provides functions that will provide the gradient of the functions that perform these transformations. Let y be the model parameter and yStar the transformed
 * (fitting) parameter, then we write y* = f(y)
 */
public interface ParameterLimitsTransform {
  ...
  /**
   * The gradient of the function used to transform from a model parameter that is only allows to take certain values, to a fitting parameter that can take any
   * value.
   *
   * @param x
   *          Model parameter
  ...
  /**
   * The gradient of the function used to transform from a fitting parameter that can take any value, to a model parameter that is only allows to take certain
   * values.
   *
   * @param y
   *          fitting parameter
