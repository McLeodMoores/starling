...
public class ParameterSensitivityBlackSmileYearOnYearCapDiscountInterpolatedFDCalculator {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument,
      final BlackSmileCapInflationYearOnYearProviderDiscount black) {
    ...
    for (final IndexPrice index : indexPrice) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final BlackSmileCapInflationYearOnYearProviderDiscount marketDscBumped = new BlackSmileCapInflationYearOnYearProviderDiscount(
    ...
    for (final IndexON index : indexON) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final YieldAndDiscountCurve fwdBumped = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumped, curveInt.getInterpolator(), true));
        final BlackSmileCapInflationYearOnYearProviderDiscount marketFwdBumped = new BlackSmileCapInflationYearOnYearProviderDiscount(
