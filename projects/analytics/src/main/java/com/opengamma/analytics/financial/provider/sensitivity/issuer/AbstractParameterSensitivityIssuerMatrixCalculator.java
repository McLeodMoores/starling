...
public abstract class AbstractParameterSensitivityIssuerMatrixCalculator {
   ...
   *          The calculator.
   */
  public AbstractParameterSensitivityIssuerMatrixCalculator(
   ...
   */
  public DoubleMatrix1D calculateSensitivity(final InstrumentDerivative instrument, final ParameterIssuerProviderInterface multicurves,
   ...
   * @return The sensitivity (as a DoubleMatrix1D).
   */
  public abstract DoubleMatrix1D pointToParameterSensitivity(MulticurveSensitivity sensitivity, ParameterIssuerProviderInterface multicurves,
