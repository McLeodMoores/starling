...
public interface BlackForexProviderInterface<VOLATILITY_TYPE> extends ParameterProviderInterface {
  ...
  /**
   * Checks that the two currencies are consistent with those for which this surface applies. The order of the two currencies is not important.
   * 
   * @param ccy1
   *          The first currency.
   * @param ccy2
   ...
   */
  boolean checkCurrencies(Currency ccy1, Currency ccy2);
