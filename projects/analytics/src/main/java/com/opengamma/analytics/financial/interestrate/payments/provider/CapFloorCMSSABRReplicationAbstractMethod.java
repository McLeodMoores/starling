...
public abstract class CapFloorCMSSABRReplicationAbstractMethod {
   ...
   */
  public abstract MultipleCurrencyAmount presentValue(CapFloorCMS cmsCapFloor, SABRSwaptionProviderInterface sabrData);
   ...
   */
  public abstract MultipleCurrencyMulticurveSensitivity presentValueCurveSensitivity(CapFloorCMS cmsCapFloor,
      SABRSwaptionProviderInterface sabrData);
   ...
   */
  public abstract PresentValueSABRSensitivityDataBundle presentValueSABRSensitivity(CapFloorCMS cmsCapFloor,
      SABRSwaptionProviderInterface sabrData);
   ...
   */
  public abstract double presentValueStrikeSensitivity(CapFloorCMS cmsCapFloor, SABRSwaptionProviderInterface sabrData);
