...
public abstract class ParameterSensitivityInflationMatrixProviderAbstractCalculator {
   ...
   *          The calculator.
   */
  public ParameterSensitivityInflationMatrixProviderAbstractCalculator(
   ...
   */
  public DoubleMatrix1D calculateSensitivity(final InstrumentDerivative instrument, final InflationProviderInterface inflationCurves,
   ...
   * @return The sensitivity (as a DoubleMatrix1D).
   */
  public abstract DoubleMatrix1D pointToParameterSensitivity(InflationSensitivity sensitivity, InflationProviderInterface inflation, Set<String> curvesSet);
}
