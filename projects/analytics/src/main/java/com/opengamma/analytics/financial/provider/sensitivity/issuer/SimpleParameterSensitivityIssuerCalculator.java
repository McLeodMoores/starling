 ...
 *          Data type.
 */
public class SimpleParameterSensitivityIssuerCalculator<DATA_TYPE extends ParameterIssuerProviderInterface>
    extends SimpleParameterSensitivityIssuerAbstractCalculator<DATA_TYPE> {
   ...
   */
  @Override
  public SimpleParameterSensitivity pointToParameterSensitivity(final MulticurveSensitivity sensitivity, final DATA_TYPE multicurves,
