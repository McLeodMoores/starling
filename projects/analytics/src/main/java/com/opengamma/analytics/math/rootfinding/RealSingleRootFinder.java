...
public abstract class RealSingleRootFinder implements SingleRootFinder<Double, Double> {
   ...
   * @param x1
   *          The first bound, not null
   * @param x2
   *          The second bound, not null, must be greater than x1
   * @throws IllegalArgumentException
   *           if x1 and x2 do not bracket a root
   */
  protected void checkInputs(final Function<Double, Double> function, final Double x1, final Double x2) {
