 ...
 * <p>
 * This measure is defined as: $$ \begin{eqnarray*} MRAP_i = R_i + \left(\frac{1}{\beta_i} - 1\right)(R_i - R_f) \end{eqnarray*} $$ where $R_i$ is the asset
 * return, $\beta_i$ is the beta of the asset with respect to the market and $R_f$ is the risk-free return.
 */
public class MarketRiskAdjustedPerformanceCalculator {
   ...
   * @param beta
   *          The beta of the asset with respect to the market
