...
public class AnnuityForSpreadApproxFunction extends AnnuityForSpreadFunction {
  ...
  /**
   * For a given quoted spread (aka 'flat' spread), this function returns the risky annuity (aka risky PV01, RPV01 or risky duration). This works by first
   * calibrating a constant hazard rate that recovers the given spread, then computing the value of the annuity from this constant hazard rate. The ISDA
   * standard CDS model is used for these calculations.
   * 
   * @param cds
