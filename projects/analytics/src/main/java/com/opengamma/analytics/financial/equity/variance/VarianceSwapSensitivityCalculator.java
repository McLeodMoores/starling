...
/**
 * This Calculator provides price sensitivities for the VarianceSwap derivative to changes in market values. Interest rates,
 * <p>
 * Equity European Option Volatility,
 * <p>
 * Spot VarianceSwap contracts,
 * <p>
 * Equity Spot contracts,
 * <p>
...
public final class VarianceSwapSensitivityCalculator extends EquityDerivativeSensitivityCalculator {
  ...
  /**
   * Calculates the sensitivity of the present value (PV) to a change in the funding rate from valuation to settlement. Also known as PVBP
   * and DV01, though note scaling - this returns per UNIT change in rate (100%). calcPV01 returns per basis point change in rates.
   * <p>
   * Rates enter the pricing of a VarianceSwap in two places: in the discounting and forward projection.
   * <p>
  ...
  /**
   * This calculates the derivative of the present value (PV) with respect to the level of the fair value of variance of a spot starting
   * swap with an expiry equal to the that remaining in the existing VarianceSwap, as described by David E Kuenzi in Risk 2005, 'Variance
   * swaps and non-constant vega'
   * <p>
