...
public abstract class AbstractParameterInflationSensitivityParameterCalculator<DATA_TYPE extends ParameterInflationProviderInterface> {
   ...
   *          The calculator.
   */
  public AbstractParameterInflationSensitivityParameterCalculator(
   ...
   * @return The sensitivity (as a ParameterSensitivity).
   */
  public abstract MultipleCurrencyParameterSensitivity pointToParameterSensitivity(MultipleCurrencyInflationSensitivity sensitivity,
