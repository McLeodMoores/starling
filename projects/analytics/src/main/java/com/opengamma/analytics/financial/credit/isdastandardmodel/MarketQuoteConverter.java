...
/**
 * Standard CDS have a standard premium (100 or 500bps in North America) and are quoted as either as Points Up-Front (PUF) or quoted spread - these method allow
 * conversion via a single constant hazard rate.
 * <p>
...
public class MarketQuoteConverter {
   ...
   * @param yieldCurve
   *          the yield/discount curve
   * @param creditCurve
   *          the credit/hazard curve
   * @param coupon
   *          The fractional quoted spread (coupon) of the CDS
   * @return the clean price (as a fraction)
   */
   ...
   */
  public double principal(final double notional, final CDSAnalytic cds, final ISDACompliantYieldCurve yieldCurve, final ISDACompliantCreditCurve creditCurve,
      final double coupon) {
   ...
   *          The CDS to be traded
   * @param premium
   *          The standard premium of the CDS <b>expressed as a fraction</b>
   * @param yieldCurve
   *          the yield/discount curve
   * @param creditCurve
   *          the credit/hazard curve
   * @return points up-front - these are usually quoted as a percentage of the notional - here we return a fraction of notional, so 0.01 is 1(%) points up-front
   */
  public double pointsUpFront(final CDSAnalytic cds, final double premium, final ISDACompliantYieldCurve yieldCurve,
   ...
   *          collection of CDSs
   * @param premium
   *          The single common premium of the CDSs expressed as fractions (these are usually 0.01 or 0.05)
   * @param yieldCurve
   *          the yield/discount curve
   * @param creditCurve
   *          the credit/hazard curve
   ...
   *          collection of CDSs
   * @param premiums
   *          The premiums of the CDSs expressed as fractions (these are usually 0.01 or 0.05)
   * @param yieldCurve
   *          the yield/discount curve
   * @param creditCurve
   *          the credit/hazard curve
   ...
   */
  public double[] pointsUpFront(final CDSAnalytic[] cds, final double[] premiums, final ISDACompliantYieldCurve yieldCurve,
      final ISDACompliantCreditCurve creditCurve) {
    ArgumentChecker.noNulls(cds, "cds");
   ...
   *          the yield/discount curve
   * @param quotedSpread
   *          The quoted spread (<b>as a fraction</b>).
   * @return points up-front - these are usually quoted as a percentage of the notional - here we return a fraction of notional, so 0.01 is 1(%) points up-front
   */
   ...
   *          The CDS to be traded
   * @param puf
   *          point-up-front (this contains the premium)
   * @param yieldCurve
   *          the yield/discount curve
   ...
   *          The single common premium of the CDSs expressed as fractions (these are usually 0.01 or 0.05)
   * @param yieldCurve
   *          yieldCurve the yield/discount curve
   * @param quotedSpreads
   *          The quoted spreads (<b>as a fractions</b>).
   ...
   *          the yield/discount curve
   * @param pointsUpfront
   *          The points up-front (expressed as fractions)
   ...
   *          yieldCurve the yield/discount curve
   * @param parSpreads
   *          The par-spreads (<b>as a fractions</b>).
   * @return points up-front (expressed as fractions)
   */
   ...
   */
  public double[] parSpreadsToQuotedSpreads(final CDSAnalytic[] cds, final double premium, final ISDACompliantYieldCurve yieldCurve,
      final double[] parSpreads) {
   ...
   * @return quoted spreads
   */
  public double[] parSpreadsToQuotedSpreads(final CDSAnalytic[] cds, final double[] premiums, final ISDACompliantYieldCurve yieldCurve,
      final double[] parSpreads) {
   ...
   * @return par spreads
   */
  public double[] quotedSpreadToParSpreads(final CDSAnalytic[] cds, final double premium, final ISDACompliantYieldCurve yieldCurve,
      final double[] quotedSpreads) {
   ...
   * @return par spreads
   */
  public double[] quotedSpreadToParSpreads(final CDSAnalytic[] cds, final double[] premiums, final ISDACompliantYieldCurve yieldCurve,
      final double[] quotedSpreads) {
