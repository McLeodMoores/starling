...
/**
 * Calculates the position gamma (second derivative of the price with respect to the underlying future price) for interest rate future options.
 */
public final class PositionGammaSTIRFutureOptionCalculator extends InstrumentDerivativeVisitorAdapter<BlackSTIRFuturesProviderInterface, Double> {
   ...
   * Pricing methods.
   */
  private static final InterestRateFutureOptionMarginTransactionBlackSmileMethod METHOD_STIR =
