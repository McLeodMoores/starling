...
/**
 * Describes a sector. There is the ability to add arbitrary classifications to the description.
 */
...
public final class Sector implements Bean, Serializable {
   ...
   *          The sector classifications, not null
   * @return The sector
   */
   ...
   *          The name of the sector
   * @param classifications
   *          The classifications of the sector
   */
  ...
  static {
    MetaBean.register(Sector.Meta.INSTANCE);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends Sector> builder() {
      return new DirectBeanBuilder<>(new Sector());
    }
