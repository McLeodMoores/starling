...
/**
 * Class describing a provider with discounting, forward and G2++ parameters. The forward rate are computed as the ratio of discount factors stored in
 * YieldAndDiscountCurve.
 */
