...
/**
 * Transaction on a bond future security with cash settlement against a price deduced from a yield average. In particular used for AUD-SFE bond futures.
 */
public class BondFuturesYieldAverageTransaction extends FuturesTransaction<BondFuturesYieldAverageSecurity> {
   ...
   *          The underlying yield average futures security.
   * @param quantity
