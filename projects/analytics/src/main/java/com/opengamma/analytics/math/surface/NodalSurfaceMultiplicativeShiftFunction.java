...
public class NodalSurfaceMultiplicativeShiftFunction implements SurfaceShiftFunction<NodalDoublesSurface> {
   ...
   */
  @Override
  public NodalDoublesSurface evaluate(final NodalDoublesSurface surface, final double[] xShift, final double[] yShift, final double[] percentage,
    ...
    ArgumentChecker.isTrue(m == yShift.length && m == percentage.length,
        "number of shifts {} must be equal to number of x shift positions {} and y shift positions {}",
