...
/**
 * By analogy to the $M^2$ measure, the $T^2$ measure gives the excess market-risk-adjusted performance ($MRAP$) of an asset over the market: $$
 * \begin{eqnarray*} T^2 = MRAP_i - MRAP_M \end{eqnarray*} $$ where $MRAP_i$ is the market-risk-adjusted performance of the asset and $MRAP_M$ is the
 * market-risk-adjusted performance of the market.
 */
