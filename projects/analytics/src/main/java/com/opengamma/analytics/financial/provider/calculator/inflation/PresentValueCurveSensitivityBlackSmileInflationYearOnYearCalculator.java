...
InstrumentDerivativeVisitorAdapter<BlackSmileCapInflationYearOnYearProviderInterface, MultipleCurrencyInflationSensitivity> {
   ...
   */
  private static final PresentValueCurveSensitivityBlackSmileInflationYearOnYearCalculator INSTANCE =
      new PresentValueCurveSensitivityBlackSmileInflationYearOnYearCalculator();
