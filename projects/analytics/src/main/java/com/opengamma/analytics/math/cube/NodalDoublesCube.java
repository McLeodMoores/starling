...
public class NodalDoublesCube extends DoublesCube {
   ...
   * @param vData
   *          A list of <i>v</i> data points, not null, contains same number of entries as <i>x</i>
   * @return A nodal cube with automatically-generated name
   */
   ...
   *          The name of the cube
   */
  public NodalDoublesCube(final List<Double> xData, final List<Double> yData, final List<Double> zData, final List<Double> vData, final String name) {
    super(xData, yData, zData, vData, name);
  }
