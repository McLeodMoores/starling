...
/**
 * Classes that pull out a specific field from an {@link LegalEntity}. As the legal entity is a bundle of various data types, these classes are necessary to
 * allow the correct values to be extracted in a general way.
 *
 * @param <S>
