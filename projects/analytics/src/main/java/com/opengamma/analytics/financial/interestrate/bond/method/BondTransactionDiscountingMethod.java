...
public final class BondTransactionDiscountingMethod {
   ...
   * @return The present value.
   */
  public double presentValueFromCleanPrice(final BondTransaction<? extends BondSecurity<? extends Payment, ? extends Coupon>> bond,
      final YieldCurveBundle curves, final double cleanPrice) {
    ...
    final double dfSettle = curves.getCurve(bondFixed.getBondStandard().getRepoCurveName())
   ...
   * @return The present value.
   */
  public double presentValueFromYield(final BondTransaction<? extends BondSecurity<? extends Payment, ? extends Coupon>> bond, final YieldCurveBundle curves,
      final double yield) {
