 ...
 * curve/currency pair. The sensitivity to a particular curve can be in several currencies. This class is a generalized (to inflation) of
...
public class MarketQuoteInflationSensitivityBlockCalculator<DATA_TYPE extends ParameterInflationProviderInterface> {
   ...
   * The constructor.
   * 
   * @param parameterInflationSensitivityCalculator
   *          The parameter sensitivity calculator.
   */
  public MarketQuoteInflationSensitivityBlockCalculator(
      final AbstractParameterInflationSensitivityParameterCalculator<DATA_TYPE> parameterInflationSensitivityCalculator) {
