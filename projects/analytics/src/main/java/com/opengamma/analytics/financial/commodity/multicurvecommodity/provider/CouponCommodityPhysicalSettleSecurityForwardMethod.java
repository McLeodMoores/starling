...
public final class CouponCommodityPhysicalSettleSecurityForwardMethod {
   ...
   */
  public MultipleCurrencyCommoditySensitivity presentValueCurveSensitivity(final CouponCommodityPhysicalSettle coupon,
  ...
  /**
   * Calculates the second-order sensitivity of a physically-settled commodity instrument to the forward commodity curve.
   *
   * @param coupon  the instrument
   * @param multicurve  the curves
   * @return  the sensitivity
   */
  public MultipleCurrencyCommoditySensitivity presentValueSecondOrderCurveSensitivity(final CouponCommodityPhysicalSettle coupon,
      final CommodityProviderInterface multicurve) {
    ArgumentChecker.notNull(coupon, "Coupon");
    ArgumentChecker.notNull(multicurve, "Curves");
    final double forward = multicurve.getForwardValue(coupon.getUnderlying(), coupon.getSettlementTime());
