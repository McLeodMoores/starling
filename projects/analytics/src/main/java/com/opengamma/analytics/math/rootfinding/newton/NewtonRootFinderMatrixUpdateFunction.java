...
public interface NewtonRootFinderMatrixUpdateFunction {
  ...
  DoubleMatrix2D getUpdatedMatrix(Function1D<DoubleMatrix1D, DoubleMatrix2D> jacobianFunction, DoubleMatrix1D x, DoubleMatrix1D deltaX, DoubleMatrix1D deltaY,
