...
public final class ForexOptionVanillaBlackFlatMethod {
  ...
  public MultipleCurrencyAmount presentValue(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black) {
    ...
    ArgumentChecker.notNull(black, "Smile");
    ...
    final double price = func.apply(dataBlack)
   ...
   * @return The delta.
   */
  public double deltaRelative(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black,
   ...
   * @return The delta.
   */
  public double deltaRelativeSpot(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black,
      final boolean directQuote) {
    ArgumentChecker.notNull(optionForex, "Forex option");
    ArgumentChecker.notNull(black, "Smile");
    final MulticurveProviderInterface multicurves = black.getMulticurveProvider();
   ...
   * @return The gamma.
   */
  public double gammaRelative(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black,
      final boolean directQuote) {
    ArgumentChecker.notNull(optionForex, "Forex option");
    ArgumentChecker.notNull(black, "Smile");
    final MulticurveProviderInterface multicurves = black.getMulticurveProvider();
   ...
   * @return The gamma.
   */
  public double gammaRelativeSpot(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black,
      final boolean directQuote) {
    ArgumentChecker.notNull(optionForex, "Forex option");
    ArgumentChecker.notNull(black, "Smile");
    final MulticurveProviderInterface multicurves = black.getMulticurveProvider();
   ...
   * @return The gamma.
   */
  public CurrencyAmount gamma(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black,
      final boolean directQuote) {
   ...
   * @return The gamma.
   */
  public CurrencyAmount gammaSpot(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black,
      final boolean directQuote) {
  ...
  public CurrencyAmount thetaTheoretical(final ForexOptionVanilla optionForex, final BlackForexFlatProviderInterface black) {
    ...
    final double volatility = black.getVolatility(optionForex.getCurrency1(), optionForex.getCurrency2(), optionForex.getTimeToExpiry());
    final double sign = optionForex.isLong() ? 1.0 : -1.0;
    final double theta = BlackFormulaRepository.driftlessTheta(forward, optionForex.getStrike(), optionForex.getTimeToExpiry(), volatility)
        * sign
  ...
  public MultipleCurrencyMulticurveSensitivity presentValueCurveSensitivity(final ForexOptionVanilla optionForex,
    ...
    // Sensitivity object
    final double factor = Math.abs(optionForex.getUnderlyingForex().getPaymentCurrency1().getAmount())
  ...
  public PresentValueForexBlackVolatilitySensitivity presentValueBlackVolatilitySensitivity(final ForexOptionVanilla optionForex,
    ...
    final double forward = spot
        * multicurves.getDiscountFactor(optionForex.getCurrency1(), optionForex.getUnderlyingForex().getPaymentTime()) / df;
    final double volatility = black.getVolatility(optionForex.getCurrency1(), optionForex.getCurrency2(), optionForex.getTimeToExpiry());
    ...
    final PresentValueForexBlackVolatilitySensitivity sensi = new PresentValueForexBlackVolatilitySensitivity(
        optionForex.getUnderlyingForex().getCurrency1(), optionForex.getUnderlyingForex()
            .getCurrency2(),
        result);
    return sensi;
  }
   ...
   * @param black
   *          The curve and Black data.
   * @return The volatility parameters sensitivity. The sensitivity figures are, like the present value, in the domestic currency (currency
   *         2).
   */
  public double[] presentValueBlackVolatilityNodeSensitivity(final ForexOptionVanilla optionForex,
      final BlackForexFlatProviderInterface black) {
    ArgumentChecker.notNull(optionForex, "Forex option");
    ArgumentChecker.notNull(black, "Smile");
    final MulticurveProviderInterface multicurves = black.getMulticurveProvider();
    ...
    final double volatilitySensitivityValue = priceAdjoint[2] * Math.abs(optionForex.getUnderlyingForex().getPaymentCurrency1().getAmount())
        * (optionForex.isLong() ? 1.0 : -1.0);
    final Double[] parameterSensitivity = black.getVolatilityTimeSensitivity(optionForex.getCurrency1(), optionForex.getCurrency2(),
        optionForex.getTimeToExpiry());
