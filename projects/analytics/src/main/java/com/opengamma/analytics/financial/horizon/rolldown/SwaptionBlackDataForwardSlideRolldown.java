 ...
 */
public final class SwaptionBlackDataForwardSlideRolldown implements RolldownFunction<BlackSwaptionFlatProviderInterface> {
  /**
   * A static instance.
   */
  public static final SwaptionBlackDataForwardSlideRolldown INSTANCE = new SwaptionBlackDataForwardSlideRolldown();

  /**
   * Private constructor
   */
  private SwaptionBlackDataForwardSlideRolldown() {
  }
