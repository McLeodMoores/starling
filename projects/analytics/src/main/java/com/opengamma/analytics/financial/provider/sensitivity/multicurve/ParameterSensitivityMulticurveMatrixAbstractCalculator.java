...
public abstract class ParameterSensitivityMulticurveMatrixAbstractCalculator {
   ...
   *          The calculator.
   */
  public ParameterSensitivityMulticurveMatrixAbstractCalculator(
   ...
   * @return The sensitivity (as a Matrix). The order of the sensitivity is by curve as provided by the curvesSet.
   */
  public abstract DoubleMatrix1D pointToParameterSensitivity(MulticurveSensitivity sensitivity, MulticurveProviderInterface multicurves, Set<String> curvesSet);
