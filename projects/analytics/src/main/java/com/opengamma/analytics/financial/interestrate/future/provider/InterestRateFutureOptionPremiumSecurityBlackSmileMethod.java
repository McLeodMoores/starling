 ...
 */
public final class InterestRateFutureOptionPremiumSecurityBlackSmileMethod
    extends InterestRateFutureOptionPremiumSecurityGenericMethod<BlackSTIRFuturesProviderInterface> {

  /**
   * Creates the method unique instance.
   */
  private static final InterestRateFutureOptionPremiumSecurityBlackSmileMethod INSTANCE = new InterestRateFutureOptionPremiumSecurityBlackSmileMethod();

  /**
   * Constructor.
   */
  private InterestRateFutureOptionPremiumSecurityBlackSmileMethod() {
  }
   ...
   * @return The instance.
   */
  public static InterestRateFutureOptionPremiumSecurityBlackSmileMethod getInstance() {
    return INSTANCE;
  }
   ...
   */
  public double priceFromFuturePrice(final InterestRateFutureOptionPremiumSecurity security,
   ...
   */
  @Override
  public double price(final InterestRateFutureOptionPremiumSecurity security, final BlackSTIRFuturesProviderInterface blackData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(blackData, "Black data");
   ...
   * for a given strike the volatility does not change with the curves (sticky strike).
   *
   * @param security
   *          The future option security.
   * @param blackData
   ...
   */
  @Override
  public MulticurveSensitivity priceCurveSensitivity(final InterestRateFutureOptionPremiumSecurity security,
      final BlackSTIRFuturesProviderInterface blackData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(blackData, "Black data");
    // Forward sweep
   ...
   */
  public SurfaceValue priceBlackSensitivity(final InterestRateFutureOptionPremiumSecurity security,
      final BlackSTIRFuturesProviderInterface blackData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(blackData, "Black data");
    // Forward sweep
  ...
  /**
   * Computes the option security price delta, wrt the futures price dV/df. The futures price is computed without convexity adjustment. It
   * is supposed that for a given strike the volatility does not change with the curves.
   *
   * @param security
   *          The future option security.
   * @param blackData
   ...
   * @return The delta.
   */
  public double priceDelta(final InterestRateFutureOptionPremiumSecurity security, final BlackSTIRFuturesProviderInterface blackData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(blackData, "Black data");
    // Forward sweep
  ...
  /**
   * Computes the option's value gamma, the second derivative of the security price wrt underlying futures rate. The future price is
   ...
   * @return The security price.
   */
  public double priceGamma(final InterestRateFutureOptionPremiumSecurity security, final BlackSTIRFuturesProviderInterface blackData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(blackData, "Black data");
    // Forward sweep
    final double priceFuture = METHOD_FUTURE.price(security.getUnderlyingFuture(), blackData.getMulticurveProvider());
   ...
   */
  public double priceVega(final InterestRateFutureOptionPremiumSecurity security, final BlackSTIRFuturesProviderInterface blackData) {
    // Forward sweep
    final double priceFuture = METHOD_FUTURE.price(security.getUnderlyingFuture(), blackData);
    final double strike = security.getStrike();
    final double rateStrike = 1.0 - strike;
   ...
   * @return the theta.
   */
  public double priceTheta(final InterestRateFutureOptionPremiumSecurity security, final BlackSTIRFuturesProviderInterface black) {
    ...
    final double rate = ((MulticurveProviderDiscount) black.getMulticurveProvider()).getCurve(security.getCurrency())
   ...
   */
  public double impliedVolatility(final InterestRateFutureOptionPremiumSecurity security,
      final BlackSTIRFuturesProviderInterface blackData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(blackData, "Black data");
    final double delay = security.getUnderlyingFuture().getTradingLastTime() - security.getExpirationTime();
   ...
   * @return The security price.
   */
  public double underlyingFuturesPrice(final InterestRateFutureOptionPremiumSecurity security,
      final BlackSTIRFuturesProviderInterface blackData) {
