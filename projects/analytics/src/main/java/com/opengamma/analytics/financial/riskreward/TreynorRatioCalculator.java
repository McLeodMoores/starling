 ...
 * <p>
 * The Treynor ratio is defined as: $$ \begin{eqnarray*} T = \frac{R_i - R_f}{\beta_i} \end{eqnarray*} $$ where $R_i$ is the asset return, $R_f$ is the
 * risk-free return and $\beta_i$ is the portfolio's beta.
 */
public class TreynorRatioCalculator {
   ...
   * 
   * @param assetReturnTS
   *          The asset price time series
   * @param riskFreeReturnTS
   *          The risk-free return time series
   * @param beta
