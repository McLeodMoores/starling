...
public class SABRTermStructureModelProvider extends VolatilityModelProvider {
   ...
   *          Map between parameter curve names ("alpha", "beta", "rho" and "nu") and the parameter transform used for that curve
  ...
  /**
   * @param x
   *          The concatenated nodes that form the interpolated SABR parameter curves
