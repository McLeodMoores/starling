...
/**
 * Implementation of a provider of Black smile for year on year inflation options with convexity adjustment. The volatility is time to expiration/strike/delay
...
public class BlackSmileCapInflationYearOnYearWithConvexityProviderDiscount extends BlackSmileCapInflationYearOnYearWithConvexityProvider {
   ...
   */
  public BlackSmileCapInflationYearOnYearWithConvexityProviderDiscount(final InflationProviderDiscount inflation,
  ...
  public BlackSmileCapInflationYearOnYearWithConvexityProviderDiscount copy() {
    ...
    return new BlackSmileCapInflationYearOnYearWithConvexityProviderDiscount(inflation, getBlackParameters(), getInflationConvexityAdjustmentParameters(),
