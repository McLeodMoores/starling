 ...
 * then used to price a set of caps. So it is a function from a vector (the nodes) to another vector (the cap implied volatilities), and
 * should be used in a fixing routine.
 */
public class CapletStrippingFunction extends Function1D<DoubleMatrix1D, DoubleMatrix1D> {
  ...
  public CapletStrippingFunction(final List<CapFloor> caps, final MulticurveProviderDiscount yieldCurves,
      final VolatilityModelProvider volModelProvider) {
