...
// CSOFF
/**
 * Calculator of the currency exposure for Forex derivatives in the Black
 * (Garman-Kohlhagen) world. The volatilities are given by delta-smile
 * descriptions. To compute the currency exposure, the Black volatility is kept
 * constant; the volatility is not recomputed for spot and forward changes.
 * 
 * @deprecated Calculators that use and populate {@link YieldCurveBundle}s are
 *             deprecated. Use
 *             {@link com.opengamma.analytics.financial.provider.calculator.blackforex.CurrencyExposureForexBlackSmileCalculator}.
 */
@Deprecated
