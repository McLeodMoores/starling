...
// * $\frac{\partial f}{\partial t} + a(t,x)\frac{\partial^2}{\partial x^2}\left[ \alpha(t,x) f \right] + * b(t,x)\frac{\partial}{\partial x}\left[\beta(t,x) f
// \right] + c(t,x)f = 0$
...
// public PDEResults1D solve(final ExtendedConvectionDiffusionPDEDataBundle pdeData, final PDEGrid1D grid, final BoundaryCondition lowerBoundary, final
...
// }
//
// private static PDE1DDataBundle<ConvectionDiffusionPDE1DStandardCofficients> toParabolicPDECoefficients(final
// PDE1DDataBundle<ParabolicPDEExtendedCoefficients> pdeData) {
...
// return new PDE1DDataBundle<ConvectionDiffusionPDE1DStandardCofficients>(coeff, pdeData.getInitialCondition(), pdeData.getLowerBoundary(),
// pdeData.getUpperBoundary(),
// pdeData.getGrid());
// }
// return new PDE1DDataBundle<ConvectionDiffusionPDE1DStandardCofficients>(coeff, pdeData.getInitialCondition(), pdeData.getLowerBoundary(),
// pdeData.getUpperBoundary(),
