...
/**
 * Pricing method for inflation Year on Year coupon. The price is computed by index estimation, discounting and using a convexity adjustment. See note
...
public class CouponInflationYearOnYearMonthlyConvexityAdjustmentMethod {
   ...
   */
  public MultipleCurrencyInflationSensitivity presentValueCurveSensitivity(final CouponInflationYearOnYearMonthly coupon,
