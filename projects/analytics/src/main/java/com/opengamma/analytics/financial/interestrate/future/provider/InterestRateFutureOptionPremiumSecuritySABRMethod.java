 ...
 */
public final class InterestRateFutureOptionPremiumSecuritySABRMethod
    extends InterestRateFutureOptionPremiumSecurityGenericMethod<SABRSTIRFuturesProviderInterface> {

  /**
   * Creates the method unique instance.
   */
  private static final InterestRateFutureOptionPremiumSecuritySABRMethod INSTANCE = new InterestRateFutureOptionPremiumSecuritySABRMethod();

  /**
   * Constructor.
   */
  private InterestRateFutureOptionPremiumSecuritySABRMethod() {
  }
   ...
   * @return The instance.
   */
  public static InterestRateFutureOptionPremiumSecuritySABRMethod getInstance() {
    return INSTANCE;
  }
  ...
  public double priceFromFuturePrice(final InterestRateFutureOptionPremiumSecurity security,
    ...
    final double volatility = sabrData.getSABRParameters()
   ...
   */
  @Override
  public double price(final InterestRateFutureOptionPremiumSecurity security, final SABRSTIRFuturesProviderInterface sabrData) {
  ...
  public MulticurveSensitivity priceCurveSensitivity(final InterestRateFutureOptionPremiumSecurity security,
    ...
    final double forward = 1 - priceFuture;
    final double delay = security.getUnderlyingFuture().getTradingLastTime() - security.getExpirationTime();
    final double[] volatilityAdjoint = sabrData.getSABRParameters().getVolatilityAdjoint(security.getExpirationTime(), delay, rateStrike,
        forward);
   ...
   * @return The security price curve sensitivity.
   */
  public PresentValueSABRSensitivityDataBundle priceSABRSensitivity(final InterestRateFutureOptionPremiumSecurity security,
      final SABRSTIRFuturesProviderInterface sabrData) {
