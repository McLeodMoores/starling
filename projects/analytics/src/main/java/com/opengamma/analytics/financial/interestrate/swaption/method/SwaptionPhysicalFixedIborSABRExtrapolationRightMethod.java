 ...
 * {@link com.opengamma.analytics.financial.model.volatility.smile.function.SABRHaganVolatilityFunction}. OpenGamma implementation note for the extrapolation:
 * Smile extrapolation, version 1.2, May 2011.
 *
...
public class SwaptionPhysicalFixedIborSABRExtrapolationRightMethod {
  ...
  public double presentValue(final SwaptionPhysicalFixedIbor swaption, final SABRInterestRateDataBundle sabrData) {
    ...
    if (strikeModified <= _cutOffStrike) { // No extrapolation
      ...
      return func.apply(dataBlack) * (swaption.isLong() ? 1.0 : -1.0);
    }
    // With extrapolation
    ...
    final SABRExtrapolationRightFunction sabrExtrapolation = new SABRExtrapolationRightFunction(forwardModified, sabrParam, _cutOffStrike,
