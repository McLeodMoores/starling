...
public class FuturesTransactionBlackSTIRFuturesMethod extends FuturesTransactionMethod {
  ...
  public MultipleCurrencyMulticurveSensitivity presentValueCurveSensitivity(final FuturesTransaction<?> futures,
      final BlackSTIRFuturesProviderInterface multicurve) {
   ...
   */
  public PresentValueBlackSTIRFuturesCubeSensitivity presentValueBlackSensitivity(final FuturesTransaction<?> futures,
      final BlackSTIRFuturesProviderInterface multicurve) {
