...
/**
 * Method for the pricing of interest rate future options with up-front premium. The model is the Hull-White one factor model
 ...
 */
public final class InterestRateFutureOptionPremiumSecurityHullWhiteMethod
    extends InterestRateFutureOptionPremiumSecurityGenericMethod<HullWhiteOneFactorProviderInterface> {

  /**
   * The unique instance of the calculator.
   */
  private static final InterestRateFutureOptionPremiumSecurityHullWhiteMethod INSTANCE = new InterestRateFutureOptionPremiumSecurityHullWhiteMethod();

  /**
   * Constructor.
   */
  private InterestRateFutureOptionPremiumSecurityHullWhiteMethod() {
  }
   ...
   */
  public static InterestRateFutureOptionPremiumSecurityHullWhiteMethod getInstance() {
    return INSTANCE;
  }
   ...
   */
  @Override
  public double price(final InterestRateFutureOptionPremiumSecurity security, final HullWhiteOneFactorProviderInterface hwMulticurves) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(hwMulticurves, "Hull-White and multi-curves data");
    ArgumentChecker.isTrue(security.getCurrency().equals(hwMulticurves.getHullWhiteCurrency()),
