...
/**
 */
public abstract class FDCurveSensitivityCalculator2 {
   ...
   * @param times
   *          The times along the curve. <b>Note</b> These should be in ascending order and be known sensitivity points (or the result will
   *          be zero)
   * @param absTol
  ...
  // public static final List<DoublesPair> curveSensitvityFDCalculator(final InstrumentDerivative ird,
  // AbstractInstrumentDerivativeVisitor<YieldCurveBundle,
  // Double> calculator,
  // final YieldCurveBundle curves, final String curveName, final Double[] times, final double absTol) {
   ...
   * @return Sensitivities at a given points
   */
  public static final List<DoublesPair> curveSensitvityFDCalculator(final InstrumentDerivative ird, final PricingMethod method,
  ...
  private static double impFDCalculator(final InstrumentDerivative ird,
      final InstrumentDerivativeVisitorAdapter<YieldCurveBundle, Double> calculator,
      final YieldCurveBundle curves,
      final String curveName, final double t) {
  ...
  private static double impFDCalculator(final InstrumentDerivative ird, final PricingMethod method, final YieldCurveBundle curves,
      final String curveName,
      final double t) {
