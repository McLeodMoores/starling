...
/**
 * Enumerate the possible credit rating states for a reference entity (Fitch rating classifications). The ratings are long term.
 * <p>
 * This is an incomplete list of the long-term Fitch ratings classifications, but this enum is deprecated and will not be completed. Some of
 * the enum values have been remapped to their approximate equivalents (e.g. CC &amp;rarr CCC).
 *
...
public enum CreditRatingFitch {
   ...
   *          The rating description
   */
  CreditRatingFitch(final String rating, final String description) {
    _rating = rating;
  ...
  /**
   * Delegates to {@link com.opengamma.analytics.financial.legalentity.CreditRating}, with the agency name set to Fitch and the rating
