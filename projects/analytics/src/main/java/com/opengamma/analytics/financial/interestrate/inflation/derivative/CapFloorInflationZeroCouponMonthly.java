...
public class CapFloorInflationZeroCouponMonthly extends CouponInflation implements CapFloor {
   ...
   *          The index value at the start of the coupon dates for the standard product.
   ...
   *          The cap/floor flag.
   */
  public CapFloorInflationZeroCouponMonthly(final Currency currency, final double paymentTime, final double paymentYearFraction, final double notional,
   ...
   * @return The cap/floor.
   */
  public static CapFloorInflationZeroCouponMonthly from(final CouponInflationZeroCouponMonthly coupon, final double lastKnownFixingTime, final int maturity,
      final double strike, final boolean isCap) {
    return new CapFloorInflationZeroCouponMonthly(coupon.getCurrency(), coupon.getPaymentTime(), coupon.getPaymentYearFraction(), coupon.getNotional(),
  ...
  public Coupon withNotional(final double notional) {
    return new CapFloorInflationZeroCouponMonthly(getCurrency(), getPaymentTime(), getPaymentYearFraction(), notional, getPriceIndex(), _lastKnownFixingTime,
        _indexStartValue,
