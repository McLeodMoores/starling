...
public class ParameterSensitivityBlackSTIRFuturesDiscountInterpolatedFDCalculator {
   ...
   *          The shift used for finite difference.
   */
  public ParameterSensitivityBlackSTIRFuturesDiscountInterpolatedFDCalculator(
      final InstrumentDerivativeVisitor<BlackSTIRFuturesProviderInterface, MultipleCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final BlackSTIRFuturesSmileProviderDiscount black) {
    ...
    for (final Currency ccy : ccyDiscounting) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final BlackSTIRFuturesSmileProviderDiscount marketDscBumpedPlus = new BlackSTIRFuturesSmileProviderDiscount(
            black.getMulticurveProvider().withDiscountFactor(ccy, dscBumpedPlus),
        ...
        final BlackSTIRFuturesSmileProviderDiscount marketDscBumpedMinus = new BlackSTIRFuturesSmileProviderDiscount(
            black.getMulticurveProvider().withDiscountFactor(ccy, dscBumpedMinus),
            black.getBlackParameters(), black.getFuturesIndex());
    ...
    for (final IndexON index : indexON) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final YieldAndDiscountCurve dscBumpedPlus = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumpedPlus, curveInt.getInterpolator(), true));
        final BlackSTIRFuturesSmileProviderDiscount marketFwdBumpedPlus = new BlackSTIRFuturesSmileProviderDiscount(
            black.getMulticurveProvider().withForward(index, dscBumpedPlus),
            black.getBlackParameters(), black.getFuturesIndex());
        ...
        final YieldAndDiscountCurve dscBumpedMinus = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumpedMinus, curveInt.getInterpolator(), true));
        final BlackSTIRFuturesSmileProviderDiscount marketFwdBumpedMinus = new BlackSTIRFuturesSmileProviderDiscount(
            black.getMulticurveProvider().withForward(index, dscBumpedMinus),
            black.getBlackParameters(), black.getFuturesIndex());
