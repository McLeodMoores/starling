...
public abstract class InterestRateFutureSecurityMethod implements PricingMethod {
   ...
   */
  public abstract InterestRateCurveSensitivity priceCurveSensitivity(InterestRateFutureSecurity future, YieldCurveBundle curves);

  public abstract InterestRateCurveSensitivity presentValueCurveSensitivity(InterestRateFutureSecurity future, YieldCurveBundle curves);
   ...
   */
  public InterestRateCurveSensitivity presentValueCurveSensitivity(final InterestRateFutureSecurity future,
