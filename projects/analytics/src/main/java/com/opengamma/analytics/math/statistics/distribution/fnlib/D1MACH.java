...
public class D1MACH {
  ...
  /**
   * Smallest normalised number representable by a double according to IEEE. It's about 2.225E-308.
   * 
  ...
  /**
   * Largest normalised number representable by a double according to IEEE. It's about 1.7975E+308.
   * 
  ...
  /**
   * Machine precision/machine radix according to IEEE. Approximately 1.11E-16 === Math.pow(2,-53)/2 (assuming radix 2).
   * 
  ...
  /**
   * Machine precision according to IEEE. Approximately 2.22E-16 === Math.pow(2,-53).
   * 
