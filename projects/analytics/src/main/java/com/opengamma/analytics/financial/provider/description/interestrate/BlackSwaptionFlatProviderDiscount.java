...
public class BlackSwaptionFlatProviderDiscount extends BlackSwaptionFlatProvider {
  ...
  /**
   * Constructor from exiting multicurveProvider and Black swaption parameters. The given provider and parameters are used for the new provider (the same maps
   * are used, not copied).
   *
   * @param multicurves
   *          The multi-curves provider.
   * @param parameters
   *          The Black swaption parameters.
   */
