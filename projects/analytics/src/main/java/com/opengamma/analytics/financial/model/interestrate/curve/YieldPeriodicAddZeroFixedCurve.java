...
public class YieldPeriodicAddZeroFixedCurve extends YieldAndDiscountAddZeroFixedCurve {
   ...
   */
  public YieldPeriodicAddZeroFixedCurve(final String name,
                                        final boolean subtract,
                                        final YieldPeriodicCurve curve,
                                        final YieldCurve curveFixed) {
  ...
  public double getPeriodicInterestRate(final double t, final int compoundingPeriodsPerYear) {
    final double baseIR = _baseCurve.getYValue(t) + _sign * _fixedCurve.getYValue(t);
