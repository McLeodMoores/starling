...
public class CoxRossRubinsteinLatticeSpecification extends LatticeSpecification {
  ...
  /**
   * Parameters for two-dimensional extension of CRR trinomial model, here lambda = 1. is used This choice results in negative probabilities, but is numerically
   * stable
   *
   * @param volatility
   *          Volatility
