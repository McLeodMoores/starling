...
/**
 * Method for the pricing of interest rate future options with up-front premium. The pricing is done with a Normal approach on the future
 ...
 */
public final class InterestRateFutureOptionPremiumSecurityNormalSmileMethod
    extends InterestRateFutureOptionPremiumSecurityGenericMethod<NormalSTIRFuturesSmileProviderInterface> {

  /**
   * Creates the method unique instance.
   */
  private static final InterestRateFutureOptionPremiumSecurityNormalSmileMethod INSTANCE = new InterestRateFutureOptionPremiumSecurityNormalSmileMethod();

  /**
   * Constructor.
   */
  private InterestRateFutureOptionPremiumSecurityNormalSmileMethod() {
  }
   ...
   * @return The instance.
   */
  public static InterestRateFutureOptionPremiumSecurityNormalSmileMethod getInstance() {
    return INSTANCE;
  }
   ...
   */
  @Override
  public double price(final InterestRateFutureOptionPremiumSecurity security, final NormalSTIRFuturesSmileProviderInterface normalData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(normalData, "Normal data");
  ...
  public MulticurveSensitivity priceCurveSensitivity(final InterestRateFutureOptionPremiumSecurity security,
    ...
    final MulticurveSensitivity priceFutureDerivative = METHOD_FUTURE.priceCurveSensitivity(security.getUnderlyingFuture(),
        normalData.getMulticurveProvider());
   ...
   */
  public SurfaceValue priceNormalSensitivity(final InterestRateFutureOptionPremiumSecurity security,
      final NormalSTIRFuturesSmileProviderInterface normalData) {
    ArgumentChecker.notNull(security, "Option security");
    ArgumentChecker.notNull(normalData, "Normal data");
    // Forward sweep
