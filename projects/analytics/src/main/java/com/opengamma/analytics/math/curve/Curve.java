...
/**
 * Defines a general curve <i>(x, y)</i> class. The <i>x</i> and <i>y</i> data can be any type. The curves are named; if a name is not provided then a unique ID
 * will be used.
 *
 * @param <T>
 *          the type of the <i>x</i> data
 * @param <U>
 *          the type of the <i>y</i> data
 */
@BeanDefinition
public abstract class Curve<T extends Comparable<T>, U>
  ...
  static {
    MetaBean.register(Curve.Meta.INSTANCE);
  }
