...
public abstract class LocalVolatilitySurface<T extends StrikeType> extends VolatilitySurface {
  ...
  /**
   * Depending on the application the same local volatility surface can be seem either as either a function of calendar time and value of some abstraction of
   * the underlying, or as a function of expiry and some abstraction of strike.
   *
   * @param t
   *          time
   * @param s
   *          value of abstraction of strike
