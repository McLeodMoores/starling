...
public abstract class AbstractParameterSensitivityIssuerCalculator<DATA_TYPE extends ParameterIssuerProviderInterface> {
   ...
   *          The calculator.
   */
  public AbstractParameterSensitivityIssuerCalculator(
   ...
   */
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final DATA_TYPE multicurves,
   ...
   * @return The sensitivity (as a ParameterSensitivity).
   */
  public abstract MultipleCurrencyParameterSensitivity pointToParameterSensitivity(MultipleCurrencyMulticurveSensitivity sensitivity, DATA_TYPE multicurves,
