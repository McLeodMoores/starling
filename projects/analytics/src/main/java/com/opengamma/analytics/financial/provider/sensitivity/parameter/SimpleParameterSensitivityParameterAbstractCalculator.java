...
public abstract class SimpleParameterSensitivityParameterAbstractCalculator<DATA_TYPE extends ParameterProviderInterface> {
  ...
  /**
   * The sensitivity calculator to compute the sensitivity of the (double) value with respect to the zero-coupon continuously compounded rates at different
   * times (discounting) or forward rates.
   */
   ...
   */
  public SimpleParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final DATA_TYPE parameterMulticurves,
   ...
   * @return The sensitivity (as a ParameterSensitivity).
   */
  public abstract SimpleParameterSensitivity pointToParameterSensitivity(MulticurveSensitivity sensitivity, DATA_TYPE parameterMulticurves,
