...
public abstract class ParameterSensitivityHullWhiteMatrixAbstractCalculator {
   ...
   *          The calculator.
   */
  public ParameterSensitivityHullWhiteMatrixAbstractCalculator(
   ...
   * @param multicurves
   *          The multi-curve provider. Not null. The sensitivity with respect to the curves in the fixedCurves list will not be part of the output total
   ...
   */
  public DoubleMatrix1D calculateSensitivity(final InstrumentDerivative instrument, final HullWhiteOneFactorProviderInterface multicurves,
   ...
   * @return The sensitivity (as a DoubleMatrix1D).
   */
  public abstract DoubleMatrix1D pointToParameterSensitivity(MulticurveSensitivity sensitivity, HullWhiteOneFactorProviderInterface multicurves,
