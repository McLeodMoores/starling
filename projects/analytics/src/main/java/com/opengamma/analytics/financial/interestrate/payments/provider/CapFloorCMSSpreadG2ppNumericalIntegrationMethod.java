...
public final class CapFloorCMSSpreadG2ppNumericalIntegrationMethod {
  ...
  public MultipleCurrencyAmount presentValue(final CapFloorCMSSpread cmsSpread, final G2ppProviderInterface g2Data) {
    ...
    // Integration
    final SpreadIntegrant integrant = new SpreadIntegrant(discountedCashFlowFixed, alphaFixed, tau2Fixed, discountedCashFlowIbor, alphaIbor, tau2Ibor, alphaTp,
        tau2Tp, rhobar, strike,
        cmsSpread.isCap());
