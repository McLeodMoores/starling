...
/**
 * DERF(X) provides the ability to calculate the error function at position 'x'. It does this using Chebychev approximation mixed with calls to erfc() provided
 * by {@link DERF}. This code is an approximate translation of the equivalent function in the "Public Domain" code from SLATEC, see: See
 * http://www.netlib.org/slatec/fnlib/derf.f
 */
public class DERF {
   ...
   * 
   * @param x
   *          the position at which to evaluate the error function
