 ...
 */
@BeanDefinition
public class FixedIncomeDataProvider implements FxDataProvider, DiscountingCurveProvider, IndexCurveProvider, ImmutableBean {
  ...
  private FixedIncomeDataProvider(final Map<UniqueIdentifiable, YieldAndDiscountCurve> discountingCurves,
  ...
  @Override
  public FixedIncomeDataProvider copy() {
    return new FixedIncomeDataProvider(_discountingCurves, _indexCurves, _fxMatrix);
  }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FixedIncomeDataProvider}.
   * @return the meta-bean, not null
   */
  public static FixedIncomeDataProvider.Meta meta() {
    return FixedIncomeDataProvider.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(FixedIncomeDataProvider.Meta.INSTANCE);
  }
   ...
   */
  public static FixedIncomeDataProvider.Builder builder() {
    return new FixedIncomeDataProvider.Builder();
  }

  @Override
  public FixedIncomeDataProvider.Meta metaBean() {
    return FixedIncomeDataProvider.Meta.INSTANCE;
  }
  ...
  public String toString() {
    ...
    buf.append("FixedIncomeDataProvider{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Map<UniqueIdentifiable, YieldAndDiscountCurve>> _discountingCurves = DirectMetaProperty.ofImmutable(
        this, "discountingCurves", FixedIncomeDataProvider.class, (Class) Map.class);
    /**
    ...
    private final MetaProperty<Map<Index, YieldAndDiscountCurve>> _indexCurves = DirectMetaProperty.ofImmutable(
        this, "indexCurves", FixedIncomeDataProvider.class, (Class) Map.class);
    /**
    ...
    private final MetaProperty<FXMatrix> _fxMatrix = DirectMetaProperty.ofImmutable(
        this, "fxMatrix", FixedIncomeDataProvider.class, FXMatrix.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FixedIncomeDataProvider.Builder builder() {
      return new FixedIncomeDataProvider.Builder();
    }

    @Override
    public Class<? extends FixedIncomeDataProvider> beanType() {
      return FixedIncomeDataProvider.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1937730619:  // discountingCurves
          return ((FixedIncomeDataProvider) bean).getDiscountingCurves();
        case 886361302:  // indexCurves
          return ((FixedIncomeDataProvider) bean).getIndexCurves();
        case -1198118093:  // fxMatrix
          return ((FixedIncomeDataProvider) bean).getFxMatrix();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FixedIncomeDataProvider}.
   */
  public static class Builder extends DirectFieldsBeanBuilder<FixedIncomeDataProvider> {
     ...
     */
    protected Builder(FixedIncomeDataProvider beanToCopy) {
    ...
    @Override
    public FixedIncomeDataProvider build() {
      return new FixedIncomeDataProvider(
          _discountingCurves,
          _indexCurves,
          _fxMatrix);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("FixedIncomeDataProvider.Builder{");
      int len = buf.length();
      toString(buf);
      if (buf.length() > len) {
        buf.setLength(buf.length() - 2);
