...
/**
 * Represents a link to a Security object using an ExternalIdBundle that can be resolved on demand.
 *
 * @param <T>
...
public final class ResolvableSecurityLink<T extends Security> extends SecurityLink<T> implements ImmutableBean {
   ...
   * @param type
   *          the type of the linked object, not null
   * @param linkResolver
   *          the resolver used to resolve the link when requested, not null
   */
  ...
  static {
    MetaBean.register(ResolvableSecurityLink.Meta.INSTANCE);
  }
  ...
  public static <T extends Security> ResolvableSecurityLink.Builder<T> builder() {
    return new ResolvableSecurityLink.Builder<>();
  }
  ...
  public static final class Builder<T extends Security> extends DirectFieldsBeanBuilder<ResolvableSecurityLink<T>> {
    ...
    public ResolvableSecurityLink<T> build() {
      return new ResolvableSecurityLink<>(
          _linkIdentifier);
    }
