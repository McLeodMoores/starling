...
/**
 * Represents the identification data required for a link to an object. The link can then be resolved on demand.
 *
 * @param <I>
 *          the identifier for the linked object
 * @param <T>
 *          the type of the object being linked to
 */
@BeanDefinition
public final class LinkIdentifier<I, T> implements ImmutableBean {
   ...
   *          the type of the object being linked to
   * @param identifier
   *          the identifier of the object being linked to
   * @param type
   *          the type of the object being linked to
  ...
  static {
    MetaBean.register(LinkIdentifier.Meta.INSTANCE);
  }
  ...
  public static <I, T> LinkIdentifier.Builder<I, T> builder() {
    return new LinkIdentifier.Builder<>();
  }
