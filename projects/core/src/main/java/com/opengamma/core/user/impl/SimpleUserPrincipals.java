 ...
 * <p>
 * This class is mutable and not thread-safe. It is intended to primarily be used via the read-only {@code UserPrincipals} interface.
 */
@BeanDefinition
public class SimpleUserPrincipals implements Bean, UserPrincipals, Serializable {
  ...
  /**
   * The user name that uniquely identifies the user. This is the primary identifier of a user.
   */
   ...
   * <p>
   * This allows the user identifiers of external systems to be associated with the account Some of these may be unique within the external system, others may
   * be more descriptive.
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
   ...
   * <p>
   * Unfortunately it is not possible to guarantee the presence of accuracy of the IP address, notably as a result of web browser and network proxy
   * restrictions.
   */
   ...
   *
   * @param principalsToCopy
   *          the principals to copy, not null
  ...
  static {
    MetaBean.register(SimpleUserPrincipals.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the user name that uniquely identifies the user. This is the primary identifier of a user.
  ...
  /**
   * Sets the user name that uniquely identifies the user. This is the primary identifier of a user.
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends SimpleUserPrincipals> builder() {
      return new DirectBeanBuilder<>(new SimpleUserPrincipals());
    }
