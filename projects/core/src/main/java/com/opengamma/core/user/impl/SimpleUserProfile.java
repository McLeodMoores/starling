 ...
 * <p>
 * This class is mutable and not thread-safe. It is intended to primarily be used via the read-only {@code UserProfile} interface.
 */
@BeanDefinition
public class SimpleUserProfile implements Bean, UserProfile, Serializable {
  ...
  static {
    MetaBean.register(SimpleUserProfile.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends SimpleUserProfile> builder() {
      return new DirectBeanBuilder<>(new SimpleUserProfile());
    }
