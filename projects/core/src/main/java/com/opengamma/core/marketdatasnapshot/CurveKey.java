...
public final class CurveKey implements ImmutableBean, StructuredMarketDataKey, Comparable<CurveKey>, Serializable {
  ...
  /**
   * Delegates to {@link CurveKeyFudgeBuilder}.
   *
   * @param serializer
  ...
  public MutableFudgeMsg toFudgeMsg(final FudgeSerializer serializer) {
    return CurveKeyFudgeBuilder.INSTANCE.buildMessage(serializer, this);
  }
  ...
  public static CurveKey fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg) {
    return CurveKeyFudgeBuilder.INSTANCE.buildObject(deserializer, msg);
  }
  ...
  static {
    MetaBean.register(CurveKey.Meta.INSTANCE);
  }
