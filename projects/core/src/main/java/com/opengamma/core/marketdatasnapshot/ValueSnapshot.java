...
public final class ValueSnapshot implements Bean, Serializable {
   ...
   * @param overrideValue
   *          the override, null if no override
  ...
  // -------------------------------------------------------------------------
  /**
   * Delegates Fudge encoding to {@link ValueSnapshotFudgeBuilder}.
   *
   * @param serializer
   *          the Fudge serialization context, not null
   * @return a Fudge message
   * @deprecated use the builder directly
   */
  @Deprecated
  public MutableFudgeMsg toFudgeMsg(final FudgeSerializer serializer) {
    return ValueSnapshotFudgeBuilder.INSTANCE.buildMessage(serializer, this);
  }

  /**
   * Delegates Fudge message decoding to {@link ValueSnapshotFudgeBuilder}.
   *
   * @param deserializer
   *          the Fudge deserialization context, not null
   * @param msg
   *          message containing the value representation, not null
   * @return a snapshot object
   * @deprecated use the builder directly
   */
  @Deprecated
  public static ValueSnapshot fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg) {
    return ValueSnapshotFudgeBuilder.INSTANCE.buildObject(deserializer, msg);
  }
  ...
  static {
    MetaBean.register(ValueSnapshot.Meta.INSTANCE);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends ValueSnapshot> builder() {
      return new DirectBeanBuilder<>(new ValueSnapshot());
    }
