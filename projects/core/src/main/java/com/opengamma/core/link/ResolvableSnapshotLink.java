...
/**
 * Represents a link to a snapshot object using a name that can be resolved on demand.
 *
 * @param <S>
...
public class ResolvableSnapshotLink<S extends NamedSnapshot>
   ...
   * @param linkResolver
   *          the resolver used to resolve the link when requested
   */
  ...
  static {
    MetaBean.register(ResolvableSnapshotLink.Meta.INSTANCE);
  }
  ...
  public static <S extends NamedSnapshot> ResolvableSnapshotLink.Builder<S> builder() {
    return new ResolvableSnapshotLink.Builder<>();
  }
  ...
  public static class Builder<S extends NamedSnapshot> extends DirectFieldsBeanBuilder<ResolvableSnapshotLink<S>> {
    ...
    public ResolvableSnapshotLink<S> build() {
      return new ResolvableSnapshotLink<>(
          _identifier);
    }
