...
/**
 * Represents a link to a Snapshot object using an actual instance. When the resolve method is called, the embedded object is then returned.
 *
 * @param <S>
...
public final class ResolvedSnapshotLink<S extends NamedSnapshot>
   ...
   *
   * @param value
   *          the snapshot object to be embedded
   */
  ...
  static {
    MetaBean.register(ResolvedSnapshotLink.Meta.INSTANCE);
  }
  ...
  public static <S extends NamedSnapshot> ResolvedSnapshotLink.Builder<S> builder() {
    return new ResolvedSnapshotLink.Builder<>();
  }
  ...
  public static final class Builder<S extends NamedSnapshot> extends DirectFieldsBeanBuilder<ResolvedSnapshotLink<S>> {
    ...
    public ResolvedSnapshotLink<S> build() {
      return new ResolvedSnapshotLink<>(
          _value);
    }
