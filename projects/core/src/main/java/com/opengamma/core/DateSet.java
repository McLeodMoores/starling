...
public class DateSet implements ImmutableBean {
   ...
   *
   * @param date
   *          the date after which to look, not null
   ...
   *          the date after which to look, not null
   * @param n
   *          the 1-based index of the date to retrieve after the given date
   ...
   *
   * @param date
   *          the date before which to look, not null
  ...
  static {
    MetaBean.register(DateSet.Meta.INSTANCE);
  }
