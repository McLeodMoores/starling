...
/**
 * Represents a link to a Config object using an actual instance. When the resolve method is called, the embedded object is then returned.
 *
 * @param <C>
 *          type of the config
 */
...
public final class ResolvedConfigLink<C>
   ...
   *
   * @param value
   *          the config object to be embedded
   */
  ...
  static {
    MetaBean.register(ResolvedConfigLink.Meta.INSTANCE);
  }
  ...
  public static <C> ResolvedConfigLink.Builder<C> builder() {
    return new ResolvedConfigLink.Builder<>();
  }
