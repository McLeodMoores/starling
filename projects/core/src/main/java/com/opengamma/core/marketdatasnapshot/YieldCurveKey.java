...
public final class YieldCurveKey implements ImmutableBean, StructuredMarketDataKey, Comparable<YieldCurveKey>, Serializable {
  ...
  /**
   * Delegates to {@link YieldCurveKeyFudgeBuilder}.
   *
   * @param serializer
   *          a Fudge serialization context
   * @return a message
   * @deprecated use the builder directly
   */
  @Deprecated
  public MutableFudgeMsg toFudgeMsg(final FudgeSerializer serializer) {
    return YieldCurveKeyFudgeBuilder.INSTANCE.buildMessage(serializer, this);
  }
   ...
   *
   * @param deserializer
   *          a Fudge deserialization context
   * @param msg
   *          a message
   * @return the object
   * @deprecated use the builder directly
  ...
  public static YieldCurveKey fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg) {
    return YieldCurveKeyFudgeBuilder.INSTANCE.buildObject(deserializer, msg);
  }
  ...
  static {
    MetaBean.register(YieldCurveKey.Meta.INSTANCE);
  }
