...
/**
 * Represents a link to a Convention object using an ExternalIdBundle that can be resolved on demand.
 *
 * @param <T>
...
public class ResolvableConventionLink<T extends Convention> extends ConventionLink<T> implements ImmutableBean {
   ...
   *
   * @param identifier
   *          the identifier for the convention, not null
   * @param type
   *          the type of the convention, not null
   * @param linkResolver
   *          a link resolver, not null
   */
  ...
  static {
    MetaBean.register(ResolvableConventionLink.Meta.INSTANCE);
  }
  ...
  public static <T extends Convention> ResolvableConventionLink.Builder<T> builder() {
    return new ResolvableConventionLink.Builder<>();
  }
  ...
  public static class Builder<T extends Convention> extends DirectFieldsBeanBuilder<ResolvableConventionLink<T>> {
    ...
    public ResolvableConventionLink<T> build() {
      return new ResolvableConventionLink<>(
          _identifier);
    }
