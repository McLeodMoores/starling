...
public interface PortfolioNodeTraversalCallback {
  ...
  /**
   * Event called before a position is traversed. Note that the same position may appear under multiple parent nodes
   * depending on the aggregation method used to structure the portfolio. This method
  ...
  /**
   * Event called after a position is traversed. Note that the same position may appear under multiple parent nodes
   * depending on the aggregation method used to structure the portfolio. This method
   * will be called for each such occurrence with the appropriate parent portfolio node for each.
   *
   * @param parentNode the position's parent node at this point in the traversal, not null
