...
public abstract class SnapshotLink<S extends NamedSnapshot> implements Link<S> {
   ...
   */
  public static <N extends NamedSnapshot> SnapshotLink<N> resolvable(final String name, final Class<N> type) {
   ...
   * @return a snapshot link, not null
   */
  public static <N extends NamedSnapshot> SnapshotLink<N> resolvable(final String name, final Class<N> type, final ServiceContext serviceContext) {
   ...
   */
  public static <N extends NamedSnapshot> SnapshotLink<N> resolved(final N snapshot) {
