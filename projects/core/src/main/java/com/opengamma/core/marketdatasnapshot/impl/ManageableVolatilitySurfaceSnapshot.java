...
public class ManageableVolatilitySurfaceSnapshot implements Bean, VolatilitySurfaceSnapshot {
   ...
   *
   * @param serializer
   *          Fudge serialization context, not null
  ...
  /**
   * Creates a snapshot object from a Fudge message representation. See {@link #toFudgeMsg} for the message format.
   *
   * @param deserializer
   *          the Fudge deserialization context, not null
   * @param msg
   *          message containing the snapshot representation, not null
  ...
  static {
    MetaBean.register(ManageableVolatilitySurfaceSnapshot.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends ManageableVolatilitySurfaceSnapshot> builder() {
      return new DirectBeanBuilder<>(new ManageableVolatilitySurfaceSnapshot());
    }
