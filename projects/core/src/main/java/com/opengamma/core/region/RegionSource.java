 ...
 * <p>
 * This interface provides a simple view of regions as used by most parts of the application. This may be backed by a
 * full-featured region master, or by a much simpler data structure.
 * <p>
...
public interface RegionSource extends SourceWithExternalBundle<Region> {
  ...
  /**
   * Get the region with at least one identifier from the bundle that is highest up the region hierarchy, for example US
   * will return USA rather than a dependency. US + a more specific identifier for a sub-region will also return US.
   *
