...
public class AttachToViewProcessRequest extends DirectBean {
  ...
  /**
   * Indicates whether the request should generate a new batch process, or whether an existing shared process may be re-used.
   */
  @PropertyDefinition
  ...
  static {
    MetaBean.register(AttachToViewProcessRequest.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets indicates whether the request should generate a new batch process, or whether an existing shared process may be re-used.
   * @return the value of the property
   */
  ...
  /**
   * Sets indicates whether the request should generate a new batch process, or whether an existing shared process may be re-used.
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends AttachToViewProcessRequest> builder() {
      return new DirectBeanBuilder<>(new AttachToViewProcessRequest());
    }
