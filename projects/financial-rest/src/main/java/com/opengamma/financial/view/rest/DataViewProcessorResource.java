...
public class DataViewProcessorResource extends AbstractDataResource {
   ...
   * The cycle manager.
   */
  private final AtomicReference<DataViewCycleManagerResource> _cycleManagerResource = new AtomicReference<>();
  /**
   * The view clients.
   */
  private final ConcurrentMap<UniqueId, DataViewClientResource> _createdViewClients = new ConcurrentHashMap<>();
  /**
   * The hts source
   */
   ...
   *          the volatility cube, not null
   * @param jmsConnector
   *          the JMS connector, may be null
   * @param fudgeContext
  ...
  public DataViewClientResource getViewClient(@Context final UriInfo uriInfo,
    ...
    final URI viewProcessorUri = DataViewProcessorUris.getViewProcessorUri(uriInfo);
  ...
  public Response createViewClient(@Context final UriInfo uriInfo, final UserPrincipal user) {
    ...
    final URI createdUri = DataViewProcessorUris.uriClient(uriInfo.getRequestUri(), client.getUniqueId());
  ...
  public DataViewCycleManagerResource getViewCycleManager(@Context final UriInfo uriInfo) {
    return getOrCreateDataViewCycleManagerResource(DataViewProcessorUris.getViewProcessorUri(uriInfo));
  }
