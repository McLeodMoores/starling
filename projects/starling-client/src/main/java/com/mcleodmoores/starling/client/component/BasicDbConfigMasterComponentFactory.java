 ...
 */
@BeanDefinition
public class BasicDbConfigMasterComponentFactory extends AbstractComponentFactory {
  private static final String SCHEMA_NAME = "cfg";
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) {
    ...
    DbConfigMaster dbMaster = new DbConfigMaster(getDbConnector());
    ...
    ConfigMaster master = dbMaster;
    if (isTrackingMode()) {
      master  = new DataTrackingConfigMaster(dbMaster);
    }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code BasicDbConfigMasterComponentFactory}.
   * @return the meta-bean, not null
   */
  public static BasicDbConfigMasterComponentFactory.Meta meta() {
    return BasicDbConfigMasterComponentFactory.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(BasicDbConfigMasterComponentFactory.Meta.INSTANCE);
  }

  @Override
  public BasicDbConfigMasterComponentFactory.Meta metaBean() {
    return BasicDbConfigMasterComponentFactory.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  @Override
  public BasicDbConfigMasterComponentFactory clone() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      BasicDbConfigMasterComponentFactory other = (BasicDbConfigMasterComponentFactory) obj;
  ...
  public String toString() {
    ...
    buf.append("BasicDbConfigMasterComponentFactory{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<String> _classifier = DirectMetaProperty.ofReadWrite(
        this, "classifier", BasicDbConfigMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<DbConnector> _dbConnector = DirectMetaProperty.ofReadWrite(
        this, "dbConnector", BasicDbConfigMasterComponentFactory.class, DbConnector.class);
    /**
    ...
    private final MetaProperty<Boolean> _enforceSchemaVersion = DirectMetaProperty.ofReadWrite(
        this, "enforceSchemaVersion", BasicDbConfigMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<Boolean> _autoSchemaManagement = DirectMetaProperty.ofReadWrite(
        this, "autoSchemaManagement", BasicDbConfigMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", BasicDbConfigMasterComponentFactory.class, Integer.class);
    /**
    ...
    private final MetaProperty<Boolean> _trackingMode = DirectMetaProperty.ofReadWrite(
        this, "trackingMode", BasicDbConfigMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", BasicDbConfigMasterComponentFactory.class, String.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends BasicDbConfigMasterComponentFactory> builder() {
      return new DirectBeanBuilder<BasicDbConfigMasterComponentFactory>(new BasicDbConfigMasterComponentFactory());
    }

    @Override
    public Class<? extends BasicDbConfigMasterComponentFactory> beanType() {
      return BasicDbConfigMasterComponentFactory.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((BasicDbConfigMasterComponentFactory) bean).getClassifier();
        case 39794031:  // dbConnector
          return ((BasicDbConfigMasterComponentFactory) bean).getDbConnector();
        case 2128193333:  // enforceSchemaVersion
          return ((BasicDbConfigMasterComponentFactory) bean).isEnforceSchemaVersion();
        case 1236703379:  // autoSchemaManagement
          return ((BasicDbConfigMasterComponentFactory) bean).isAutoSchemaManagement();
        case -2022653118:  // maxRetries
          return ((BasicDbConfigMasterComponentFactory) bean).getMaxRetries();
        case -1884120838:  // trackingMode
          return ((BasicDbConfigMasterComponentFactory) bean).isTrackingMode();
        case -1737146991:  // uniqueIdScheme
          return ((BasicDbConfigMasterComponentFactory) bean).getUniqueIdScheme();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((BasicDbConfigMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case 39794031:  // dbConnector
          ((BasicDbConfigMasterComponentFactory) bean).setDbConnector((DbConnector) newValue);
          return;
        case 2128193333:  // enforceSchemaVersion
          ((BasicDbConfigMasterComponentFactory) bean).setEnforceSchemaVersion((Boolean) newValue);
          return;
        case 1236703379:  // autoSchemaManagement
          ((BasicDbConfigMasterComponentFactory) bean).setAutoSchemaManagement((Boolean) newValue);
          return;
        case -2022653118:  // maxRetries
          ((BasicDbConfigMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
        case -1884120838:  // trackingMode
          ((BasicDbConfigMasterComponentFactory) bean).setTrackingMode((Boolean) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((BasicDbConfigMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((BasicDbConfigMasterComponentFactory) bean)._classifier, "classifier");
      JodaBeanUtils.notNull(((BasicDbConfigMasterComponentFactory) bean)._dbConnector, "dbConnector");
      super.validate(bean);
    }
