 ...
 */
@BeanDefinition
public class BasicDbConventionMasterComponentFactory extends AbstractComponentFactory {
  private static final String SCHEMA_NAME = "cnv";
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) {
    ...
    DbConventionBeanMaster dbMaster = new DbConventionBeanMaster(getDbConnector());
    ...
    ConventionMaster master = dbMaster;
    if (isTrackingMode()) {
      master = new DataTrackingConventionMaster(dbMaster);
    }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code BasicDbConventionMasterComponentFactory}.
   * @return the meta-bean, not null
   */
  public static BasicDbConventionMasterComponentFactory.Meta meta() {
    return BasicDbConventionMasterComponentFactory.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(BasicDbConventionMasterComponentFactory.Meta.INSTANCE);
  }

  @Override
  public BasicDbConventionMasterComponentFactory.Meta metaBean() {
    return BasicDbConventionMasterComponentFactory.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  @Override
  public BasicDbConventionMasterComponentFactory clone() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      BasicDbConventionMasterComponentFactory other = (BasicDbConventionMasterComponentFactory) obj;
  ...
  public String toString() {
    ...
    buf.append("BasicDbConventionMasterComponentFactory{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<String> _classifier = DirectMetaProperty.ofReadWrite(
        this, "classifier", BasicDbConventionMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<DbConnector> _dbConnector = DirectMetaProperty.ofReadWrite(
        this, "dbConnector", BasicDbConventionMasterComponentFactory.class, DbConnector.class);
    /**
    ...
    private final MetaProperty<Boolean> _enforceSchemaVersion = DirectMetaProperty.ofReadWrite(
        this, "enforceSchemaVersion", BasicDbConventionMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<Boolean> _autoSchemaManagement = DirectMetaProperty.ofReadWrite(
        this, "autoSchemaManagement", BasicDbConventionMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", BasicDbConventionMasterComponentFactory.class, Integer.class);
    /**
    ...
    private final MetaProperty<Boolean> _trackingMode = DirectMetaProperty.ofReadWrite(
        this, "trackingMode", BasicDbConventionMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", BasicDbConventionMasterComponentFactory.class, String.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends BasicDbConventionMasterComponentFactory> builder() {
      return new DirectBeanBuilder<BasicDbConventionMasterComponentFactory>(new BasicDbConventionMasterComponentFactory());
    }

    @Override
    public Class<? extends BasicDbConventionMasterComponentFactory> beanType() {
      return BasicDbConventionMasterComponentFactory.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((BasicDbConventionMasterComponentFactory) bean).getClassifier();
        case 39794031:  // dbConnector
          return ((BasicDbConventionMasterComponentFactory) bean).getDbConnector();
        case 2128193333:  // enforceSchemaVersion
          return ((BasicDbConventionMasterComponentFactory) bean).isEnforceSchemaVersion();
        case 1236703379:  // autoSchemaManagement
          return ((BasicDbConventionMasterComponentFactory) bean).isAutoSchemaManagement();
        case -2022653118:  // maxRetries
          return ((BasicDbConventionMasterComponentFactory) bean).getMaxRetries();
        case -1884120838:  // trackingMode
          return ((BasicDbConventionMasterComponentFactory) bean).isTrackingMode();
        case -1737146991:  // uniqueIdScheme
          return ((BasicDbConventionMasterComponentFactory) bean).getUniqueIdScheme();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((BasicDbConventionMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case 39794031:  // dbConnector
          ((BasicDbConventionMasterComponentFactory) bean).setDbConnector((DbConnector) newValue);
          return;
        case 2128193333:  // enforceSchemaVersion
          ((BasicDbConventionMasterComponentFactory) bean).setEnforceSchemaVersion((Boolean) newValue);
          return;
        case 1236703379:  // autoSchemaManagement
          ((BasicDbConventionMasterComponentFactory) bean).setAutoSchemaManagement((Boolean) newValue);
          return;
        case -2022653118:  // maxRetries
          ((BasicDbConventionMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
        case -1884120838:  // trackingMode
          ((BasicDbConventionMasterComponentFactory) bean).setTrackingMode((Boolean) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((BasicDbConventionMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((BasicDbConventionMasterComponentFactory) bean)._classifier, "classifier");
      JodaBeanUtils.notNull(((BasicDbConventionMasterComponentFactory) bean)._dbConnector, "dbConnector");
      super.validate(bean);
    }
