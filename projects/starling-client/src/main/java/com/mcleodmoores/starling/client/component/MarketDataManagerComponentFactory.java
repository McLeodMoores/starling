...
public class MarketDataManagerComponentFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) {
    ComponentInfo info = new ComponentInfo(MarketDataManager.class, getClassifier());
    info.addAttribute(ComponentInfoAttributes.LEVEL, 1);
    MarketDataManager marketDataManager =
        new MarketDataManager(getHistoricalTimeSeriesMaster(), getHistoricalTimeSeriesSource(),
            getSecuritySource(), getHistoricalTimeSeriesResolver(), getConfigSource(), getViewProcessor());
