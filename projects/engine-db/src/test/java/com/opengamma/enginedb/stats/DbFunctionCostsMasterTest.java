...
public class DbFunctionCostsMasterTest extends AbstractDbTest {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(DbFunctionCostsMasterTest.class);
  ...
  public void testMaster() throws Exception {
    ...
    final FunctionCostsDocument doc2 = new FunctionCostsDocument();
    ...
    // store1
    final FunctionCostsDocument stored1 = _costsMaster.store(doc1);
    ...
    final FunctionCostsDocument loaded1 = _costsMaster.load("Conf1", "Func1", null);
    ...
    // store2
    final FunctionCostsDocument stored2 = _costsMaster.store(doc2);
    ...
    final FunctionCostsDocument loaded2 = _costsMaster.load("Conf2", "Func2", null);
    ...
    final FunctionCostsDocument loaded1b = _costsMaster.load("Conf1", "Func1", null);
  ...
  public void testHistory() throws Exception {
    ...
    // load latest
    final FunctionCostsDocument loadedLatest = _costsMaster.load("Conf", "Func", null);
    ...
    // load historic
    final FunctionCostsDocument loadedHistoric = _costsMaster.load("Conf", "Func", stored1.getVersion());
    ...
    final FunctionCostsDocument loadedHistoric2 = _costsMaster.load("Conf", "Func", stored1.getVersion().plusMillis(1));
