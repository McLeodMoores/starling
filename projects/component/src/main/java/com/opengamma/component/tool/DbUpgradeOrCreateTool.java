...
public class DbUpgradeOrCreateTool extends AbstractDbTool<DbToolContext> {
  ...
  protected void doRun(final boolean write, final File outputFile) throws Exception {
    final DbUpgradeOrCreateOperation upgradeOp = new DbUpgradeOrCreateOperation(getDbToolContext(), write, outputFile);
    upgradeOp.execute();
  ...
  public static void main(final String[] args) { //CSIGNORE
    final boolean success = new DbUpgradeOrCreateTool().initAndRun(args, DbToolContext.class);
