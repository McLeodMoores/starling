...
public class RemoteNamedMarketDataSpecificationRepositoryComponentFactory extends AbstractRemoteComponentServerComponentFactory {
  ...
  protected void initComponent(final ComponentRepository repo, final ComponentInfo info) {
    if (NamedMarketDataSpecificationRepository.class.isAssignableFrom(info.getType())) {
      final NamedMarketDataSpecificationRepository repository = new RemoteNamedMarketDataSpecificationRepository(info.getUri());
  ...
  static {
    MetaBean.register(RemoteNamedMarketDataSpecificationRepositoryComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractRemoteComponentServerComponentFactory.Meta {
    ...
    public BeanBuilder<? extends RemoteNamedMarketDataSpecificationRepositoryComponentFactory> builder() {
      return new DirectBeanBuilder<>(new RemoteNamedMarketDataSpecificationRepositoryComponentFactory());
    }
