...
public class RemoteMastersComponentFactory extends AbstractComponentFactory {
  ...
  protected void initComponent(final ComponentRepository repo, final ComponentInfo info) {
    ...
    if (info.getAttributes().containsKey(ComponentInfoAttributes.REMOTE_CLIENT_JAVA)
      ...
      final String jmsBrokerUri = info.getAttributes().get(ComponentInfoAttributes.JMS_BROKER_URI);
  ...
  static {
    MetaBean.register(RemoteMastersComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends RemoteMastersComponentFactory> builder() {
      return new DirectBeanBuilder<>(new RemoteMastersComponentFactory());
    }
