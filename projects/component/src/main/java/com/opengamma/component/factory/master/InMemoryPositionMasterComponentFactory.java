...
public class InMemoryPositionMasterComponentFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) {
    final InMemoryPositionMaster master;
    if (_idScheme == null) {
      master = new InMemoryPositionMaster();
    } else {
      master = new InMemoryPositionMaster(new ObjectIdSupplier(_idScheme));
    }
  ...
  static {
    MetaBean.register(InMemoryPositionMasterComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<String> _idScheme = DirectMetaProperty.ofReadWrite(
        this, "idScheme", InMemoryPositionMasterComponentFactory.class, String.class);
    /**
    ...
    public BeanBuilder<? extends InMemoryPositionMasterComponentFactory> builder() {
      return new DirectBeanBuilder<>(new InMemoryPositionMasterComponentFactory());
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -661606752:  // idScheme
          return ((InMemoryPositionMasterComponentFactory) bean).getIdScheme();
        case 199795673:  // cloneResults
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -614707837:  // publishRest
          ...
          return;
        case -661606752:  // idScheme
          ((InMemoryPositionMasterComponentFactory) bean).setIdScheme((String) newValue);
          return;
        case 199795673:  // cloneResults
