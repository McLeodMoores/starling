...
public class DbUpgradeTool extends AbstractDbTool<DbToolContext> {
  ...
  protected void doRun(final boolean write, final File outputFile) throws Exception {
    final DbUpgradeOperation upgradeOp = new DbUpgradeOperation(getDbToolContext(), write, outputFile);
    upgradeOp.execute();
  ...
  public static void main(final String[] args) { //CSIGNORE
    final boolean success = new DbUpgradeTool().initAndRun(args, DbToolContext.class);
