...
public class AlwaysAvailableHistoricalTimeSeriesSourceComponentFactory extends AbstractComponentFactory {
  ...
  static {
    JodaBeanUtils.registerMetaBean(AlwaysAvailableHistoricalTimeSeriesSourceComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends AlwaysAvailableHistoricalTimeSeriesSourceComponentFactory> builder() {
      return new DirectBeanBuilder<AlwaysAvailableHistoricalTimeSeriesSourceComponentFactory>(new AlwaysAvailableHistoricalTimeSeriesSourceComponentFactory());
    }
