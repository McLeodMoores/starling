...
public class HistoricalTimeSeriesSourceComponentFactory extends AbstractComponentFactory {
  ...
  protected HistoricalTimeSeriesResolver createCachedResolver(final HistoricalTimeSeriesResolver resolver) {
  ...
  static {
    MetaBean.register(HistoricalTimeSeriesSourceComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends HistoricalTimeSeriesSourceComponentFactory> builder() {
      return new DirectBeanBuilder<>(new HistoricalTimeSeriesSourceComponentFactory());
    }
