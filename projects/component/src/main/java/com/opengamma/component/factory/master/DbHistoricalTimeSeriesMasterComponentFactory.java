...
extends AbstractDocumentDbMasterComponentFactory<HistoricalTimeSeriesMaster, DbHistoricalTimeSeriesMaster> {
  ...
  static {
    MetaBean.register(DbHistoricalTimeSeriesMasterComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractDocumentDbMasterComponentFactory.Meta<HistoricalTimeSeriesMaster, DbHistoricalTimeSeriesMaster> {
    ...
    public BeanBuilder<? extends DbHistoricalTimeSeriesMasterComponentFactory> builder() {
      return new DirectBeanBuilder<>(new DbHistoricalTimeSeriesMasterComponentFactory());
    }
