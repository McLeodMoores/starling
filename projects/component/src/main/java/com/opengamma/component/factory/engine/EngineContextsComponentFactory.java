...
public class EngineContextsComponentFactory extends AbstractComponentFactory {
  ...
  static {
    MetaBean.register(EngineContextsComponentFactory.Meta.INSTANCE);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the volatility cube source.
   * @return the value of the property
   */
  ...
  /**
   * Sets the volatility cube source.
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends EngineContextsComponentFactory> builder() {
      return new DirectBeanBuilder<>(new EngineContextsComponentFactory());
    }
