...
extends AbstractDbMasterComponentFactory<I, M> {
  ...
  public AbstractDocumentDbMasterComponentFactory(final String schemaName, final Class<I> masterInterface) {
    super(schemaName, masterInterface);
  }

  @Override
  protected M createMaster(final ComponentRepository repo, final ComponentInfo info) throws Exception {
    final M master = createDbDocumentMaster();
  ...
  static {
    MetaBean.register(AbstractDocumentDbMasterComponentFactory.Meta.INSTANCE);
  }
