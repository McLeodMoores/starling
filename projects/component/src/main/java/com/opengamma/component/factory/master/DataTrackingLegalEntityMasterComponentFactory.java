...
public class DataTrackingLegalEntityMasterComponentFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) throws Exception {
    ...
    final ComponentInfo componentInfo = new ComponentInfo(LegalEntityMaster.class, _classifier);

    final DataTrackingLegalEntityMaster dataTrackingLegalEntityMaster = new DataTrackingLegalEntityMaster(_trackedMaster);
  ...
  static {
    MetaBean.register(DataTrackingLegalEntityMasterComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends DataTrackingLegalEntityMasterComponentFactory> builder() {
      return new DirectBeanBuilder<>(new DataTrackingLegalEntityMasterComponentFactory());
    }
