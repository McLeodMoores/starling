...
public class SharedUserComponentFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) throws Exception {
    final UserPrincipal sharedUser = UserPrincipal.getLocalUser(getUserName());
    final ComponentInfo info = new ComponentInfo(UserPrincipal.class, "shared");
  ...
  static {
    MetaBean.register(SharedUserComponentFactory.Meta.INSTANCE);
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends SharedUserComponentFactory> builder() {
      return new DirectBeanBuilder<>(new SharedUserComponentFactory());
    }
