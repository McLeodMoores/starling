 ...
 * <p>
 * Some servers are able to respond with details of subscriptions which it is not currently publishing information on - a well written client can use
 * this information to either free local resources if they are not really needed, or reestablish them if they are.
 */
