...
/**
 * A live data server for connection responses.
 */
@BeanDefinition
public class ConnectionResponseMessage extends DirectBean {
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private List<String> _availableServers = new LinkedList<>();
  /**
  ...
  /**
   * Adds capabilities to the response.
   *
  ...
  static {
    MetaBean.register(ConnectionResponseMessage.Meta.INSTANCE);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    public BeanBuilder<? extends ConnectionResponseMessage> builder() {
      return new DirectBeanBuilder<>(new ConnectionResponseMessage());
    }
