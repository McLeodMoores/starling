...
public class ResolveResponse implements java.io.Serializable {
  ...
  public ResolveResponse (final com.opengamma.livedata.LiveDataSpecification resolvedSpecification) {
    if (resolvedSpecification == null) {
      throw new NullPointerException ("'resolvedSpecification' cannot be null");
    } else {
  ...
  protected ResolveResponse (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a ResolveResponse - field 'resolvedSpecification' is not present");
    }
    try {
  ...
  protected ResolveResponse (final ResolveResponse source) {
    ...
    if (source._resolvedSpecification == null) {
      _resolvedSpecification = null;
    } else {
  ...
  public static ResolveResponse fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.livedata.msg.ResolveResponse".equals (className)) {
        break;
      }
      try {
  ...
  public void setResolvedSpecification (final com.opengamma.livedata.LiveDataSpecification resolvedSpecification) {
    if (resolvedSpecification == null) {
      throw new NullPointerException ("'resolvedSpecification' cannot be null");
    } else {
      _resolvedSpecification = resolvedSpecification;
