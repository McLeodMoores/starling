...
public class EntitlementResponseMsg implements java.io.Serializable {
  ...
  public EntitlementResponseMsg (final java.util.Collection<? extends com.opengamma.livedata.msg.EntitlementResponse> responses) {
    if (responses == null) {
      throw new NullPointerException ("'responses' cannot be null");
    } else {
      final java.util.List<com.opengamma.livedata.msg.EntitlementResponse> fudge0 = new java.util.ArrayList<> (responses);
      if (responses.size () == 0) {
        throw new IllegalArgumentException ("'responses' cannot be an empty list");
      }
      for (final java.util.ListIterator<com.opengamma.livedata.msg.EntitlementResponse> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.livedata.msg.EntitlementResponse fudge2 = fudge1.next ();
        if (fudge2 == null) {
  ...
  protected EntitlementResponseMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a EntitlementResponseMsg - field 'responses' is not present");
    }
  ...
  protected EntitlementResponseMsg (final EntitlementResponseMsg source) {
    ...
    if (source._responses == null) {
      ...
      final java.util.List<com.opengamma.livedata.msg.EntitlementResponse> fudge0 = new java.util.ArrayList<> (source._responses);
      for (final java.util.ListIterator<com.opengamma.livedata.msg.EntitlementResponse> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.livedata.msg.EntitlementResponse fudge2 = fudge1.next ();
        fudge1.set (fudge2.clone ());
      }
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    if (_responses != null)  {
      for (final com.opengamma.livedata.msg.EntitlementResponse fudge1 : _responses) {
  ...
  public static EntitlementResponseMsg fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.livedata.msg.EntitlementResponseMsg".equals (className)) {
        break;
      }
      try {
  ...
  public void setResponses (final com.opengamma.livedata.msg.EntitlementResponse responses) {
    if (responses == null) {
      throw new NullPointerException ("'responses' cannot be null");
    } else {
  ...
  public void setResponses (final java.util.Collection<? extends com.opengamma.livedata.msg.EntitlementResponse> responses) {
    if (responses == null) {
      throw new NullPointerException ("'responses' cannot be null");
    } else {
      final java.util.List<com.opengamma.livedata.msg.EntitlementResponse> fudge0 = new java.util.ArrayList<> (responses);
  ...
  public void addResponses (final com.opengamma.livedata.msg.EntitlementResponse responses) {
    if (responses == null) {
      throw new NullPointerException ("'responses' cannot be null");
    }
    if (_responses == null) {
