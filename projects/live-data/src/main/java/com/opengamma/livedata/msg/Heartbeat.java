...
public class Heartbeat implements java.io.Serializable {
  ...
  public Heartbeat (final java.util.Collection<? extends com.opengamma.livedata.LiveDataSpecification> liveDataSpecifications) {
  ...
  protected Heartbeat (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a Heartbeat - field 'liveDataSpecifications' is not present");
    }
  ...
  public static Heartbeat fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.livedata.msg.Heartbeat".equals(className)) {
        break;
      }
      try {
