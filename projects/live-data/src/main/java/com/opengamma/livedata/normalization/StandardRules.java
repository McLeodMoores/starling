...
public class StandardRules {
   ...
   * <p>
   * Market data messages normalized with the standard OpenGamma scheme will
   * include:
   * <ul>
   * <li>{@link com.opengamma.core.value.MarketDataRequirementNames#MARKET_VALUE}
   * <li>{@link com.opengamma.core.value.MarketDataRequirementNames#VOLUME} (if
   * available)
   * <li>{@link com.opengamma.core.value.MarketDataRequirementNames#IMPLIED_VOLATILITY}
   * (if available)
   * <li>{@link com.opengamma.core.value.MarketDataRequirementNames#YIELD_CONVENTION_MID}
   * (if available)
   * <li>{@link com.opengamma.core.value.MarketDataRequirementNames#YIELD_YIELD_TO_MATURITY_MID}
   * (if available)
   * <li>{@link com.opengamma.core.value.MarketDataRequirementNames#DIRTY_PRICE_MID}
   * (if available)
   * </ul>
   *
