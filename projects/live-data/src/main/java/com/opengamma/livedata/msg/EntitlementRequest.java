...
public class EntitlementRequest implements java.io.Serializable {
  ...
  public EntitlementRequest (final com.opengamma.livedata.UserPrincipal user, final java.util.Collection<? extends com.opengamma.livedata.LiveDataSpecification> liveDataSpecifications) {
    if (user == null) {
      throw new NullPointerException ("'user' cannot be null");
    } else {
      _user = user;
    }
    if (liveDataSpecifications == null) {
      throw new NullPointerException ("'liveDataSpecifications' cannot be null");
    } else {
      final java.util.List<com.opengamma.livedata.LiveDataSpecification> fudge0 = new java.util.ArrayList<> (liveDataSpecifications);
      if (liveDataSpecifications.size () == 0) {
        throw new IllegalArgumentException ("'liveDataSpecifications' cannot be an empty list");
      }
      for (final java.util.ListIterator<com.opengamma.livedata.LiveDataSpecification> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        ...
        if (fudge2 == null) {
          throw new NullPointerException ("List element of 'liveDataSpecifications' cannot be null");
        }
        fudge1.set (fudge2);
      }
  ...
  protected EntitlementRequest (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a EntitlementRequest - field 'user' is not present");
    }
    try {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a EntitlementRequest - field 'liveDataSpecifications' is not present");
    }
    _liveDataSpecifications = new java.util.ArrayList<> (fudgeFields.size ());
  ...
  protected EntitlementRequest (final EntitlementRequest source) {
    ...
    if (source._liveDataSpecifications == null) {
      _liveDataSpecifications = null;
    } else {
      final java.util.List<com.opengamma.livedata.LiveDataSpecification> fudge0 = new java.util.ArrayList<> (source._liveDataSpecifications);
      for (final java.util.ListIterator<com.opengamma.livedata.LiveDataSpecification> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.livedata.LiveDataSpecification fudge2 = fudge1.next ();
        fudge1.set (fudge2);
      }
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    ...
    if (_liveDataSpecifications != null)  {
      for (final com.opengamma.livedata.LiveDataSpecification fudge1 : _liveDataSpecifications) {
  ...
  public void setLiveDataSpecifications (final com.opengamma.livedata.LiveDataSpecification liveDataSpecifications) {
    if (liveDataSpecifications == null) {
      throw new NullPointerException ("'liveDataSpecifications' cannot be null");
    } else {
      _liveDataSpecifications = new java.util.ArrayList<> (1);
      addLiveDataSpecifications (liveDataSpecifications);
    }
  }
  public void setLiveDataSpecifications (final java.util.Collection<? extends com.opengamma.livedata.LiveDataSpecification> liveDataSpecifications) {
    if (liveDataSpecifications == null) {
      throw new NullPointerException ("'liveDataSpecifications' cannot be null");
    } else {
      final java.util.List<com.opengamma.livedata.LiveDataSpecification> fudge0 = new java.util.ArrayList<> (liveDataSpecifications);
  ...
  public void addLiveDataSpecifications (final com.opengamma.livedata.LiveDataSpecification liveDataSpecifications) {
    if (liveDataSpecifications == null) {
      throw new NullPointerException ("'liveDataSpecifications' cannot be null");
    }
    if (_liveDataSpecifications == null) {
      _liveDataSpecifications = new java.util.ArrayList<> ();
    }
