...
public class EntitlementResponse implements java.io.Serializable {
  ...
  public EntitlementResponse (final com.opengamma.livedata.LiveDataSpecification liveDataSpecification, final boolean isEntitled) {
  ...
  protected EntitlementResponse (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a EntitlementResponse - field 'liveDataSpecification' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a EntitlementResponse - field 'isEntitled' is not present");
    }
    try {
  ...
  public EntitlementResponse (final com.opengamma.livedata.LiveDataSpecification liveDataSpecification, final boolean isEntitled, final String msg) {
    if (liveDataSpecification == null) {
      throw new NullPointerException ("'liveDataSpecification' cannot be null");
    } else {
      _liveDataSpecification = liveDataSpecification;
  ...
  protected EntitlementResponse (final EntitlementResponse source) {
    ...
    if (source._liveDataSpecification == null) {
      _liveDataSpecification = null;
    } else {
  ...
  public void setIsEntitled (final boolean isEntitled) {
    _isEntitled = isEntitled;
  }
