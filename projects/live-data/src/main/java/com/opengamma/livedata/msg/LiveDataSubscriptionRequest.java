...
public class LiveDataSubscriptionRequest implements java.io.Serializable {
  ...
  public LiveDataSubscriptionRequest (final com.opengamma.livedata.UserPrincipal user, final com.opengamma.livedata.msg.SubscriptionType type, final java.util.Collection<? extends com.opengamma.livedata.LiveDataSpecification> specifications) {
    if (user == null) {
    ...
    if (specifications == null) {
      throw new NullPointerException ("'specifications' cannot be null");
    } else {
      final java.util.List<com.opengamma.livedata.LiveDataSpecification> fudge0 = new java.util.ArrayList<> (specifications);
      if (specifications.size () == 0) {
        throw new IllegalArgumentException ("'specifications' cannot be an empty list");
      }
      for (final java.util.ListIterator<com.opengamma.livedata.LiveDataSpecification> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.livedata.LiveDataSpecification fudge2 = fudge1.next ();
        if (fudge2 == null) {
          throw new NullPointerException ("List element of 'specifications' cannot be null");
        }
        fudge1.set (fudge2);
      }
  ...
  protected LiveDataSubscriptionRequest (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a LiveDataSubscriptionRequest - field 'user' is not present");
    }
    try {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a LiveDataSubscriptionRequest - field 'type' is not present");
    }
    try {
    ...
    if (fudgeFields.size () == 0) {
      throw new IllegalArgumentException ("Fudge message is not a LiveDataSubscriptionRequest - field 'specifications' is not present");
    }
    _specifications = new java.util.ArrayList<> (fudgeFields.size ());
  ...
  protected LiveDataSubscriptionRequest (final LiveDataSubscriptionRequest source) {
    ...
    if (source._user == null) {
      _user = null;
    } else {
      _user = source._user;
    }
    _type = source._type;
    if (source._specifications == null) {
      _specifications = null;
    } else {
      final java.util.List<com.opengamma.livedata.LiveDataSpecification> fudge0 = new java.util.ArrayList<> (source._specifications);
      for (final java.util.ListIterator<com.opengamma.livedata.LiveDataSpecification> fudge1 = fudge0.listIterator (); fudge1.hasNext ();) {
        final com.opengamma.livedata.LiveDataSpecification fudge2 = fudge1.next ();
        fudge1.set (fudge2);
      }
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    ...
    if (_specifications != null)  {
      for (final com.opengamma.livedata.LiveDataSpecification fudge1 : _specifications) {
  ...
  public void setType (final com.opengamma.livedata.msg.SubscriptionType type) {
    if (type == null) {
      throw new NullPointerException ("type' cannot be null");
    }
    _type = type;
  ...
  public void setSpecifications (final com.opengamma.livedata.LiveDataSpecification specifications) {
    if (specifications == null) {
      throw new NullPointerException ("'specifications' cannot be null");
    } else {
      _specifications = new java.util.ArrayList<> (1);
      addSpecifications (specifications);
    }
  }
  public void setSpecifications (final java.util.Collection<? extends com.opengamma.livedata.LiveDataSpecification> specifications) {
    if (specifications == null) {
      throw new NullPointerException ("'specifications' cannot be null");
    } else {
      final java.util.List<com.opengamma.livedata.LiveDataSpecification> fudge0 = new java.util.ArrayList<> (specifications);
  ...
  public void addSpecifications (final com.opengamma.livedata.LiveDataSpecification specifications) {
    if (specifications == null) {
      throw new NullPointerException ("'specifications' cannot be null");
    }
    if (_specifications == null) {
      _specifications = new java.util.ArrayList<> ();
    }
  ...
  public boolean equals (final Object o) {
    ...
    else if (msg._user != null) {
      return false;
    }
    if (_type != null) {
      if (msg._type != null) {
        if (!_type.equals (msg._type)) {
          return false;
        }
      } else {
        return false;
    ...
    else if (msg._type != null) {
      return false;
    }
    if (_specifications != null) {
      if (msg._specifications != null) {
        if (!_specifications.equals (msg._specifications)) {
          return false;
        }
      } else {
        return false;
    ...
    else if (msg._specifications != null) {
      return false;
    }
    return true;
  }
