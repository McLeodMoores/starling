...
public class ResolveRequest implements java.io.Serializable {
  ...
  public ResolveRequest (final com.opengamma.livedata.LiveDataSpecification requestedSpecification) {
  ...
  protected ResolveRequest (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null) {
      throw new IllegalArgumentException ("Fudge message is not a ResolveRequest - field 'requestedSpecification' is not present");
    }
    try {
  ...
  public static ResolveRequest fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.livedata.msg.ResolveRequest".equals (className)) {
        break;
      }
      try {
