 ...
 * {@link com.opengamma.financial.security.cash.CashSecurity}.
 */
@BeanDefinition
public class CashSecurityBean extends SecurityBean {
  ...
  static {
    MetaBean.register(CashSecurityBean.Meta.INSTANCE);
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    public BeanBuilder<? extends CashSecurityBean> builder() {
      return new DirectBeanBuilder<>(new CashSecurityBean());
    }
