 ...
 * {@link com.opengamma.financial.security.option.IRFutureOptionSecurity}.
 */
@BeanDefinition
public class IRFutureOptionSecurityBean extends SecurityBean {
  ...
  static {
    MetaBean.register(IRFutureOptionSecurityBean.Meta.INSTANCE);
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    public BeanBuilder<? extends IRFutureOptionSecurityBean> builder() {
      return new DirectBeanBuilder<>(new IRFutureOptionSecurityBean());
    }
