...
/**
 * Provides access to configuration methods on {@link AbstractDbMaster}, {@link AbstractDocumentDbMaster} (and potentially other implementations). This makes it
 * possible to initialize in a standard way. See AbstractDocumentDbMasterComponentFactory (og-component) for further details.
 */
