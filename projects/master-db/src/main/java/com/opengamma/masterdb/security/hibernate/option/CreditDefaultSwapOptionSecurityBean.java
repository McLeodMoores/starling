 ...
 * {@link com.opengamma.financial.security.option.CreditDefaultSwapOptionSecurity}.
 */
@BeanDefinition
public class CreditDefaultSwapOptionSecurityBean extends SecurityBean {
  ...
  static {
    MetaBean.register(CreditDefaultSwapOptionSecurityBean.Meta.INSTANCE);
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    public BeanBuilder<? extends CreditDefaultSwapOptionSecurityBean> builder() {
      return new DirectBeanBuilder<>(new CreditDefaultSwapOptionSecurityBean());
    }
