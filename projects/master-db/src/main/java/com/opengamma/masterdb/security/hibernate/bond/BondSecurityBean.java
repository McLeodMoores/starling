 ...
 * {@link com.opengamma.financial.security.bond.BondSecurity}.
 */
@BeanDefinition
public class BondSecurityBean extends SecurityBean {
  ...
  static {
    MetaBean.register(BondSecurityBean.Meta.INSTANCE);
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    public BeanBuilder<? extends BondSecurityBean> builder() {
      return new DirectBeanBuilder<>(new BondSecurityBean());
    }
