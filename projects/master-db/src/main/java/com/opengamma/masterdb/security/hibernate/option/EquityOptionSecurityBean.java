 ...
 * {@link com.opengamma.financial.security.option.EquityOptionSecurity}.
 */
@BeanDefinition
public class EquityOptionSecurityBean extends SecurityBean {
  ...
  static {
    MetaBean.register(EquityOptionSecurityBean.Meta.INSTANCE);
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    public BeanBuilder<? extends EquityOptionSecurityBean> builder() {
      return new DirectBeanBuilder<>(new EquityOptionSecurityBean());
    }
